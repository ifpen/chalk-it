...
let getAuthToken=()=>{};function setXHRAuthorizationHeader(t){const e=getAuthToken();e&&t.setRequestHeader("Authorization",e)}function getAuthorizationHeaders(){const t=getAuthToken();return t?{Authorization:t}:{}}"true"!=xDashConfig.xDashBasicVersion&&(getAuthToken=()=>LoginMngr.GetSavedJwt()),angular.module("xCLOUD").service("ApisFactory",["$http","$rootScope",function(t,e){function n(t,e,n,r){return $.ajax({type:t,contentType:"application/json; charset=utf-8",data:JSON.stringify(n),dataType:"json",crossDomain:!0,url:urlxDashNodeServer+"api/"+e})}return this.saveSettings=function(t){return new Promise((function(e,n){(new FileMngrFct).SendFile("settings",new Blob([JSON.stringify(t)],{type:"application/json"}),e)})).then((function(n){return e.allSettings=t,t}),(function(t){return console.log("saveSettings error "+t),{error:!0,status:401,message:t}}))},this.getSettings=async function(){try{const t=new FileMngrFct,n=await new Promise(((e,n)=>t.ReadFile("settings","",e)));if("File does not exist"===n)return console.log("settings.usr file does not exist on server. Creating new one with default settings"),e.DefaultSettings;let r={};try{r=JSON.parse(n)}catch(t){return e.xDashFullVersion?swal("Unexpected error","unable to load settings.usr\n\n"+n,"error"):swal("Please check and restart the command line",'unable to load "~/.chalk-it/settings.json"',"error"),e.DefaultSettings}return r}catch(t){return console.log("getSettings error"+t),{error:!0,status:401,message:t}}},this.postRequest=function(n,r){return e.loadingBarStart(),t.post(xServConfig.urlApi+n,JSON.stringify(r),{contentType:"application/json; charset=utf-8"}).then((function(t){return e.loadingBarStop(),JSON.parse(t.data.d)}),(function(t){return e.loadingBarStop(),t}))},this.GetProjectByName=function(n){return e.loadingBarStart(),t.post(xServConfig.urlApi+"ReadProject",JSON.stringify(n),{contentType:"application/json; charset=utf-8"}).then((function(t){return e.loadingBarStop(),JSON.parse(t.data.d)}),(function(t){return e.loadingBarStop(),t}))},this.deleteFileFromServer=function(n,r){return e.loadingBarStart(),t.post(xServConfig.urlApi+r,JSON.stringify(n),{contentType:"application/json; charset=utf-8"}).then((function(t){return e.loadingBarStop(),JSON.parse(t.data.d)}),(function(t){return e.loadingBarStop(),t}))},this.sentResetPasswordRequest=function(t){return n("PUT","auth/updatepassword",{email:t})},this.sentResetPasswordForm=function(t){return n("POST","auth/updatepassword",t)},this.registerRequest=function(t){return n("POST","auth/register",t)},this.loginWithEmailPasswordAction=function(t){return n("POST","auth/login",{email:t.email,password:t.password})},this.getUserProfileByToken=function(t){return n("GET","users/me?Authorization=Bearer "+t,{})},this.updatePassword=function(t){return n("POST","auth/updatepassword",{email:t.email,password:t.password})},this}]);
angular.module("modules.python-images",[]).config(["$stateProvider",function(e){e.state("modules.python-images",{notAuthenticate:!0,userAuthenticated:!1,abstract:!0,url:"/python-images",templateUrl:""})}]).service("PythonImagesManager",["$http","$rootScope","ApisFactory",function(e,t,a){const i=this;function n(e,t){if("success"!==t)throw Error(e)}function l(e=!0){const t=new Uint32Array(8);window.crypto.getRandomValues(t);let a="";for(let i=0;i<t.length;i++)a+=(i<2||i>5?"":"-")+t[i].toString(e?16:36).slice(-4);return a}function s(){return new Promise(((e,t)=>{(new FileMngrFct).GetFileList("pydata",((a,i,n)=>{"success"===n?e(a.FileList.map((e=>e.Python))):t(a)}),!1)}))}function o(e,t,a){const i=e.Id;return a&&a(0),new Promise(((e,n)=>{(new FileMngrFct).SendText("pydata",i,t,((t,a,i)=>{"success"===i?e(t):n(t)}),a)}))}this.getImages=async()=>{const e=await s();return e||[]},this.createImage=async(e,t,a)=>{await o(e,t.data,a),(new FileMngrFct).AddPythonInfo(e.Id,n,e.BaseImage,"",e.Name,e.Description,e.FileName,e.FileSize)},this.updateImage=async(e,t,a={},i)=>{e.Hash&&(_.isUndefined(t)||(a.data||t.FileName!==e.FileName||t.BaseImage!==e.BaseImage)&&(e.Hash=void 0)),a.data&&await o(e,a.data,i),(new FileMngrFct).AddPythonInfo(e.Id,n,e.BaseImage,e.Hash,e.Name,e.Description,e.FileName,e.FileSize);const l=await s();if(!l)throw Error("No images defined");const r=l.findIndex((t=>t.Id===e.Id));if(-1===r)throw Error(`Image ${e.Id} does not exist`);l[r]=e},this.deleteImage=async t=>{const a=urlPython+`images/${t.Id}`;e.delete(a,{headers:getAuthorizationHeaders()}),async function(e){await new Promise(((e,t)=>{(new FileMngrFct).GetFileList("pydata",((a,i,n)=>{"success"===n?e(a.FileList.map((e=>e.Name))):t(a)}),!1)})),(await i.getImages()).map((e=>e.Id));!function(e){new Promise(((t,a)=>{(new FileMngrFct).DeleteFile("pydata",e,((e,i,n)=>{"error"===n?a(e):t(e)}))}))}(e)}(t.Id)},this.buildImage=async t=>{const a=urlPython+"images/build",i={id:t.Id,baseImage:t.BaseImage,fileData:await(n=t.Id,new Promise(((e,t)=>{var a=new FileMngrFct;a.ReadFile("pydata",n,((a,i,n)=>{"success"===n?e(b64DecodeUnicode(a)):t(a)}))}))),fileName:t.FileName};var n;return(await e.post(a,i,{headers:getAuthorizationHeaders()})).data},this.getImageFullStatus=async t=>{const a=urlPython+`images/${t}`;return(await e.get(a,{headers:getAuthorizationHeaders()})).data},this.getImagesStatus=async t=>{const a=urlPython+"images/list";return(await e.post(a,t,{headers:getAuthorizationHeaders()})).data};const r="name",c="file",d="base",u="python:3.8";let p;p=xDashConfig.disablePythonSlim?[{label:"python:3.10",value:"python:3.10"},{label:"python:3.9",value:"python:3.9"},{label:"python:3.8",value:u},{label:"python:3.7",value:"python:3.7"},{label:"python:3.6",value:"python:3.6"}]:[{label:"python:3.10-slim",value:"python:3.10-slim"},{label:"python:3.10",value:"python:3.10"},{label:"python:3.9-slim",value:"python:3.9-slim"},{label:"python:3.9",value:"python:3.9"},{label:"python:3.8-slim",value:"python:3.8-slim"},{label:"python:3.8",value:u},{label:"python:3.7-slim",value:"python:3.7-slim"},{label:"python:3.7",value:"python:3.7"},{label:"python:3.6-slim",value:"python:3.6-slim"},{label:"python:3.6",value:"python:3.6"}];function m(e,t){const a=$('<div style="margin: 10px 0 10px 0"></div>'),i=h(r,"Image name",a),n=$('<input type="text">').appendTo(i).change((function(){e.Name=$(this).val(),g(e,t)}));e.Name&&n.val(e.Name);const l=h("desc","Image description",a),s=$('<textarea class="calculated-value-input">').appendTo(l).change((function(){e.Description=$(this).val(),g(e,t)}));e.Description&&s.val(e.Description);const o=h(d,"Base image",a),u=$("<select></select>").appendTo($('<div class="styled-select"></div>').appendTo(o));p.forEach((e=>{u.append($(`<option>${e.label}</option>`).attr("value",e.value))})),u.change((function(){e.BaseImage=$(this).val(),g(e,t)})),e.BaseImage&&u.val(e.BaseImage);const m=e.FileName?v(e.FileName,e.FileSize):"",I=$(`<input type="text" id="select_file_path" value="${m}"></input><label class="board-toolbar datasource-input-suffix"><i class="fa-folder-open fa" aria-hidden="true"></i>Browse...</label>`),F=$('<input type="file" style="display: none" id="select_file" accept=".zip, .txt"></input>').appendTo(I);I.mousedown((function(e){e.preventDefault(),$("#select_file").trigger("click")})),F.change((function(a){if(a.target.files.length>0){const i=a.target.files[0],n=i.name;if(i.size>1e9)f(c),y(c,`File ${n} is too big.`);else{const a=new FileReader;a.addEventListener("load",(function(a){const l=a.target.result,s=i.size;t.data=l.replace(/^data:.+;base64,/,""),e.FileName=n,e.FileSize=s,$("#select_file_path").val(v(n,s)),g(e,t)})),a.readAsDataURL(i)}}}));const w=h(c,"Package/requirements",a);return I.appendTo(w),a}function h(e,t,a){var i=$('<div id="setting-row-'+e+'" class="form-row"></div>').appendTo(a);return i.append('<div class="form-label"><label class="control-label">'+t+"</label></div>"),$('<div id="setting-value-container-'+e+'" class="form-value"></div>').appendTo(i)}function g(e,t){var a=!0;return f(r),0===(e.Name||"").trim().length&&(y(r,"This is required"),a=!1),f(c),(e.FileSize||0)<=0&&(y(c,"Either a requirement file or a package is required"),a=!1),f(d),0===(e.BaseImage||"").trim().length&&(y(d,"Base image is mandatory"),a=!1),a}function y(e,t){const a=$('<div class="validation--error"></div>').html(t);$("#setting-value-container-"+e).append(a)}function f(e){$("#setting-value-container-"+e).children(".validation--error").remove()}function v(e,t){var a="";return e&&(a+=e),t&&t>0&&(a+=" ("+formatDataSize(t)+")"),a}this.openOutputDialog=async(e,t)=>{const a=this;const i=await this.getImageFullStatus(e),n=$('<div><pre id="outputText" style="color: white; background-color: black"></div>');new DialogBox(n,"Build output","Close",null,(()=>(t&&t(image),!1))),function t(i){if(i.output){const e=$("#outputText");e.text(i.output.replace(/\r\n/g,"\n"));const t=e.parent();t.animate({scrollTop:t.prop("scrollHeight")})}"building"===i.status&&setTimeout((async()=>t(await a.getImageFullStatus(e))),5e3)}(i)},this.openNewImageDialog=()=>{const e={BaseImage:u,Id:l(!1)},t={};return $("#editForm").append(m(e,t)),[e,t]},this.openEditImageDialog=e=>{const t=_.clone(e),a={};return $("#editForm").append(m(t,a)),[t,a]},this.checkImageValidity=g}]);
...
function displayLoadSpinner(e){const t=this,n=document.getElementById("button"+e),o=document.getElementById("button"+e+"_select_file"),a=document.createElement("i");let s;this.disableButton=function(){n.classList.add("disabled"),a.setAttribute("id","icon"+e),a.setAttribute("class","fa fa-spinner fa-spin"),n.append(a)},this.enableButton=function(){n.classList.remove("disabled"),a&&a.remove()},this.disableButton(),o.onchange=function(){clearTimeout(s),document.body.focus(),t.enableButton()},document.body.onfocus=function(){s=setTimeout((()=>{t.enableButton(),document.body.onfocus=null}),200)}}function _addSpinner(e){const t=document.getElementById("button"+e),n=document.getElementById("icon"+e)||document.createElement("i");n.setAttribute("id","icon"+e),t.classList.add("btn","btn-table-cell","btn-lg","disabled"),n.classList.contains("fa","fa-spinner","fa-spin")||n.classList.add("fa","fa-spinner","fa-spin"),t.contains(n)||t.append(n)}function _removeSpinner(e,t){const n=document.getElementById("icon"+t),o=document.getElementById("button"+t);n&&n.remove(),o.className=`btn btn-table-cell btn-lg ${e}widgetCustomColor`}function updateWidgetDataNode(e,t){const n=widgetConnector.widgetsConnection[e];if(!n)return;const o=n.sliders,a=[];if(o){for(const e in o){const t=o[e].dataNode;if("None"!=t){const e=datanodesManager.getDataNodeByName(t);a.push(e.name())}}if(a.length){datanodesManager.getDataNodeByName(a[0]).schedulerStart(a,a[0],"triggerButton");const n=setInterval((function(){a.some((e=>"Pending"===datanodesManager.getDataNodeByName(e).status()))?_addSpinner(t):(_removeSpinner(e,t),clearInterval(n))}),100)}}}function setFileUploadSpinner(e,t){const n=document.getElementById("button"+e),o=document.getElementById("icon"+e);if("remove"==t)n.classList.remove("disabled"),o&&o.remove();else if("add"==t&&(n.classList.add("disabled"),!o)){const t=document.createElement("i");t.setAttribute("id","icon"+e),t.setAttribute("class","fa fa-spinner fa-spin"),n.appendChild(t)}}
var widgetPreview=function(){var e,t=[],n="scaleTwh",o=0,i=1,d=new rescaleHelper(e,n,"preview"),s=[],a=[],l=[],r=[],c="",g={};function u(){return{widthPx:$("#dashboard-zone").width(),heightPx:$("#dashboard-zone").height(),scrollWidthPx:$("#dashboard-zone")[0].scrollWidth,scrollHeightPx:$("#dashboard-zone")[0].scrollHeight,widthVw:100*$("#dashboard-zone").width()/document.documentElement.clientWidth,heightVh:100*$("#dashboard-zone").height()/document.documentElement.clientHeight,scrollWidthVw:100*$("#dashboard-zone")[0].scrollWidth/document.documentElement.clientWidth,scrollHeightVh:100*$("#dashboard-zone")[0].scrollHeight/document.documentElement.clientHeight,scalingMethod:n}}function f(){for(let e in t)for(let n of widgetConnector.effectiveSliders())null!=t[e]&&null!=t[e].getByName(n)&&(slider=t[e].getByName(n),slider.addValueChangedHandler(y))}function m(e,n){_.each(_.keys(e.dashboard),(e=>{let o=document.getElementById(e+"c"),i=e.substring(0,e.length-1),d=o.firstElementChild.id;t[e]=n?widgetsPluginsHandler.createWidget(d,i,e,!0):widgetsPluginsHandler.copyWidget(d,i,null,e,!0),function(e){$("#"+e+"c")[0].style.position="absolute",$("#"+e+"c")[0].style.border="1px solid rgba(255, 255, 255, 0)"}(e),null!=widgetConnector.widgetsConnection[e]&&(widgetConnector.widgetsConnection[e].widgetObjEdit=null,widgetConnector.widgetsConnection[e].widgetObjConnect=t[e],p(e,!1))})),d.updateCellsProportions(),_.each(_.keys(t),(e=>{!function(e,t){s[e]=$("#"+t).width()/$("#"+$("#"+t)[0].parentNode.id).width(),a[e]=$("#"+t).height()/$("#"+$("#"+t)[0].parentNode.id).height(),l[e]=$("#"+t).position().left/$("#"+$("#"+t)[0].parentNode.id).width(),r[e]=$("#"+t).position().top/$("#"+$("#"+t)[0].parentNode.id).height(),c=getMedia()}(e,e+"c")}))}function p(e,t){const n=widgetConnector.widgetsConnection[e];if(_.isUndefined(n))console.log("connection of "+e+" is undefined");else for(const o in n.sliders){const i=n.sliders[o];if("None"!==i.name){let d=null;if(null!=n.widgetObjEdit?d=n.widgetObjEdit.getByName(i.name):null!=n.widgetObjConnect&&(d=n.widgetObjConnect.getByName(i.name)),null!=d){const n=i.dataNode;if("None"!==n){const i=datanodesManager.getDataNodeByName(n);if(i){C(e,o,d,i.latestData(),i.status(),i.last_updated(),t)}else{b(e,o,"Invalid connection with data")}}else widgetPreview.clearDataFromWidget(e,o,d,!0)}}}}function b(e,t,n){if(!g[e]){var o=widgetConnector.widgetsConnection[e].instanceId+"c";_.isUndefined($("#"+o)[0])||"3px groove #e40000"!=$("#"+o)[0].style.border&&(w=parseFloat($("#"+o)[0].style.width)+1,h=parseFloat($("#"+o)[0].style.height)+1,$("#"+o)[0].style.width=w+"vw",$("#"+o)[0].style.height=h+"vh",$("#"+o)[0].style.border="3px groove #e40000",$("#"+o)[0].style.borderRadius="6px",$("#"+o)[0].style.background="rgba(255, 0, 0, 0.26)",$("#"+o).append('<br/><span style="color:red">'+n+' "'+widgetConnector.widgetsConnection[e].sliders[t].dataNode+'" !</span>')),g[e]=!0}}function C(e,t,n,o,i,d,s){if(_.isUndefined(o)&&"never"!=d||"Error"==i)return msg="Invalid data",void b(e,t,msg);if(function(e){var t=widgetConnector.widgetsConnection[e].instanceId+"c";if(!_.isUndefined($("#"+t)[0])&&"1px solid rgba(255, 255, 255, 0)"!=$("#"+t)[0].style.border){w=parseFloat($("#"+t)[0].style.width)-1,h=parseFloat($("#"+t)[0].style.height)-1,$("#"+t)[0].style.width=w+"vw",$("#"+t)[0].style.height=h+"vh",$("#"+t)[0].style.border="1px solid rgba(255, 255, 255, 0)",$("#"+t)[0].style.borderRadius="",$("#"+t)[0].style.background="";for(var n=0;n<$("#"+t)[0].childNodes.length;n++)"span"==$("#"+t)[0].childNodes[n].localName&&$("#"+t)[0].childNodes[n].remove()}g[e]=!1}(e),!_.isUndefined(o)&&!_.isNull(o)){const i=widgetConnector.widgetsConnection[e].sliders[t];let d=o,a=i.dataNode;for(let e=0;e<i.dataFields.length;e++){const t=i.dataFields[e];"string"==typeof t&&t.includes(" ... ")||(a=t,d=_.isNull(d)||_.isUndefined(d)?o[a]:d[a])}if(null===d)widgetPreview.clearDataFromWidget(e,t,n,!0);else if("D"===i.name.substring(0,1))try{n.setText(d)}catch(e){console.log("setText got exception with data '"+i.dataNode+"'. "+e)}else{if(!_.isUndefined(n.setCaption))try{n.setCaption(a,s)}catch(e){console.log("setCaption got exception with data '"+i.dataNode+"'. "+e)}if(!_.isUndefined(n.setValue))try{n.setValue(d)}catch(e){console.log("setValue got exception with data '"+i.dataNode+"'. "+e)}}}}function y(e,t){let n=function(e){for(let t in widgetConnector.widgetsConnection){const n=widgetConnector.widgetsConnection[t];if(n.widgetObjConnect){const t=Object.values(n.sliders).find((t=>n.widgetObjConnect.getByName(t.name)===e));if(t)return t}}return null}(e);if(n&&"None"!==n.dataNode){const t=datanodesManager.getDataNodeByName(n.dataNode);if(_.isUndefined(t))console.log("data was removed or data index was modified!");else if(t.canSetValue()&&!_.isUndefined(e.getValue))try{t.setValue(n.dataFields,e.getValue())}catch(e){console.log("setValue got exception with data: "+t.name()+". "+e.message)}else console.log("setValue is not possible with data: "+t.name())}}function v(){e=u(),d.setDimensions(e);var n,o=isMediaChanged(c);n=o.bChanged,c=o.lastMedia,n?_.each(_.keys(t),(e=>{let n=e+"c";d.resizeWidgetOnMediaChange(e,n),function(e){let n=e+"c";for(var o=document.getElementById(n),i=o.id.substring(0,o.id.length-2),d=(e=o.id.substring(0,o.id.length-1),o.firstElementChild),s=o.childNodes.length-1;s>=0;s--)o.removeChild(o.childNodes[s]);var a=document.createElement("div");a.style.height=unitH(o.offsetHeight-2),a.style.width=unitW(o.offsetWidth-2),a.style.minWidth=parseFloat(o.style.minWidth)-5+"px",a.style.minHeight=parseFloat(o.style.minHeight)-5+"px",o.appendChild(a),a.id=d.id;var l=d.id;t[e]=widgetsPluginsHandler.copyWidget(l,i,t[e],e,!0),g[e]=!1}(e),null!=widgetConnector.widgetsConnection[e]&&(widgetConnector.widgetsConnection[e].widgetObjConnect=t[e],p(e))})):_.each(_.keys(t),(e=>{rescaleWidget(t,e)}))}function x(){for(var e in t)delete t[e];for(var e in $("#dashboard-zone").html(""),s)delete s[e];for(var e in a)delete a[e];for(var e in l)delete l[e];for(var e in r)delete r[e];c=""}return{loadPlayMode:function(){x(),e=widgetEditor.getSnapshotDashZoneDims(),d.setDimensions(e),d.setScalingMethod(n),d.setRows(o),d.setCols(i),m(function(){var e=xdash.serialize();e.scaling=widgetEditor.getSnapshotDashZoneDims();var t=document.getElementById("dashboard-zone"),n=document.createElement("div");return n.id="DropperDroitec",n.className="dropperR",n.style.zIndex=0,n.style.borderRadius="10px",t.appendChild(n),reconstructFoundations.buildDivsFromXprjson(e),e}(),!1),0!=datanodesManager.getAllDataNodes().length&&f()},renderDashboardWidgets:m,updateDataFromWidget:y,resizeDashboard:function(e){if("undefined"!=typeof execOutsideEditor&&execOutsideEditor){let e=0;const t=jQuery.extend(!0,{},jsonContent.scaling);switch($("#nav-menu")[0]&&(e=parseInt($("#nav-menu")[0].style.height),isNaN(e)&&(e=0)),jsonContent.exportOptions){case"rowToPage":rowToPageRuntime.rowToPagePrepareRescale(o,i);break;case"rowToTab":rowToTabRuntime.rowToTabPrepareRescale(o,i);break;case"customNavigation":customNavigationRuntime.customNavigationPrepareRescale(o,i);break;case"keepOriginalWidth":{const n=$("#dashboard-zone"),o=document.body.clientHeight,i=document.body.clientWidth;n.css({top:o/2-n.outerHeight()/2+"px",left:i/2-n.outerWidth()/2+"px",position:"absolute",height:t.scrollHeightPx+e+"px",width:t.scrollWidthPx+"px"});break}case"adjustToFullWidth":{const n=$("#dashboard-zone"),o=document.body.clientHeight;n.css({top:o/2-n.outerHeight()/2+"px",position:"absolute",height:t.scrollHeightPx+e+"px"});break}default:$("#dashboard-zone")[0].style.height=document.body.clientHeight-e+"px"}}d.setScalingMethod(n),d.setRows(o),d.setCols(i),d.resizeDashboard(e),v(),"undefined"!=typeof execOutsideEditor&&execOutsideEditor&&"rowToPage"==jsonContent.exportOptions&&setTimeout(rowToPageRuntime.rowToPageFinishRescale,500,o,i)},resizeDashboardCols:function(){d.resizeDashboardCols()},widget:t,plotConstantData:p,assignValueChangeHandlers:f,rescale:v,clear:function(){x(),htmlExport.exportOptions="ajustToTargetWindow"},deserialize:function(e){let t;for(t in _.each(_.keys(e),(e=>{let t=e.substring(0,e.length-1),n=e+"c";null==widgetConnector.widgetsConnection[e]&&(widgetConnector.widgetsConnection[e]={name:n,id:n,instanceId:e,modelJsonId:t,sliders:[],widgetObjEdit:null,widgetObjConnect:null})})),widgetConnector.widgetsConnection)for(var n in e[t])widgetConnector.widgetsConnection[t].sliders[n]=e[t][n];for(t in widgetConnector.widgetsConnection)try{widgetPreview.plotConstantData(t,!1),widgetConnector.widgetsConnection[t].widgetObjEdit=null}catch(e){}},setDataOnWidget:C,clearDataFromWidget:function(e,t,n,o){"D"===widgetConnector.widgetsConnection[e].sliders[t].name.substring(0,1)?n.setText(""):(!_.isUndefined(n.clearCaption)&&o&&n.clearCaption(),_.isUndefined(n.setValue)||n.setValue(null))},getCurrentDashZoneDims:u,getSnapshotDashZoneDims:function(){return e},getWidgetsRelativeDims:function(){return{width:s,height:a,left:l,top:r}},setScalingInformation:function(e,t,s,a){null!=e&&(d.setDimensions(e),null!=e.colDims&&d.deserialize(e)),null!=t&&(n=t,d.setScalingMethod(n)),null!=s&&(o=s,d.setRows(o)),null!=a&&(i=a,d.setCols(i))},getCols:function(){return d.getCols()},mediaChangeProjection:function(e,t,n){return d.mediaChangeProjection(e,t,n)},toPng:function(){var e=function(){var e,n,o=0,i=0,d=$("#dashboard-zone").offset().left,s=$("#dashboard-zone").offset().top,a=$("#dashboard-zone").height();for(var l in t)(e=$("#"+l+"c").offset().left-d+$("#"+l+"c").width())>o&&(o=e),(n=$("#"+l+"c").offset().top-s+$("#"+l+"c").height())>i&&(i=n),i>a&&(i=a);return{right:o,bottom:i}}(),n=document.getElementById("dashboard-zone"),o=n.style.height,i=n.style.width;n.style.height=e.bottom+"px",n.style.width=e.right+"px",html2canvas(n,{allowTaint:!1,useCORS:!0}).then((function(t){var d=Canvas2Image.convertToPNG(t,e.right,e.bottom),s=document.createElement("a");s.setAttribute("download",$("#projectName")[0].value+".png"),s.setAttribute("href",d.src.replace("image/png","image/octet-stream")),s.click(),n.style.height=o,n.style.width=i}))},elevateZIndex:function(e,n){var o=0;_.each(Object.keys(t),(function(e){var t=Number($("#"+e+"c")[0].style["z-index"]);t>o&&(o=t)})),$("#"+e+"c")[0].style["z-index"]=o+1}}}();
...
class RowToPageRuntime{#e;constructor(){this.#e={rows:1,cols:1}}rowToPagePrepareRescale(e,o){Number(e)>1&&$("[id^=dpr][id$=c]").show()}rowToPageFinishRescale(e,o){const r=angular.element(document.body).scope().$root.pageNumber,s=Number(e),i=Number(o);if(this.grid={rows:s,cols:i},s>1)if($("[id^=dpr][id$=c]").hide(),i>1){const e=r*i;for(let o=e-i+1;o<=e;o++)$("#dpr"+o+"c").show()}else $("#dpr"+r+"c").show()}rowToPageModeInit(e){const o=angular.element(document.body).scope().$root,r=Number(e.device.cols.valueRow),s=Number(e.device.cols.valueCol);if(customNavigationRuntime.jsonContent=e,this.grid={rows:r,cols:s},o.pageNumber=1,o.totalPages=r,o.showPagination=!0,o.exportOptions=e.exportOptions,o.$apply(),r>1)if($("[id^=dpr][id$=c]").hide(),s>1)for(let e=1;e<=s;e++)$("#dpr"+e+"c").show();else $("#dpr"+o.pageNumber+"c").show();o.rowToPageChange=function(e){let r=!0,i="";switch(e){case"previous":r=o.pageNumber>1,i="-";break;case"next":r=o.pageNumber<o.totalPages,i="+"}if(r){switch($("[id^=dpr][id$=c]").hide(),i){case"-":o.pageNumber-=1;break;case"+":o.pageNumber+=1}if(s>1){const e=o.pageNumber*s;for(let o=e-s+1;o<=e;o++)$("#dpr"+o+"c").show()}else $("#dpr"+o.pageNumber+"c").show()}}}get grid(){return this.#e}set grid(e){this.#e=e}}const rowToPageRuntime=new RowToPageRuntime;
class RowToTabRuntime{#e;constructor(){this.#e={rows:1,cols:1}}rowToTabPrepareRescale(e,o){Number(e)>1&&$("[id^=dpr][id$=c]").show()}rowToTabFinishRescale(e,o){const r=angular.element(document.body).scope().$root.pageNumber,s=Number(e),i=Number(o);if(this.grid={rows:s,cols:i},$("#page-"+r).removeClass("cancel").addClass("primary"),s>1)if($("[id^=dpr][id$=c]").hide(),i>1){const e=r*i;for(let o=e-i+1;o<=e;o++)$("#dpr"+o+"c").show()}else $("#dpr"+r+"c").show()}rowToTabModeInit(e){const o=angular.element(document.body).scope().$root,r=Number(e.device.cols.valueRow),s=Number(e.device.cols.valueCol);if(customNavigationRuntime.jsonContent=e,this.grid={rows:r,cols:s},o.pageNumber=1,o.pageNames=e.pages.pageNames,o.showPagination=!0,o.exportOptions=e.exportOptions,o.$apply(),r>1)if($("[id^=dpr][id$=c]").hide(),s>1)for(let e=1;e<=s;e++)$("#dpr"+e+"c").show();else $("#dpr"+o.pageNumber+"c").show();o.rowToTabChange=function(e){if(o.pageNumber=e,$("[id^=dpr][id$=c]").hide(),s>1){const o=e*s;for(let e=o-s+1;e<=o;e++)$("#dpr"+e+"c").show()}else $("#dpr"+e+"c").show()}}get grid(){return this.#e}set grid(e){this.#e=e}}const rowToTabRuntime=new RowToTabRuntime;
class CustomNavigationRuntime{#o;#t;constructor(){this.#o={rows:1,cols:1},this.#t={}}customNavigationPrepareRescale(o,t){Number(o)>1&&$("[id^=dpr][id$=c]").show()}customNavigationModeInit(o){const t=Number(o.pages.defaultPage.id),e=Number(o.device.cols.valueRow),s=Number(o.device.cols.valueCol);if(this.jsonContent=o,this.grid={rows:e,cols:s},e>1)if($("[id^=dpr][id$=c]").hide(),s>1){const o=t*s;for(let t=o-s+1;t<=o;t++)$("#dpr"+t+"c").show()}else $("#dpr"+t+"c").show()}customNavigationGoToPage(o){const t=angular.element(document.body).scope().$root,e=this.jsonContent;let s,i,n="";if(!("undefined"!=typeof layoutMgr&&!t.bIsPlayMode||"undefined"==typeof layoutMgr&&_.isEmpty(e))&&(t.pageNumber=o,_.isEmpty(e)?(s=layoutMgr.getRows(),i=layoutMgr.getCols(),n=htmlExport.exportOptions):(s=Number(e.device.cols.valueRow),i=Number(e.device.cols.valueCol),n=e.exportOptions),this.grid={rows:s,cols:i},s>1))if("projectToTargetWindow"==n){$("#dpr"+o*i+"c")[0].scrollIntoView(!1)}else if($("[id^=dpr][id$=c]").hide(),i>1){const t=o*i;for(let o=t-i+1;o<=t;o++)$("#dpr"+o+"c").show()}else $("#dpr"+o+"c").show()}get jsonContent(){return this.#t}set jsonContent(o){this.#t=o}get grid(){return this.#o}set grid(o){this.#o=o}}const customNavigationRuntime=new CustomNavigationRuntime;
