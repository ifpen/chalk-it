...
var xdash=function(){var e=xDashConfig.version.fullVersion;const t=angular.element(document.body).scope().$root;function a(){angular.element(document.body).injector().invoke(["UndoManagerService",e=>{e.clear()}]),datanodesManager.clear(),widgetEditor.clear(),xdashNotifications.clearAllNotifications(),$("#projectName")[0].value="",$(".tab--active").removeClass("changed"),t.currentPrjDirty="";angular.element(document.getElementById("library__wrap")).scope().resetPyodideLibs(),layoutMgr.resetDashBgColor(),layoutMgr.resetDashboardTheme();angular.element(document.getElementById("help__wrap")).scope().initFrame()}function n(){return{version:e,date:Date(),name:"",description:"",groupName:"",tags:[],schedulerLogOff:offSchedLogUser}}async function o(e){try{return $("#projectName")[0].value=e.meta.name,_.isUndefined(e.meta.description)||(t.currentProject.description=e.meta.description),_.isUndefined(e.meta.tags)||(t.currentProject.tags=e.meta.tags),_.isUndefined(e.meta.groupName)||(t.currentProject.groupName=e.meta.groupName),_.isUndefined(e.meta.schedulerLogOff)?offSchedLogUser=!0:offSchedLogUser=e.meta.schedulerLogOff,await pyodideLib.deserialize(e),e.data.version=e.meta.version,datanodesManager.load(e.data,!0)?(angular.element(document.body).injector().invoke(["UndoManagerService",e=>{e.clear()}]),function(e,t,a,n){const o=e.droppers;let r=[];"datasources"in n?_.isUndefined(n.datasources)||(r=n.datasources.map(e=>e.name)):_.isUndefined(n.datanodes)||(r=n.datanodes.map(e=>e.name));if(_.isEmpty(o)){const e=_.keys(t);_.each(e,e=>{i(e,t,a,n,r)})}else{const e=_.keys(o);_.each(e,e=>{const l=_.keys(o[e]);_.each(l,l=>{let s=o[e][l];o[e][l]=i(s,t,a,n,r)})})}}(e.device,e.dashboard,e.connections,e.data),widgetEditor.deserialize(e.dashboard,e.scaling,e.device),widgetConnector.deserialize(e.connections),widgetPreview.clear(),widgetEditor.unselectAllWidgets(),layoutMgr.deserializeDashBgColor(e.device),layoutMgr.deserializeDashboardTheme(e.device),_.isUndefined(e.pages)||(layoutMgr.deserializeRowNames(e.pages),layoutMgr.deserializeDefaultRow(e.pages)),layoutMgr.deserializeExportOptions(e.exportOptions),_.isUndefined(e.navBarNotification)?htmlExport.navBarNotification=!1:htmlExport.navBarNotification=e.navBarNotification,!0):(a(),!1)}catch(e){return console.log(e),!1}}function i(e,t,a,n,o){if(e.includes("flatUiValue")&&!e.includes("flatUiValueDisplay")){let i="",r="";"datasources"in n?_.isUndefined(a[e].value.dataSource)||(r=a[e].value.dataSource):_.isUndefined(a[e].value.dataNode)||(r=a[e].value.dataNode);(""===r||o.includes(r))&&!_.isUndefined(t[e].modelParameters.isNumber)?(t[e].modelParameters.isNumber?(_.isUndefined(t[e].modelParameters.isPassword)||delete t[e].modelParameters.isPassword,i="flatUiNumericInput"):i="flatUiTextInput",delete t[e].modelParameters.isNumber):i="flatUiValueDisplay",_.isUndefined(t[e].container.id)||(t[e].container.id=t[e].container.id.replace("flatUiValue",i)),_.isUndefined(t[e].container.instanceId)||(t[e].container.instanceId=t[e].container.instanceId.replace("flatUiValue",i)),_.isUndefined(t[e].container.modelJsonId)||(t[e].container.modelJsonId=t[e].container.modelJsonId.replace("flatUiValue",i)),_.isUndefined(t[e].container.widgetTypeName)||(t[e].container.widgetTypeName=t[e].container.widgetTypeName.replace("flatUiValue",i)),_.isUndefined(t[e].modelParameters.decimalDigits)||delete t[e].modelParameters.decimalDigits;let l=e;return t[e=e.replace("flatUiValue",i)]=t[l],delete t[l],a[e]=a[l],delete a[l],e}return e}function r(e,t){let a="Previous";t&&"datanode"!=e||(a="Cancel"),(new FileMngrFct).GetFileList(e,l,!1,a,null)}function l(e,t,a,n){if("error"==a)swal(e,t,a);else if("success"==a){let a=t,o="files";"project"==a?o="projects":"datanode"==a&&(o="xdsjson"),contentElement=function(e,t){var a=document.createElement("div");a.classList.add("dashboard-form");var n='<label for="selectFile">'+t+"</label>";if(n+='<select class="multiple h-full" name="select-file" id="selectFile" size="10">',!_.isUndefined(e.FileList))for(let t=0;t<e.FileList.length;t++)_.isUndefined(e.FileList[t].Name)||(n=0==t?n+'<option selected value ="'+e.FileList[t].Name+'">'+e.FileList[t].Name+"</option>":n+'<option value ="'+e.FileList[t].Name+'">'+e.FileList[t].Name+"</option>");return n+="</select>",a.innerHTML=n,a}(e,"Please select a "+a+": "),new DialogBox(contentElement,"List of available "+o+" on server","Open",n,(function(){let e=$("#selectFile")[0];if(-1==e.selectedIndex)return!0;{datanodesManager.showLoadingIndicator(!0);let t=e.options[e.selectedIndex].value;swal.close(),(new FileMngrFct).ReadFile(a,t,s)}}))}}function s(e,t,a){if("error"==a)swal(e,t,a);else{let a=e,n=t;"project"==n?d(a):"datanode"==n&&xdsjson.openJsonManager(a)}datanodesManager.showLoadingIndicator(!1)}async function d(e){let t;try{t=JSON.parse(e)}catch(e){return void swal("Unable to load file","Project loading will be interrupted.","error")}var a;a=t,angular.element(document.body).injector().invoke(["$rootScope",function(e){e.currentProject={name:a.meta.name}}]);let n=!1,i=async function(e){if(angular.element(document.getElementById("dash-ctrl")).scope().reset(),n=await o(t),datanodesManager.showLoadingIndicator(!1),document.removeEventListener("widgets-tab-loaded",i),t=void 0,!n)return swal("Unable to load your project","Project loading will be interrupted.","error"),!1};document.addEventListener("widgets-tab-loaded",i),"widgets"==tabActive&&await i()}return $(window).bind("beforeunload",(function(){return function(){let e=angular.element(document.body).scope().$root;if(""!==e.currentProject.name){let t=angular.element(document.getElementById("headerbar-ctrl")).scope();if($(".tab--active").hasClass("changed")){fileManager.getFileListExtended("project",e.currentProject.name,void 0,(function(){t.closeProject(e.currentProject.name,!0),console.log("Your project is saved before closing")}),!0)}else t.closeProject(e.currentProject.name),console.log("Your project was closed")}}(),"Are you sure you want to leave the page ?"})),{openFile:function(e,t){"project"==e?fileText="project":"datanode"==e&&(fileText="xdsjson"),"local"===t?function(e){let t=FileMngr.GetFileExt(e);if(window.File&&window.FileReader&&window.FileList&&window.Blob){let a=document.createElement("input");a.type="file",a.setAttribute("accept",t),$(a).on("change",(function(t){"project"==e&&swal.close();let a=t.target.files;if(a&&a.length>0){let t=a[0],n=new FileReader;datanodesManager.showLoadingIndicator(!0),n.addEventListener("load",(function(t){let a=t.target;"project"==e?d(a.result):"datanode"==e&&xdsjson.openJsonManager(a.result)})),n.readAsText(t)}})),$(a).trigger("click")}else swal("Unable to load a file in this browser.","","error")}(e):"server"===t&&r(e,!0)},openFromServer:r,serialize:function(){const e=n();e.name=$("#projectName")[0].value||"Untitled",t.currentProject&&(e.description=t.currentProject.description,e.tags=t.currentProject.tags,e.groupName=t.currentProject.groupName);const a=datanodesManager.serialize(),o=pyodideLib.serialize();let i;i=t.moduleOpened||"widgets"!=tabActive||"edit-dashboard"!=modeActive||"full"!=editorStatus?widgetEditor.getSnapshotDashZoneDims():widgetEditor.getCurrentDashZoneDims();const r=widgetEditor.serialize(),l=layoutMgr.serializeCols(),s=layoutMgr.serializeDashBgColor(),d=layoutMgr.serializeDashboardTheme(),c=widgetConnector.serialize(),u=layoutMgr.serializeRowNames(),g=layoutMgr.serializeDefaultRow(),m=layoutMgr.serializeExportOptions();return navBarNotification=htmlExport.navBarNotification,{meta:e,data:a,libraries:o,scaling:i,device:{...l,...s,...d},dashboard:r,connections:c,exportOptions:m,pages:{...u,...g},checkExportOptions:!0,navBarNotification:navBarNotification}},initMeta:n,openProjectManager:d,deserialize:o,clear:a,pageLoad:!0,readFileFromServer:function(e,t){let a=new FileMngrFct,n=angular.element(document.body),o=n.scope().$root,i=n.scope().$state;o.origin="openProject",o.showNotifications=!1,o.toggleMenuOptionDisplay("none"),i.go("modules",{}),o.moduleOpened=!1,a.ReadFile(t,e+".xprjson",(function(a,n,i){if("success"===i){xdash.openProjectManager(a);let n=new PNotify({title:e,text:"Your "+t+" "+e+" is ready!",type:"success",delay:1800,styling:"bootstrap3"});$(".ui-pnotify-container").on("click",(function(){n.remove()})),o.loadingBarStop(),o.currentProject.name=e}else swal(a,n,i)}))},readFileFromUrl:function(e,t){let a;$.get(t,(function(e){a=e})).done((function(){let t=angular.element(document.body),n=t.scope().$root,o=t.scope().$state;n.origin="openProject",n.showNotifications=!1,n.toggleMenuOptionDisplay("none"),o.go("modules",{}),n.moduleOpened=!1,s(a,e)})).fail((function(e,t){datanodesManager.showLoadingIndicator(!1),swal("Error in loading xprjson from URL","Server response : "+e.status,"error")}))}}}();
