...
function DatanodesListModel(e,a,t,n){var s=this,o=[];function r(a){var o=new DatanodeModel(s,e,t,n);return o.deserialize(a)?(s.addDatanode(o),!0):(s.error(!0),!1)}this.datanodes=ko.observableArray(),this.datasourceData={},this.processDatanodeUpdate=function(e,a){s.datasourceData[e]=a},this.renameDatanodeData=function(e,a){s.datasourceData[a]=s.datasourceData[e],delete s.datasourceData[e]},this._datanodeTypes=ko.observable(),this.datanodeTypes=ko.computed({read:function(){s._datanodeTypes();var a=[];return _.each(e,(function(e){var t=e.type_name,n=t;_.isUndefined(e.display_name)||(n=e.display_name),a.push({name:t,display_name:n})})),a}}),this.serialize=function(){var e=[],a=[],n=t.topologicalSort();_.each(s.datanodes(),(function(e){a.push(_.indexOf(n,e.name()))})),_.each(s.datanodes(),(function(a){e.push(a.serialize())}));var o=angular.element(document.body).scope().$root;return o.alldatanodes=datanodesManager.getAllDataNodes(),o.showNotifications=!1,o.safeApply(),{datanodes:e,reIndexMap:a,noTopologicalSortAtSerialize:!0}},this.deserialize=function(e,a,d){return a&&s.clear(),function(){s.error=ko.observable(!1),o=[];var i,l=0,c=e.reIndexMap,f=[];_.isUndefined(e.datanodes)&&(e.datanodes=e.datasources,delete e.datasources);for(let a=0;a<e.datanodes.length;a++)"REST_web-service_from_datasource"===e.datanodes[a].type||"FMI_web-service_from_datasource"===e.datanodes[a].type||"Map_matching_from_datasource"===e.datanodes[a].type||"Clock_web-service"===e.datanodes[a].type||"Generic_file_reader_plugin"===e.datanodes[a].type||e.datanodes[a].type;if(i=e.datanodes.length,1==e.noTopologicalSortAtSerialize)for(l=0;l<i;l++)f[c[l]]=e.datanodes[l];else f=e.datanodes;for(var h,u=0,p=[],g=0;g<f.length;g++)null==f[g]&&(p[u]=g,u++);if(u)for(swal("The project file is corrupt","Project is opened in fail safe mode. Please save this new file.","error"),console.log("Error in deserialization because reindexMap "+g+" is missing in your xprjson."),g=p.length-1;g>=0;g--)f.splice(p[g],1);if(_.each(f,(function(e){if(function(e){for(var a=!1,t=0;t<s.datanodes().length;t++)if(a=!1,s.datanodes()[t].name()==e){a=!0;break}return!!a}(e.name))o.push(e);else if(!r(e))return!1})),1==e.noTopologicalSortAtSerialize&&a){var m=[],v=[];for(l=0;l<i;l++)m[l]=jQuery.extend(!0,{},s.datanodes()[l+0]);var y=Math.max.apply(Math,p),b=Math.min.apply(Math,p),D=[],k=1;for(l=0;l<c.length;l++)c[l]>y?D[l]=c[l]-u:c[l]<b?D[l]=c[l]:c[l]>b&&c[l]<y&&(D[l]=c[l]-u+k,k++);for(l=0;l<f.length;l++)v[l]=jQuery.extend(!0,{},m[D[l]]);for(s.datanodes.splice(0,i),l=0;l<v.length;l++)s.datanodes.push(v[l])}if(0!=o.length&&(h=xdsjson.getDuplicateDataList(o,"Please check data to be loaded after choosing rename or overwite option"),new DialogBoxForDuplicateData(h,"List of duplicate data name","Load","Close",(function(){var e=0;for(e=0;e<o.length;e++)$("#data-checkbox-"+e).is(":checked")&&(o[e].name=$("#data-check-"+e)[0].value);for(e=0;e<o.length;e++)if($("#data-checkbox-"+e).is(":checked"))if(o[e].name=$("#data-check-"+e)[0].value,$("#data-rename-"+e).is(":checked"))r(o[e]);else for(var a=0;a<s.datanodes().length;a++)if(s.datanodes()[a].name()==o[e].name){s.deleteDatanode(s.datanodes()[a]),s.datanodes.remove(s.datanodes()[a]),r(o[e]);break}}))),s.datanodes().length>0){var T,S=!1,x=Object.keys(t.dependencyStructure).length-f.length;if(0!=x)for(var M in t.dependencyStructure){S=!1;for(var w=0;w<f.length;w++)if(M===f[w].name){S=!0;break}if(!S){var U=Array.from(t.getSuccessors(M));swal("Missed dataNodes!","'"+M+"' is referenced in formula of '"+U+"' but doesn't exist in list of datanodes","error"),x--}if(0==x)break}var j=!1,z=!1,A=0,F=0;for(k=0;k<s.datanodes().length;k++)T=s.datanodes()[k],_.isUndefined(T.settings().refresh)?_.isUndefined(T.settings().refresh_time)?_.isUndefined(T.settings().refresh_rate)?_.isUndefined(T.settings().refreshRate)||(T.settings().sampleTime=T.settings().refreshRate,delete T.settings().refreshRate):(T.settings().sampleTime=T.settings().refresh_rate,delete T.settings().refresh_rate):(T.settings().sampleTime=T.settings().refresh_time,delete T.settings().refresh_time):(T.settings().sampleTime=T.settings().refresh,delete T.settings().refresh);t.computeAllDisconnectedGraphs();for(k=0;k<s.datanodes().length;k++)T=s.datanodes()[k],_.isUndefined(T.settings().sampleTime)||0==T.settings().sampleTime?(z=!0,F=k):(j=!0,A=k,T.sampleTime(T.settings().sampleTime),n.registerDatanode(T.sampleTime(),T.name(),"globalFirstUpdate"));j&&(T=s.datanodes()[A],n.registerDatanode(T.sampleTime(),T.name())),z&&(T=s.datanodes()[F],s.launchGlobalFirstUpdate(T))}_.isFunction(d)&&d()}(),!s.error()},this.launchGlobalFirstUpdate=function(e){var a=t.getSourceNodes();0!=a.length&&e.schedulerStart(a,a[0],"globalFirstUpdate")},this.clear=function(){if(Object.keys(t.getExtraStartNodes()).length&&t.clearExtraStartNodes(),_.each(s.datanodes(),(function(e){s.deleteDatanode(e)})),Object.keys(t.dependencyStructure).length)for(var e in t.dependencyStructure)t.removeNode(e),console.log("extra nodes are deleted");t.resetGraphList(),s.datanodes.removeAll()},this.load=function(e,t,n){a.showLoadingIndicator(!0),s.deserialize(e,t,(function(){return a.showLoadingIndicator(!1),_.isFunction(n)&&n(),!s.error()}))},this.addDatanode=function(e){for(var a=!1,t=0;t<s.datanodes().length;t++)if(a=!1,s.datanodes()[t].name()==e.name()){a=!0;break}a||s.datanodes.unshift(e)},this.deleteDatanode=function(e){var a=e.name();delete s.datasourceData[a],e.dispose()}}
...
var schedulerProfiling={},schedulerProfilingItem={};function DatanodeScheduler(e,a,t,o){if(!_.isUndefined(datanodesManager)){var n=new Set(a),d=new Set,s=new Set,r=new Set,i=new Set,l=new Set;datanodesManager.getAllDataNodes().forEach((function(e){l.add(e.name()),xDashConfig.disableSchedulerProfiling||(schedulerProfiling[e.name()]=[])}));var c=e.getDescendants(a),g=difference(l,c),u=new Set;return g.forEach((function(e){"OK"==datanodesManager.getDataNodeByName(e).status()&&u.add(e)})),{launchSchedule:function(){N()},operationCompleted:function(a,o){var i=!0;switch(o){case"OK":s.add(a),d.delete(a),e.dependencyStructure[a].forEach((function(e){m(e)&&n.add(e)})),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+a+" completed with status "+o),xDashConfig.disableSchedulerProfiling||(schedulerProfilingItem.completion=Date.now(),schedulerProfilingItem.status=o,schedulerProfiling[a].push(schedulerProfilingItem)),n.size&&(i=!1,N());break;case"Error":r.add(a),d.delete(a),e.getDescendants([a]).forEach((function(e){r.add(e),datanodesManager.getDataNodeByName(e).statusCallback("None"),datanodesManager.getDataNodeByName(e).updateCallback("","None")})),n=difference(n,r),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+a+" completed with status "+o),xDashConfig.disableSchedulerProfiling||(schedulerProfilingItem.completion=Date.now(),schedulerProfilingItem.status=o,schedulerProfiling[a].push(schedulerProfilingItem));break;case"NOP":if("OK"===datanodesManager.getDataNodeByName(a).status()){s.add(a),d.delete(a),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+a+" completed with status "+o),xDashConfig.disableSchedulerProfiling||(schedulerProfilingItem.completion=Date.now(),schedulerProfilingItem.status=o,schedulerProfiling[a].push(schedulerProfilingItem)),n.size&&(i=!1,N());break}"None"===datanodesManager.getDataNodeByName(a).status()||"Error"===datanodesManager.getDataNodeByName(a).status()?(r.add(a),d.delete(a),e.getDescendants([a]).forEach((function(e){r.add(e)})),n=difference(n,r),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+a+" completed with status "+o),xDashConfig.disableSchedulerProfiling||(schedulerProfilingItem.completion=Date.now(),schedulerProfilingItem.status=o,schedulerProfiling[a].push(schedulerProfilingItem))):console.log("datanode with explicitTrig ended with status ",datanodesManager.getDataNodeByName(a).status());break;default:return{initiatorNode:t,schedulingInstanceTerminated:!1}}return 0==d.size&&0==n.size&&i?{initiatorNode:t,schedulingInstanceTerminated:!0}:{initiatorNode:t,schedulingInstanceTerminated:!1}},stopAllOperations:function(){n.forEach((function(e){n.delete(e)})),d.forEach((function(e){d.delete(e),datanodesManager.getDataNodeByName(e).completeExecution("NOP"),datanodesManager.getDataNodeByName(e).statusCallback("None"),datanodesManager.getDataNodeByName(e).updateCallback(void 0,"None")}));var e=new Set;for(var a in datanodesManager.getAllDataNodes()){datanodesManager.getAllDataNodes()[a].schedulerStatus("Stop");var o=datanodesManager.getAllDataNodes()[a].getXHR();_.isUndefined(o)||e.add(o)}e.forEach((function(a){a.abort(),e.delete(a)})),null!=datanodesManager.getDataNodeByName(t).execInstance()&&datanodesManager.getDataNodeByName(t).schedulerEnd()},stopOperation:function(e){if(d.has(e)){d.delete(e),datanodesManager.getDataNodeByName(e).completeExecution("NOP"),datanodesManager.getDataNodeByName(e).statusCallback("None"),datanodesManager.getDataNodeByName(e).updateCallback(void 0,"None"),datanodesManager.getDataNodeByName(e).schedulerStatus("Stop");var a=datanodesManager.getDataNodeByName(e).getXHR();_.isUndefined(a)||a.abort()}},getInitiatorNode:function(){return t},getSchedulerCallOrigin:function(){return o},clear:function(){}}}function f(e){if(!_.contains(a,e))return!0;switch(o){case"triggerButton":case"vignette":case"setValue":case"setFile":case"unidentified":case"edit":case"refresh":return!1;case"globalFirstUpdate":return!0;default:return!1}}function h(e){switch(o){case"triggerButton":case"vignette":case"setValue":case"setFile":case"refresh":return!0;default:return!1}}function N(){var a=!0,t=!1;n.forEach((function(l){if(0!=n.size){if(_.isUndefined(datanodesManager.getDataNodeByName(l)))return offSchedLogUser||xDashConfig.disableSchedulerLog||console.log(l+" is not treated because it does not exist"),n.delete(l),void r.add(l);switch(datanodesManager.getDataNodeByName(l).statusForScheduler()){case"Ready":if(datanodesManager.foundDatanode(l)){var c=m(l);c?(n.delete(l),d.add(l),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+l+" released"),xDashConfig.disableSchedulerProfiling||(schedulerProfilingItem={release:Date.now()}),a=f(l),t=h(),datanodesManager.getDataNodeByName(l).updateNow(a,t,c)):(n.delete(l),i.add(l),"refresh"==o||"triggerButton"==o?(swal("Update is not available","Predecessors: "+(N=l,D="[",S=e.getPredecessorsSet(N),p=union(s,u),difference(S,p).forEach(e=>{D=D+' "'+e+'" '}),D+' ] of operation "')+l+'" need to be executed first.',"info"),datanodesManager.getDataNodeByName(l).completeExecution("NOP")):"edit"==o||"unidentified"==o?(i.delete(l),d.add(l),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+l+" released"),xDashConfig.disableSchedulerProfiling||(schedulerProfilingItem={release:Date.now()}),a=f(l),t=h(),datanodesManager.getDataNodeByName(l).updateNow(a,t,c)):(offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+l+" is ready but cannot be executed because of its predecessors."),datanodesManager.getDataNodeByName(l).completeExecution("NOP")))}else{var g=Array.from(e.getSuccessors(l));offSchedLogUser||xDashConfig.disableSchedulerLog||console.log(l+" is referenced in '"+g+"' but not defined as a datanode."),datanodesManager.getDataNodeByName(l).completeExecution("NOP")}break;case"Wait":n.delete(l),i.add(l),m(l)?offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+l+" is waiting for initialization to be done."):offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+l+" cannot be executed because of its predecessors."),datanodesManager.getDataNodeByName(l).completeExecution("NOP");break;case"NotReady":case"Stop":n.delete(l),r.add(l),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("operation "+l+" cannot not be scheduled because it needs initialization."),e.getDescendants([l]).forEach((function(e){r.add(e)})),n=difference(n,r),datanodesManager.getDataNodeByName(l).completeExecution("Error")}var N,D,S,p}else offSchedLogUser||xDashConfig.disableSchedulerLog||console.log(l+" is already treated")}))}function m(a){var t=e.getPredecessorsSet(a),o=union(s,u);return!!isSuperset(o,t)}}
...
PluginEditor=function(e){function n(e,n){var t,a=$('<div class="validation--error"></div>').html(n);_.isUndefined($("#setting-value-container-data_path")[0])||(t=$("#setting-value-container-data_path")[0].childNodes[$("#setting-value-container-data_path")[0].childNodes.length-1]),"data_path"==e&&(_.isUndefined(t)||(t.style.display="table-cell"),a[0].style.display="table-cell",a[0].style.height="25px"),"name"!=e&&"url"!=e||(_.isUndefined(t)||(t.style.display=""),a[0].style.display=""),$("#setting-value-container-"+e).append(a)}function t(n,t,a,i,s,l){var o=$('<textarea autocorrect="off" autocomplete="off" spellcheck="false" class="calculated-value-input" style="display:none; width:78%"></textarea>');a.multi_input?o.change((function(){var e=[];$(n).find("textarea").each((function(){var n=$(this).val();n&&(e=e.concat(n))})),t.settings[a.name]=e})):o.change((function(){t.settings[a.name]=$(this).val()})),i&&o.val(i);var r=$('<div class="codemirror-wrapper__top"></div>'),d=$('<div class="calculated-setting-row codemirror-wrapper"></div>');d.append(r);var c=e.displayMiniJSEditor(d,o.val(),t,(function(e){o.val(e),o.change()}));d.append(o);var p=$('<a>Full Screen view<i class="basic icn-full-screen""></i></a>').mousedown((function(n){n.preventDefault(),e.displayJSEditor(o.val(),t,a,l,(function(e){c.setValue(e),o.val(e),o.change()}))}));if(r.append(p),s){var f=$('<li class="remove-setting-row"><i class="icon-minus icon"></i><label></label></li>').mousedown((function(e){e.preventDefault(),d.remove(),$(n).find("textarea:first").change()}));r.prepend(f)}$(n).append(d),_.isUndefined(a.description1)||$(n).append($('<div class="setting-description" style="display:block;">'+a.description1+"</div>"))}var i={type:"",iconType:"",settings:{}};function s(e,n,s,l){var o,r;if(i={type:n,iconType:"",settings:{}},!_.isUndefined(l))return r=l,i.type=r,i.settings={},$(".input-wrapper-current").remove(),o=e[r],i.iconType=o.icon_type,void(_.isUndefined(o)||(angular.element(document.body).scope().$root.dataNodeDescription=o.description,_.isUndefined(o.preFillBody)?d(o.settings,o.typeahead_source,o.typeahead_data_segment):d(o.settings,o.typeahead_source,o.typeahead_data_segment,o.preFillBody)));function d(e,n,a,l){!function(){let e=$("#data-form-content")[0];for(;e.firstChild;)e.removeChild(e.firstChild)}(),_.each(e,(function(e){!_.isUndefined(e.default_value)&&_.isUndefined(s[e.name])&&(s[e.name]=e.default_value),"body"==e.name&&1==s.bodyPrefill&&(_.isUndefined(e.default_value)?s[e.name]="":""===s[e.name]&&(s[e.name]=e.default_value));var o,r=e.name;switch(_.isUndefined(e.display_name)||(r=e.display_name),o=function(e,n){let t=$('<div id="setting-row-'+e+'" class="form-row"></div>').appendTo("#data-form-content");return t.append('<div class="form-label"><label class="control-label">'+n+"</label></div>"),$('<div id="setting-value-container-'+e+'" class="form-value"></div>').appendTo(t)}(e.name,r),e.type){case"array":{var d=$('<div style="display:inline-table"></div>').appendTo(o),c=$('<div class="form-table-value-subtable" style="width:80%"></div>').appendTo(d),p=$('<table class="sub-table"></table>').appendTo(c),f=$("<thead></thead>").hide().appendTo(p),u=$("<tr></tr>").appendTo(f),m=$("<tbody></tbody>").appendTo(p),g=[];function v(){i.settings[e.name].length>0?f.show():f.hide()}function h(n){var t=$("<tr></tr>").appendTo(m),a={},s=!1;_.isArray(i.settings[e.name])||(i.settings[e.name]=[],s=!0);var l=2*i.settings[e.name].length;i.settings[e.name].push(a),_.each(e.settings,(function(i){var o=$("<td></td>").appendTo(t),r="";_.isUndefined(n[i.name])||(r=n[i.name]),a[i.name]=r;var d="table-row-value-"+e.name+l;$("<input id="+d+' class="table--row-value" type="text">').appendTo(o).val(r).change((function(){a[i.name]=$(this).val()})),s&&$("input#"+d)[0].setAttribute("readonly","readonly"),l++})),s?t.append($('<td class="table-row-operation"></td>').append($('<ul class="board-toolbar"></ul>').append($("<li></li>").append($('<i class=" icon"></i>'))))):t.append($('<td class="table-row-operation"></td>').append($('<ul class="board-toolbar"></ul>').append($("<li></li>").append($('<i class="icon-trash icon"></i>').click((function(){var n=i.settings[e.name].indexOf(a);-1!=n&&(i.settings[e.name].splice(n,1),t.remove(),v())})))))),c.scrollTop(c[0].scrollHeight),v()}if(_.each(e.settings,(function(e){var n=e.name;_.isUndefined(e.display_name)||(n=e.display_name),$("<th>"+n+"</th>").appendTo(u)})),e.name in s&&(g=s[e.name]),$('<label class="board-toolbar datasource-input-suffix"><i class="fa-plus fa"></i>ADD</label>').appendTo(d).click((function(){var n={};_.each(e.settings,(function(e){n[e.name]=""})),h(n)})),_.each(g,(function(e,n){h(e)})),0==g.length){var y={};_.each(e.settings,(function(e){y[e.name]=""})),i.settings.req_data_type="none",$("select#select-option-req_data_type")[0].value="none",h(y)}break}case"boolean":{i.settings[e.name]=s[e.name];let n=$("<div></div>").appendTo(o);var b=$('<div class="onoffswitch" style="display:inline-block"><label class="onoffswitch-label" for="'+e.name+'-onoff"><div class="onoffswitch-inner"><span class="on">YES</span><span class="off">NO</span></div><div class="onoffswitch-switch"></div></label></div>').appendTo(n),w=$('<input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="'+e.name+'-onoff">').prependTo(b).change((function(){i.settings[e.name]=this.checked}));e.name in s&&w.prop("checked",s[e.name]);break}case"browseText":if(i.settings[e.name]=s[e.name],i.settings.content=s.content,(w=$('<input type="text" id="select_file_path" style="float:left"></input><input type="file" style="display: none" id="select_file"></input><label class="board-toolbar datasource-input-suffix"><i class="fa-folder-open fa"></i>Browse...</label>')).mousedown((function(e){e.preventDefault(),$("#select_file").change((function(e){var n=this.value,t=Path2FileName(n);$("#select_file_path").val(t);var a=new FileReader;a.addEventListener("load",(function(e){var n=e.target;text=n.result,i.settings.content=text})),a.readAsText(e.target.files[0])})),$("#select_file").trigger("click")})),w.appendTo(o).change((function(){i.settings[e.name]=Path2FileName($(this).val())})),e.name in s){var T=s[e.name],x=Path2FileName(T);$("#select_file_path").val(x)}break;case"browseBinary":if(i.settings[e.name]=s[e.name],i.settings.content=s.content,(w=$('<input type="text" id="select_file_path" style="float:left"></input><input type="file" style="display: none" id="select_file"></input><label class="board-toolbar datasource-input-suffix"><i class="fa-folder-open fa"></i>Browse...</label>')).mousedown((function(e){e.preventDefault(),$("#select_file").change((function(e){var n=this.value,t=Path2FileName(n);$("#select_file_path").val(t);var a=new FileReader;a.addEventListener("load",(function(e){const n=e.target.result;i.settings.content=btoa([].reduce.call(new Uint8Array(n),(function(e,n){return e+String.fromCharCode(n)}),""))})),a.readAsArrayBuffer(e.target.files[0])})),$("#select_file").trigger("click")})),w.appendTo(o).change((function(){i.settings[e.name]=Path2FileName($(this).val())})),e.name in s){T=s[e.name],x=Path2FileName(T);$("#select_file_path").val(x)}break;case"unzip":if(i.settings[e.name]=s[e.name],i.settings.content=s.content,(w=$('<input type="text" id="select_file_path" style="float:left"></input><input type="file" style="display: none" id="select_file" accept="application/x-zip-compressed"></input><label class="board-toolbar datasource-input-suffix"><i class="fa-folder-open fa"></i>Browse...</label>')).mousedown((function(e){e.preventDefault(),$("#select_file").change((function(e){const n=e.target.files[0],t=n.size;let a="";t<1024?a=t+" bytes":t>=1024&&t<1048576?a=(t/1024).toFixed(1)+" KB":t>=1048576&&(a=(t/1048576).toFixed(1)+" MB");const s={type:n.type,size:a,name:n.name,content:""};JSZip.loadAsync(n).then((function(e){var n=[],t=[];const a=["txt","json","xprjson","xml","svg","html","css"];e.forEach((function(e,i){let s=e.split(".").pop();a.includes(s)?n.push(i.async("string").then((function(n){let a="";a="json"===s||"xprjson"===s?JSON.parse(n,null,2):n,t.push({name:e,content:a})}))):s.includes("/")||n.push(i.async("uint8array").then((function(n){let a=btoa([].reduce.call(new Uint8Array(n),(function(e,n){return e+String.fromCharCode(n)}),""));t.push({name:e,content:a})})))})),Promise.all(n).then((function(){s.content=t,i.settings.content=s}))}),(function(e){let t=new PNotify({title:"Unzip file",text:"Error reading "+n.name+": "+e.message,type:"error",styling:"bootstrap3"});$(".ui-pnotify-container").on("click",(function(){t.remove()})),console.error("Error reading "+n.name+": "+e.message)}));var l=this.value,o=Path2FileName(l);$("#select_file_path").val(o)})),$("#select_file").trigger("click")})),w.appendTo(o).change((function(){i.settings[e.name]=Path2FileName($(this).val())})),e.name in s){T=s[e.name],x=Path2FileName(T);$("#select_file_path").val(x)}break;case"json":if(i.settings[e.name]=s[e.name],i.settings.content=s.content,_.isUndefined($("#var-body")[0]))(w=$('<input type="text" title="'+e.display_name+'" class="input__wrapper--text" id="var-body" autocorrect="off" autocomplete="off" spellcheck="false" />')).appendTo(o).change((function(){i.settings[e.name]=$(this).val();let n=datanodesManager.getJsonEditor();datanodesManager.getJsonEd().updateEditor(n,$(this).val())})),$('<div class="btn-wrapper btn-wrapper--no-label input-wrapper-current" id="btn-json">').appendTo($("#data-form-content")),$('<div class="tree__preview__container input-wrapper-current" style="height:unset"><div id="full-screen-json" class="tree__preview__container--top"><a><p>Full Screen view</p><i class="basic icn-full-screen"></i></a></div><div id="tree-preview" style="height: 36vh;"></div></div>').appendTo($("#data-form-content")),$("#full-screen-json").on("click",(function(){var e=document.getElementById("tree-preview");e.requestFullscreen?e.requestFullscreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.msRequestFullscreen&&e.msRequestFullscreen()})),datanodesManager.getJsonEd().displayJSONEdit(w.val(),(function(e){w.val(e),w.change()}));if(e.name in s){$("#var-body").val(s[e.name]);let n=datanodesManager.getJsonEditor();datanodesManager.getJsonEd().updateEditor(n,s[e.name])}break;case"option":var k=s[e.name],N="select-option-"+e.name;w=$('<select id="'+N+'"></select>').appendTo($('<div class="styled-select"></div>').appendTo(o)).change((function(){i.settings[e.name]=$(this).val(),("FMI_webservice"===e.name&&i.settings.bodyPrefill||"req_data_type"===e.name)&&l()}));_.each(e.options,(function(e){var n,t;_.isObject(e)?(n=e.name,t=e.value):n=e,_.isUndefined(t)&&(t=n),_.isUndefined(k)&&(k=t),$("<option></option>").text(n).attr("value",t).appendTo(w)})),i.settings[e.name]=k,e.name in s&&w.val(s[e.name]);break;case"custom1":case"custom2":i.settings[e.name]=s[e.name],e.implementation(o,e,s,i);break;default:if(i.settings[e.name]=s[e.name],"calculated"==e.type){if(e.name in s){var S=s[e.name];if(e.multi_input&&_.isArray(S))for(var F=!1,U=0;U<S.length;U++)t(o,i,e,S[U],F),F=!0;else t(o,i,e,S,!1)}else t(o,i,e,null,!1);if(e.multi_input){var C=$('<ul class="board-toolbar"><li class="add-setting-row"><i class="fa-plus fa"></i><label>ADD</label></li></ul>').mousedown((function(n){n.preventDefault(),t(o,i,e,null,!0)}));$(o).siblings(".form-label").append(C)}}else if(w=$('<input type="text" title="'+e.display_name+'" class="input__wrapper--text" />').appendTo(o).change((function(){if("name"==e.name&&($('<input type="text">')[0].maxLength=40),"number"==e.type)i.settings[e.name]=Number($(this).val());else{var n=!1,t="";for(var t in widgetConnector.widgetsConnection){for(var a in widgetConnector.widgetsConnection[t].sliders)if("None"!=widgetConnector.widgetsConnection[t].sliders[a].name&&!_.isUndefined(widgetConnector.widgetsConnection[t].sliders[a].connectedDataNodeS)&&widgetConnector.widgetsConnection[t].sliders[a].connectedDataNodeS===i.settings[e.name]){n=!0;break}if(n)break}n&&swal("'"+i.settings[e.name]+"' is now missing","Connections with widget '"+widgetConnector.widgetsConnection[t].modelJsonId+"' may be removed!","warning"),i.settings[e.name]=$(this).val()}})),e.name in s&&w.val(s[e.name]),n&&e.typeahead_data_field&&w.addClass("typeahead_data_field-"+e.typeahead_data_field),n&&e.typeahead_field){var P=[];w.keyup((function(e){e.which>=65&&e.which<=91&&w.trigger("change")})),$(w).autocomplete({source:P,select:function(e,n){w.val(n.item.value),w.trigger("change")}}),w.change((function(t){var i=w.val(),s=_.template(n)({input:i});$.get(s,(function(n){if(a&&(n=n[a]),n=_.select(n,(function(n){return n[e.typeahead_field][0]==i[0]})),P=_.map(n,(function(n){return n[e.typeahead_field]})),$(w).autocomplete("option","source",P),1==n.length)for(var t in n=n[0])if(n.hasOwnProperty(t)){var s=$(_.template("input.typeahead_data_field-<%= field %>")({field:t}));s&&(s.val(n[t]),s.val()!=w.val()&&s.trigger("change"))}}))}))}}_.isUndefined(e.suffix)||o.append($('<div class="input--suffix">'+e.suffix+"</div>")),_.isUndefined(e.description)||o.append($('<div class="setting-description">'+e.description+"</div>"))}))}for(var c=[{name:"JSON",searchString:["Variable"]},{name:"Python",searchString:["Pyodide"]},{name:"JavaScript",searchString:["client-side"]},{name:"APIs",searchString:["REST"]},{name:"Files",searchString:["Generic","CSV file","Unzip"]},{name:"Streams & Real-time",searchString:["Clock","Delay","WebSocket","MQTT","Geoloc"]},{name:"Others",searchString:""}],p=[],f=0;f<c.length;f++)p[c[f].name]=[];if(_.each(e,(function(e){for(var n=c.length-1,t=0;t<c.length;t++){for(var a=!1,i=0;i<c[t].searchString.length;i++)if(-1!=e.display_name.search(c[t].searchString[i])){n=t,a=!0;break}if(a)break}p[c[n].name].push({name:e.display_name,type:e.type_name})})),1==$("#datanode-list")[0].childNodes.length){$("#datanode-list")[0].innerHTML="",$('<div class="panel--content--top"><h1>New</h1><button ng-click="editorView.newDatanodePanel.view=!editorView.newDatanodePanel.view" class="btn btn-icon-only"><i class="basic icn-miniarrowleft"></i></button></div>').appendTo($("#datanode-list"));for(let e=0;e<c.length;e++)if(p[c[e].name].length>0){var u=$('<div class="add__new__datanode--list--wrap"></div>').appendTo($("#datanode-list"));$("<span>"+c[e].name+"</span>").appendTo(u);let n=$("<ul></ul>").appendTo(u);for(let t=0;t<p[c[e].name].length;t++)a=$('<a title="Open '+c[e].name+" : "+p[c[e].name][t].name+' dataNode" ng-click="openDataNodeTypePlugin(\''+p[c[e].name][t].type+"')\"></a>").appendTo($("<li></li>").appendTo(n)),a.text(p[c[e].name][t].name),$('<i class="basic icn-miniarrowright"></i>').appendTo(a)}angular.element(document.body).scope().$root.myDataNodeHTML=$("#datanode-list").html()}}return{createPluginEditor:function(e,n,t,a){s(e,n,t,a)},getNewSettings:function(){return i},saveSettings:function(e,t,a){return function(e,t,a){$(".validation--error").remove(),""===i.type&&(i=t);for(var s=0;s<e.settings.length;s++){var l=e.settings[s];if(l.required&&(_.isUndefined(i.settings[l.name])||""==i.settings[l.name]))return n(l.name,"This is required."),!0;if("integer"==l.type&&i.settings[l.name]%1!=0)return n(l.name,"Must be a whole number."),!0;if("number"==l.type&&(o=i.settings[l.name],isNaN(parseFloat(o))||!isFinite(o)))return n(l.name,"Must be a number."),!0;if("text"==l.type&&"name"==l.name&&-1!==i.settings[l.name].indexOf("\\"))return n(l.name,"Backslash '\\' is forbidden."),!0}var o;if("JSON_var_plugin"==i.type){datanodesManager.getJsonEd().updateVal()}return"Map_matching_from_datanode"!=i.type||navigator.onLine?_.isFunction(a)?!1!==a(i):void 0:(swal("Need internet connection for '"+i.settings.name+"'","Please verify your connection then reload the page","error"),!1)}(e,t,a)}}};
...
!function(){var e=function(e,n,a){t=!1;var i=e;this.updateNow=function(e,t){if(!t&&!1===i.autoStart)return{notTobeExecuted:!0};t&&i.sampleTime>0&&(i.autoStart=!0),a("Pending");var o=new Date,r={numeric_value:o.getTime(),full_string_value:o.toLocaleString(),date_string_value:o.toLocaleDateString(),time_string_value:o.toLocaleTimeString(),date_object:o};return a("OK"),n(r),!0},this.onDispose=function(){},this.onSettingsChanged=function(e,t){return"OK"===t&&(t,i),i=e,!0},this.isSettingNameChanged=function(e){return i.name!=e},this.isSettingSampleTimeChanged=function(e){return i.sampleTime!=e},this.isSetValueValid=function(){return!1},this.isSetFileValid=function(){return!1},this.isInternetNeeded=function(){return!1}},t=!1;datanodesManager.loadDatanodePlugin({type_name:"Clock_web-service",display_name:"Clock",icon_type:"clock.svg",description:"Clock trigger",settings:[{name:"sampleTime",display_name:"Sample time",type:"number",suffix:"seconds",default_value:1},{name:"autoStart",display_name:"AUTO START",description:"Starts datanode automatically after dashboard play begins or after creation or modification.",type:"boolean",default_value:!0}],newInstance:function(n,a,i,o){return a(new e(n,i,o)),!t}})}();
...
function baseWidget(e,o,r,t){this.idDivContainer=e,this.idWidget=o,this.idInstance=r,this.bIsInteractive=t,this.getColorValueFromCSSProperty=function(e){var o=e;if(o.includes("var(--")){var r=e.substring(4,e.length-1);o=window.getComputedStyle(document.documentElement).getPropertyValue(r)}return o},this.labelFontSize=function(){return"font-size: calc(7px + "+modelsParameters[r].labelFontSize*getFontFactor()+"vw + 0.4vh); "},this.valueFontSize=function(){return"font-size: calc(7px + "+modelsParameters[r].valueFontSize*getFontFactor()+"vw + 0.4vh); "},this.valueFormat=function(e){var o=parseInt(modelsParameters[r].decimalDigits,10);if(isNaN(o))return e;var t=e;if(-1!=o&&!isNaN(e)){if(t=parseFloat(e),isNaN(t))return e;t=Math.round10(t,-o)}return t},this.fontSize=function(){return"font-size: calc(7px + "+modelsParameters[r].fontsize*getFontFactor()+"vw + 0.4vh); "},this.selectFontSize=function(){return"font-size: calc(7px + "+modelsParameters[r].selectValueFontSize*getFontFactor()+"vw + 0.4vh); "},this.labelColor=function(){return _.isUndefined(modelsParameters[r].labelColor)&&(modelsParameters[r].labelColor="#2154ab"),"color:"+modelsParameters[r].labelColor+"; "},this.valueColor=function(){return _.isUndefined(modelsParameters[r].valueColor)&&(modelsParameters[r].valueColor="#34495e"),"color:"+modelsParameters[r].valueColor+"; "},this.labelFontFamily=function(){return _.isUndefined(modelsParameters[r].labelFontFamily)&&(modelsParameters[r].labelFontFamily="Helvetica Neue"),"font-family: "+modelsParameters[r].labelFontFamily+", Helvetica, Arial, sans-serif; "},this.valueFontFamily=function(){return _.isUndefined(modelsParameters[r].valueFontFamily)&&(modelsParameters[r].valueFontFamily="Helvetica Neue"),"font-family: "+modelsParameters[r].valueFontFamily+", Helvetica, Arial, sans-serif; "},this.buttonFontFamily=function(){return _.isUndefined(modelsParameters[r].buttonFontFamily)&&(modelsParameters[r].buttonFontFamily="Helvetica Neue"),"font-family: "+modelsParameters[r].buttonFontFamily+", Helvetica, Arial, sans-serif; "},this.setButtonColorStyle=function(){_.isUndefined(modelsParameters[r].buttonDefaultColor)&&(modelsParameters[r].buttonDefaultColor="#447bdc"),_.isUndefined(modelsParameters[r].buttonHoverColor)&&(modelsParameters[r].buttonHoverColor="#a9c3ef"),_.isUndefined(modelsParameters[r].buttonActiveColor)&&(modelsParameters[r].buttonActiveColor="#2154ab"),_.isUndefined(modelsParameters[r].buttonTextColor)&&(modelsParameters[r].buttonTextColor="#ffffff");var e="styleNormalFor"+r+"widgetCustomColor",o=document.getElementById(e),s="."+r+"widgetCustomColor{ color: "+modelsParameters[r].buttonTextColor+";background-color: "+modelsParameters[r].buttonDefaultColor+";border-color: "+modelsParameters[r].buttonDefaultColor+"; }";if(null==o?((o=document.createElement("style")).type="text/css",o.id=e,o.innerHTML=s,document.getElementsByTagName("head")[0].appendChild(o)):o.innerHTML=s,t){var a="styleHoverFor"+r+"widgetCustomColor",l=document.getElementById(a),n="."+r+"widgetCustomColor:hover{ background-color: "+modelsParameters[r].buttonHoverColor+";border-color: "+modelsParameters[r].buttonHoverColor+";}";null==l?((l=document.createElement("style")).type="text/css",l.id=a,l.innerHTML=n,document.getElementsByTagName("head")[0].appendChild(l)):l.innerHTML=n;var d="styleActiveFor"+r+"widgetCustomColor",i=document.getElementById(d),m="."+r+"widgetCustomColor:active{ background-color: "+modelsParameters[r].buttonActiveColor+";border-color: "+modelsParameters[r].buttonActiveColor+";}";null==i?((i=document.createElement("style")).type="text/css",i.id=d,i.innerHTML=m,document.getElementsByTagName("head")[0].appendChild(i)):i.innerHTML=m}},this.border=function(){var e="border: none; ";return modelsParameters[r].displayBorder?(_.isUndefined(modelsParameters[r].borderColor)&&(modelsParameters[r].borderColor="#447bdc"),e=" border: 2px solid "+modelsParameters[r].borderColor+"; "):(e+="-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);",e+="-moz-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);",e+="box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);"),e},this.captionHelper=function(e,o,t){o?modelsParameters[r].label=e:t?modelsParameters[r].inheritLabelFromData=!1:modelsParameters[r].label=e},this.validationButtonDefaultColor=function(){return _.isUndefined(modelsParameters[r].validationBtnDefaultColor)&&(modelsParameters[r].validationBtnDefaultColor="#447bdc"),"background-color:"+modelsParameters[r].validationBtnDefaultColor+"; "},this.validationButtonHoverColor=function(){return _.isUndefined(modelsParameters[r].validationBtnHoverColor)&&(modelsParameters[r].validationBtnHoverColor="#a9c3ef"),"background-color:"+modelsParameters[r].validationBtnHoverColor+"; "},this.validationButtonActiveColor=function(){return _.isUndefined(modelsParameters[r].validationBtnActiveColor)&&(modelsParameters[r].validationBtnActiveColor="#2154ab"),"background-color:"+modelsParameters[r].validationBtnActiveColor+"; "},this.validationButtonBorderColor=function(){var e="border: none; ";return modelsParameters[r].displayBorder?(_.isUndefined(modelsParameters[r].validationBtnDefaultColor)&&(modelsParameters[r].validationBtnDefaultColor="#2154ab"),e="border: 2px solid "+modelsParameters[r].validationBtnDefaultColor+"; "):(e+="-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);",e+="-moz-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);",e+="box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);"),e},this.graphColor=function(){return _.isUndefined(modelsParameters[r].graphColor)&&(modelsParameters[r].graphColor="#007a87"),this.getColorValueFromCSSProperty(modelsParameters[r].graphColor)},this.subLabelFontFamily=function(){return _.isUndefined(modelsParameters[r].subLabelFontFamily)&&(modelsParameters[r].subLabelFontFamily="Helvetica Neue"),"font-family: "+modelsParameters[r].subLabelFontFamily+", Helvetica, Arial, sans-serif; "},this.subLabelColor=function(){return _.isUndefined(modelsParameters[r].subLabelColor)&&(modelsParameters[r].subLabelColor="#34495e"),"color:"+modelsParameters[r].subLabelColor+"; "},this.subLabelFontSize=function(){return"font-size: calc(7px + "+modelsParameters[r].subLabelFontSize*getFontFactor()+"vw + 0.4vh); "},this.switchOnColor=function(){return _.isUndefined(modelsParameters[r].switchOnColor)&&(modelsParameters[r].switchOnColor="#447bdc"),"background-color: "+modelsParameters[r].switchOnColor+"; "},this.switchOffColor=function(){return _.isUndefined(modelsParameters[r].switchOffColor)&&(modelsParameters[r].switchOffColor="#ccc"),"background-color: "+modelsParameters[r].switchOffColor+"; "},this.switchShadowColor=function(){return _.isUndefined(modelsParameters[r].switchOnColor)&&(modelsParameters[r].switchOnColor="#447bdc"),"box-shadow: 0 0 1px "+modelsParameters[r].switchOnColor+"; "},this.progressBarRangeColor=function(){return _.isUndefined(modelsParameters[r].progressBarRangeColor)&&(modelsParameters[r].progressBarRangeColor="#447bdc"),"background-color: "+modelsParameters[r].progressBarRangeColor+"; "},this.progressBarSegmentColor=function(){return _.isUndefined(modelsParameters[r].progressBarSegmentColor)&&(modelsParameters[r].progressBarSegmentColor="#ebedef"),"background-color: "+modelsParameters[r].progressBarSegmentColor+"; "},this.sliderRangeColor=function(){return _.isUndefined(modelsParameters[r].sliderRangeColor)&&(modelsParameters[r].sliderRangeColor="#447bdc"),"background-color: "+modelsParameters[r].sliderRangeColor+"; "},this.sliderSegmentColor=function(){return _.isUndefined(modelsParameters[r].sliderSegmentColor)&&(modelsParameters[r].sliderSegmentColor="#ebedef"),"background-color: "+modelsParameters[r].sliderSegmentColor+"; "},this.sliderHandleDefaultColor=function(){return _.isUndefined(modelsParameters[r].sliderHandleDefaultColor)&&(modelsParameters[r].sliderHandleDefaultColor="#2154ab"),"background-color: "+modelsParameters[r].sliderHandleDefaultColor+"; "},this.sliderHandleHoverColor=function(){return _.isUndefined(modelsParameters[r].sliderHandleHoverColor)&&(modelsParameters[r].sliderHandleHoverColor="#a9c3ef"),"background-color: "+modelsParameters[r].sliderHandleHoverColor+"; "},this.sliderHandleActiveColor=function(){return _.isUndefined(modelsParameters[r].sliderHandleActiveColor)&&(modelsParameters[r].sliderHandleActiveColor="#a9c3ef"),"background-color: "+modelsParameters[r].sliderHandleActiveColor+"; "},this.valueBorderColor=function(){return _.isUndefined(modelsParameters[r].valueBorderColor)&&(modelsParameters[r].valueBorderColor="#447bdc"),"border-color: "+modelsParameters[r].valueBorderColor+"; "},this.textSize=function(){return"font-size: calc(7px + "+modelsParameters[r].textSize*getFontFactor()+"vw + 0.4vh); "},this.textColor=function(){return _.isUndefined(modelsParameters[r].textColor)&&(modelsParameters[r].textColor="#3e3f47"),"color: "+modelsParameters[r].textColor+"; "},this.subTextColor=function(){return _.isUndefined(modelsParameters[r].subTextColor)&&(modelsParameters[r].subTextColor="#88878e"),"color: "+modelsParameters[r].subTextColor+"; "},this.browseButtonTextColor=function(){_.isUndefined(modelsParameters[r].browseButtonTextColor)&&(modelsParameters[r].browseButtonTextColor="#e0807f");var e=" color: "+modelsParameters[r].browseButtonTextColor+"; ";return e=e+" border-color: "+modelsParameters[r].browseButtonTextColor+"; "},this.browseButtonDefaultColor=function(){return _.isUndefined(modelsParameters[r].browseButtonDefaultColor)&&(modelsParameters[r].browseButtonDefaultColor="#ffffff")," background-color: "+modelsParameters[r].browseButtonDefaultColor+"; "},this.browseButtonHoverColor=function(){return _.isUndefined(modelsParameters[r].browseButtonHoverColor)&&(modelsParameters[r].browseButtonHoverColor="#ffffff")," background-color: "+modelsParameters[r].browseButtonHoverColor+"; "},this.browseButtonActiveColor=function(){return _.isUndefined(modelsParameters[r].browseButtonActiveColor)&&(modelsParameters[r].browseButtonActiveColor="#ffffff")," background-color: "+modelsParameters[r].browseButtonActiveColor+"; "},this.deleteButtonDefaultColor=function(){_.isUndefined(modelsParameters[r].deleteButtonDefaultColor)&&(modelsParameters[r].deleteButtonDefaultColor="#e8eaf1");var e=" background-color: "+modelsParameters[r].deleteButtonDefaultColor+"; ";return e=e+" box-shadow: 0 0 2px 3px "+modelsParameters[r].deleteButtonDefaultColor+"; "},this.deleteButtonActiveColor=function(){_.isUndefined(modelsParameters[r].deleteButtonActiveColor)&&(modelsParameters[r].deleteButtonActiveColor="#e0807f");var e=" background-color: "+modelsParameters[r].deleteButtonActiveColor+"; ";return e=e+" box-shadow: 0 0 2px 3px "+modelsParameters[r].deleteButtonActiveColor+"; "},this.deleteButtonHoverColor=function(){_.isUndefined(modelsParameters[r].deleteButtonHoverColor)&&(modelsParameters[r].deleteButtonHoverColor="#e0807f");var e=" background-color: "+modelsParameters[r].deleteButtonHoverColor+"; ";return e=e+" box-shadow: 0 0 2px 3px "+modelsParameters[r].deleteButtonHoverColor+"; "},this.listBackgroundColor=function(){return _.isUndefined(modelsParameters[r].listBackgroundColor)&&(modelsParameters[r].listBackgroundColor="#ffffff")," background-color: "+modelsParameters[r].listBackgroundColor+"; "},this.selectValueColor=function(){return _.isUndefined(modelsParameters[r].selectValueColor)&&(modelsParameters[r].selectValueColor="#34495e")," color: "+modelsParameters[r].selectValueColor+"; "},this.selectValueBackgroundColor=function(){return _.isUndefined(modelsParameters[r].selectValueBackgroundColor)&&(modelsParameters[r].selectValueBackgroundColor="#cecece")," background-color: "+modelsParameters[r].selectValueBackgroundColor+"; "},this.valueDefaultColor=function(){return _.isUndefined(modelsParameters[r].valueDefaultColor)&&(modelsParameters[r].valueDefaultColor="#666666")," color: "+modelsParameters[r].valueDefaultColor+"; "},this.valueFocusColor=function(){return _.isUndefined(modelsParameters[r].valueFocusColor)&&(modelsParameters[r].valueFocusColor="#666666")," color: "+modelsParameters[r].valueFocusColor+"; "},this.valueHoverColor=function(){return _.isUndefined(modelsParameters[r].valueHoverColor)&&(modelsParameters[r].valueHoverColor="#000000")," color: "+modelsParameters[r].valueHoverColor+"; "},this.checkboxDefaultColor=function(){return _.isUndefined(modelsParameters[r].checkboxDefaultColor)&&(modelsParameters[r].checkboxDefaultColor="#ffffff")," background-color: "+modelsParameters[r].checkboxDefaultColor+"; "},this.checkboxFocusColor=function(){return _.isUndefined(modelsParameters[r].checkboxFocusColor)&&(modelsParameters[r].checkboxFocusColor="#bdd7ee")," background-color: "+modelsParameters[r].checkboxFocusColor+"; "},this.checkboxHoverColor=function(){return _.isUndefined(modelsParameters[r].checkboxHoverColor)&&(modelsParameters[r].checkboxHoverColor="#ffffff")," background-color: "+modelsParameters[r].checkboxHoverColor+"; "},this.checkboxHoverBorderColor=function(){return _.isUndefined(modelsParameters[r].checkboxHoverBorderColor)&&(modelsParameters[r].checkboxHoverBorderColor="#171819")," border-color: "+modelsParameters[r].checkboxHoverBorderColor+"; "},this.checkboxFocusBorderColor=function(){return _.isUndefined(modelsParameters[r].checkboxFocusBorderColor)&&(modelsParameters[r].checkboxFocusBorderColor="#171819")," border-color: "+modelsParameters[r].checkboxFocusBorderColor+"; "},this.checkboxWidth=function(){return _.isUndefined(modelsParameters[r].checkboxWidth)&&(modelsParameters[r].checkboxWidth=7)," width: "+modelsParameters[r].checkboxWidth+"rem; "},this.checkboxHeight=function(){return _.isUndefined(modelsParameters[r].checkboxHeight)&&(modelsParameters[r].checkboxHeight=1.5)," line-height: "+modelsParameters[r].checkboxHeight+"; "},this.checkboxBorder=function(){var e="border: none; ";return modelsParameters[r].displayBorder?(_.isUndefined(modelsParameters[r].checkboxBorderColor)&&(modelsParameters[r].checkboxBorderColor="#171819"),e=" border: 1.5px solid "+modelsParameters[r].checkboxBorderColor+"; "):(e+="-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);",e+="-moz-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);",e+="box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0);"),e},this.selectedValueColor=function(){return _.isUndefined(modelsParameters[r].selectedValueColor)&&(modelsParameters[r].selectedValueColor="#ffffff")," color: "+modelsParameters[r].selectedValueColor+"; "},this.selectedItemDefaultColor=function(){return _.isUndefined(modelsParameters[r].selectedItemDefaultColor)&&(modelsParameters[r].selectedItemDefaultColor="#447bdc")," background-color: "+modelsParameters[r].selectedItemDefaultColor+"; "},this.selectedItemHoverColor=function(){return _.isUndefined(modelsParameters[r].selectedItemHoverColor)&&(modelsParameters[r].selectedItemHoverColor="#a9c3ef")," background-color: "+modelsParameters[r].selectedItemHoverColor+"; "},this.valueAlign=function(){_.isUndefined(modelsParameters[r].ValueAlign)||delete modelsParameters[r].ValueAlign,_.isUndefined(modelsParameters[r].valueAlign)&&(modelsParameters[r].valueAlign="left");return" text-align: "+modelsParameters[r].valueAlign+"; "},this.thicknessBackgroundColor=function(){return _.isUndefined(modelsParameters[r].thicknessBackgroundColor)&&(modelsParameters[r].thicknessBackgroundColor="#ebedef"),' background-color="'+this.getColorValueFromCSSProperty(modelsParameters[r].thicknessBackgroundColor)+'" '},this.thicknessColor=function(){return _.isUndefined(modelsParameters[r].thicknessColor)&&(modelsParameters[r].thicknessColor="#447bdc"),' foreground-color="'+this.getColorValueFromCSSProperty(modelsParameters[r].thicknessColor)+'" '},this.thicknessBackgroundColor=function(){return _.isUndefined(modelsParameters[r].thicknessBackgroundColor)&&(modelsParameters[r].thicknessBackgroundColor="#ebedef"),' background-color="'+this.getColorValueFromCSSProperty(modelsParameters[r].thicknessBackgroundColor)+'" '},this.thicknessColor=function(){return _.isUndefined(modelsParameters[r].thicknessColor)&&(modelsParameters[r].thicknessColor="#447bdc"),' foreground-color="'+this.getColorValueFromCSSProperty(modelsParameters[r].thicknessColor)+'" '},this.tipBackgroundColor=function(){return _.isUndefined(modelsParameters[r].tipBackgroundColor)&&(modelsParameters[r].tipBackgroundColor="#2A3F54"),this.getColorValueFromCSSProperty(modelsParameters[r].tipBackgroundColor)},this.tipBorderColor=function(){return _.isUndefined(modelsParameters[r].tipBorderColor)&&(modelsParameters[r].tipBorderColor="#FFF"),this.getColorValueFromCSSProperty(modelsParameters[r].tipBorderColor)}}baseWidget.prototype.getActuatorDescriptions=function(e=null){return[]},baseWidget.prototype.getByName=function(e){if(this.hasOwnProperty(e))return this[e]},baseWidget.prototype.getInteractive=function(){return this.bIsInteractive},baseWidget.prototype.setInteractive=function(e){e!=this.bIsInteractive&&(this.bIsInteractive=e,this.render())},baseWidget.prototype.rescale=function(){},baseWidget.prototype.render=function(){};class WidgetActuator{setValue(e){}getValue(){}addValueChangedHandler(e){}removeValueChangedHandler(e){}setCaption(e,o){}clearCaption(){}}class WidgetActuatorBase extends WidgetActuator{static NOOP_CALLBACK=function(e,o,r){};constructor(e){super(),this.widget=e}updateCallback=WidgetActuatorBase.NOOP_CALLBACK;addValueChangedHandler(e){this.updateDataFromWidget=e}removeValueChangedHandler(e){this.updateDataFromWidget=WidgetActuatorBase.NOOP_CALLBACK}}class WidgetActuatorDescription{static TRIGGER=0;static READ=1;static WRITE=2;static READ_WRITE=WidgetActuatorDescription.READ|WidgetActuatorDescription.WRITE;static FILE=4;constructor(e,o,r,t=null,s=null){this._name=e,this._summary=o,this._readwrite=r,this._schema=t,this._validator=s}get name(){return this._name}get summary(){return this._summary}get direction(){return this._readwrite}get jsonSchema(){return this._schema}get validator(){return this._validator}}class WidgetActuatorValidationError{constructor(e,o){this._msg=e,this._nested=o||[]}get msg(){return this._msg}get nested(){return this._nested}toString(){return this._print().join("\n")}_print(e=""){return[e+"- "+this._msg,...this._nested.flatMap(o=>o._print(e+"   "))]}compareTo(e){const o=this.msg.localeCompare(e.msg);if(0!==o)return o;const r=this.nested.length,t=r-e.nested.length;if(0!==t)return t;for(let o=0;o<r;o++){const r=this.nested[o].compareTo(e.nested[o]);if(0!==r)return r}return 0}}
...
var widgetConnector=function(){var e=[];function t(){const e=angular.element(document.body).injector();e&&e.has("EventCenterService")&&e.invoke(["EventCenterService",e=>{e.sendEvent(EVENTS_EDITOR_CONNECTIONS_CHANGED)}])}function n(){for(const t in e)widgetEditor.widgetContainers.get(e[t].id)||delete e[t];for(const[t,n]of widgetEditor.widgetContainers)if(e[t]){if(widgetEditor.widgetObject[t]){if(!_.isNull(e[t].widgetObjEdit)&&!_.isNull(widgetEditor.widgetObject[t])){let n=e[t].widgetObjEdit.numberOfTriggers-widgetEditor.widgetObject[t].numberOfTriggers;for(;n>0;){let d=Object.keys(e[t].sliders);delete e[t].sliders[d[d.length-1]],n--}}e[t].widgetObjEdit=widgetEditor.widgetObject[t]}}else e[t]={name:t,id:t,instanceId:t,modelJsonId:n.modelJsonId,sliders:[],widgetObjEdit:widgetEditor.widgetObject[t],widgetObjConnect:null};t()}function d(){for(const t in e)i(t);t()}function i(t){const n=e[t];for(const e in n.sliders){const t=n.sliders[e];t.dataNode="None",t.dataFields.length=0,t.dataNodeIndex=-1}}function o(){for(const t in e)delete e[t];d()}return{widgetsConnection:e,updateWidgetsConnections:n,effectiveSliders:function(){let t=[];return _.each(_.keys(e),n=>{let d=_.keys(e[n].sliders);for(let e=0;e<d.length;e++)_.isEmpty(d[e])||t.push(d[e])}),_.uniq(t)},resetSingleMatchingBox:d,serialize:function(){const t={};for(const n in e){t[n]={};for(const d in e[n].sliders)t[n][d]=jQuery.extend(!0,{},e[n].sliders[d])}return t},deserialize:function(d){o(),n();for(var i=[],a=0;a<datanodesManager.getAllDataNodes().length;a++)i[a]=datanodesManager.getAllDataNodes()[a].name();for(const t in e)for(const n in d[t])_.isUndefined(d[t][n].dataNode)&&(d[t][n].dataNode=d[t][n].dataSource,d[t][n].dataNodeIndex=d[t][n].dataSourceIndex,delete d[t][n].dataSource,delete d[t][n].dataSourceIndex),e[t].sliders[n]=d[t][n];for(let t in e)try{widgetConnector.updateDataNodeIndex(t),widgetPreview.plotConstantData(t,!1)}catch(e){console.error(e)}t()},clear:o,updateDataNodeIndex:function(n){if(e[n]){var d="",i=-1;for(let t in e[n].sliders)if("None"!=e[n].sliders[t].dataNode){e[n].sliders[t].name,d=e[n].sliders[t].dataNode;for(let e=0;e<datanodesManager.getAllDataNodes().length;e++)d==datanodesManager.getAllDataNodes()[e].name()&&(i=e);e[n].sliders[t].dataNodeIndex=i}}t()},duplicateConnection:function(n,d){e[n]=jQuery.extend(!0,{},e[d.id]),e[n].id=n,e[n].name=n,e[n].instanceId=n,t()},refreshDatanodeConsumers:function(t,n,d,i){for(const o in e){const a=e[o];for(const e in a.sliders){const r=a.sliders[e];if("None"!=r.name){let s=null;null!=a.widgetObjEdit?s=a.widgetObjEdit.getByName(r.name):null!=a.widgetObjConnect&&(s=a.widgetObjConnect.getByName(r.name)),null!=s&&(r.dataNode===n?"Python_pyodide_plugin"==datanodesManager.getDataNodeByName(n).type()&&"fig"===e?widgetPreview.setDataOnWidget(o,e,s,n,d,i,!1):widgetPreview.setDataOnWidget(o,e,s,t,d,i,!1):r.dataNode)}}}}}}();
function displaySpinnerOnInputFileButton(e,t){var n=document.getElementById("button"+t),a=document.getElementById("button"+t+"_select_file"),o=document.createElement("i");let d;var i=function(){n.setAttribute("class","btn btn-block btn-lg "+e+"widgetCustomColor "),o&&o.remove()};n.setAttribute("class","btn btn-block btn-lg disabled"),o.setAttribute("id","icon"+t),o.setAttribute("class","fa fa-spinner fa-spin"),n.append(o),a.onchange=function(){clearTimeout(d),document.body.focus(),i()},document.body.onfocus=function(){d=setTimeout(()=>{i(),document.body.onfocus=null},200)}}function updateDataSourceFromWidget(e,t){if(!_.isUndefined(widgetConnector.widgetsConnection[e])){var n,a=widgetConnector.widgetsConnection[e].sliders,o=[];if(!_.isUndefined(a)){for(var d in a)-1!=(n=a[d].dataNodeIndex)&&(n=void 0,o.push(datanodesManager.getAllDataNodes()[n].name()));o.length>0&&(-1==n&&(n=void 0),datanodesManager.getAllDataNodes()[n].schedulerStart(o,o[0],"triggerButton"))}}}function updateDataSourceFromWidgetwithspinButton(e,t){var n=document.getElementById("button"+t),a=document.createElement("i");if(a.setAttribute("id","icon"+t),n.append(a),!_.isUndefined(widgetConnector.widgetsConnection[e])){var o,d,i=widgetConnector.widgetsConnection[e].sliders,s=[];if(!_.isUndefined(i)){for(var r in i)-1!=(o=i[r].dataNodeIndex)&&(d=o,s.push(datanodesManager.getAllDataNodes()[o].name()));if(s.length>0){-1==o&&(o=d),datanodesManager.getAllDataNodes()[o].schedulerStart(s,s[0],"triggerButton");var l=setInterval((function(){var n=[];s.forEach(e=>{"Pending"==datanodesManager.getDataNodeByName(e).status()&&($("#button"+t).attr("class","btn btn-block btn-lg disabled"),n.push(!0),$(a).hasClass("fa fa-spinner fa-spin")||a.setAttribute("class","fa fa-spinner fa-spin"))}),0==n.length&&($("#button"+t).attr("class","btn btn-block btn-lg "+e+"widgetCustomColor "),document.getElementById("icon"+t).remove(),a.remove(),clearInterval(l))}),100)}}}}function updateDataSourceFileFromWidget(e,t){if(!_.isUndefined(widgetConnector.widgetsConnection[e])){var n=widgetConnector.widgetsConnection[e].sliders;if(!_.isUndefined(n))for(var a in n){var o=n[a].dataNodeIndex;-1!=o&&datanodesManager.getAllDataNodes()[o].isSetFileValid()&&datanodesManager.getAllDataNodes()[o].setFile(t)}}}
var widgetPreview=function(){var e,t=[],n="scaleTwh",o=0,i=1,d=new rescaleHelper(e,n,"preview"),a=[],s=[],l=[],r=[],c="",g={};function u(){return{widthPx:$("#dashboard-zone").width(),heightPx:$("#dashboard-zone").height(),scrollWidthPx:$("#dashboard-zone")[0].scrollWidth,scrollHeightPx:$("#dashboard-zone")[0].scrollHeight,widthVw:100*$("#dashboard-zone").width()/document.documentElement.clientWidth,heightVh:100*$("#dashboard-zone").height()/document.documentElement.clientHeight,scrollWidthVw:100*$("#dashboard-zone")[0].scrollWidth/document.documentElement.clientWidth,scrollHeightVh:100*$("#dashboard-zone")[0].scrollHeight/document.documentElement.clientHeight,scalingMethod:n}}function C(){for(let e in t)for(let n of widgetConnector.effectiveSliders())null!=t[e]&&null!=t[e].getByName(n)&&(slider=t[e].getByName(n),slider.addValueChangedHandler(y))}function f(e,n){_.each(_.keys(e.dashboard),e=>{let o=document.getElementById(e+"c"),i=e.substring(0,e.length-1),d=o.firstElementChild.id;t[e]=n?widgetsPluginsHandler.createWidget(d,i,e,!0):widgetsPluginsHandler.copyWidget(d,i,null,e,!0),function(e){$("#"+e+"c")[0].style.position="absolute",$("#"+e+"c")[0].style.border="1px solid rgba(255, 255, 255, 0)"}(e),widgetConnector.updateDataNodeIndex(e),null!=widgetConnector.widgetsConnection[e]&&(widgetConnector.widgetsConnection[e].widgetObjEdit=null,widgetConnector.widgetsConnection[e].widgetObjConnect=t[e],m(e,!1))}),d.updateCellsProportions(),_.each(_.keys(t),e=>{!function(e,t){a[e]=$("#"+t).width()/$("#"+$("#"+t)[0].parentNode.id).width(),s[e]=$("#"+t).height()/$("#"+$("#"+t)[0].parentNode.id).height(),l[e]=$("#"+t).position().left/$("#"+$("#"+t)[0].parentNode.id).width(),r[e]=$("#"+t).position().top/$("#"+$("#"+t)[0].parentNode.id).height(),c=getMedia()}(e,e+"c")})}function m(e,t){var n=null;if(_.isUndefined(widgetConnector.widgetsConnection[e]))console.log("connection of "+e+" is undefned");else for(var o in widgetConnector.widgetsConnection[e].sliders)if("None"!=widgetConnector.widgetsConnection[e].sliders[o].name&&(n=null,null!=widgetConnector.widgetsConnection[e].widgetObjEdit?n=widgetConnector.widgetsConnection[e].widgetObjEdit.getByName(widgetConnector.widgetsConnection[e].sliders[o].name):null!=widgetConnector.widgetsConnection[e].widgetObjConnect&&(n=widgetConnector.widgetsConnection[e].widgetObjConnect.getByName(widgetConnector.widgetsConnection[e].sliders[o].name)),null!=n))if("None"!=widgetConnector.widgetsConnection[e].sliders[o].dataNode){var i=widgetConnector.widgetsConnection[e].sliders[o].dataNodeIndex;if(-1!=i){var d=datanodesManager.getAllDataNodes()[i].latestData(),a=datanodesManager.getAllDataNodes()[i].name(),s=datanodesManager.getAllDataNodes()[i].status(),l=datanodesManager.getAllDataNodes()[i].last_updated();"Python_pyodide_plugin"==datanodesManager.getDataNodeByName(a).type()&&"fig"==o?b(e,o,n,a,s,l,t):b(e,o,n,d,s,l,t)}else msg="Invalid connection with data",p(e,o,msg)}else $("#collapse-matching-box").hasClass("collapse in")&&widgetPreview.clearDataFromWidget(e,o,n,!0)}function p(e,t,n){if(!g[e]){var o=widgetConnector.widgetsConnection[e].instanceId+"c";_.isUndefined($("#"+o)[0])||"3px groove #e40000"!=$("#"+o)[0].style.border&&(w=parseFloat($("#"+o)[0].style.width)+1,h=parseFloat($("#"+o)[0].style.height)+1,$("#"+o)[0].style.width=w+"vw",$("#"+o)[0].style.height=h+"vh",$("#"+o)[0].style.border="3px groove #e40000",$("#"+o)[0].style.borderRadius="6px",$("#"+o)[0].style.background="rgba(255, 0, 0, 0.26)",$("#"+o).append('<br/><span style="color:red">'+n+' "'+widgetConnector.widgetsConnection[e].sliders[t].dataNode+'" !</span>')),g[e]=!0}}function b(e,t,n,o,i,d,a){if(_.isUndefined(o)&&"never"!=d||"Error"==i)return msg="Invalid data",void p(e,t,msg);if(function(e){var t=widgetConnector.widgetsConnection[e].instanceId+"c";if(!_.isUndefined($("#"+t)[0])&&"1px solid rgba(255, 255, 255, 0)"!=$("#"+t)[0].style.border){w=parseFloat($("#"+t)[0].style.width)-1,h=parseFloat($("#"+t)[0].style.height)-1,$("#"+t)[0].style.width=w+"vw",$("#"+t)[0].style.height=h+"vh",$("#"+t)[0].style.border="1px solid rgba(255, 255, 255, 0)",$("#"+t)[0].style.borderRadius="",$("#"+t)[0].style.background="";for(var n=0;n<$("#"+t)[0].childNodes.length;n++)"span"==$("#"+t)[0].childNodes[n].localName&&$("#"+t)[0].childNodes[n].remove()}g[e]=!1}(e),!_.isUndefined(o)&&!_.isNull(o)){const i=widgetConnector.widgetsConnection[e].sliders[t];let d=o,s=i.dataNode;for(let e=0;e<i.dataFields.length;e++){const t=i.dataFields[e];"string"==typeof t&&t.includes(" ... ")||(s=t,d=_.isNull(d)||_.isUndefined(d)?o[s]:d[s])}if(null===d)widgetPreview.clearDataFromWidget(e,t,n,!0);else if("D"===i.name.substring(0,1))try{n.setText(d)}catch(e){console.log("setText got exception with data '"+i.dataNode+"'. "+e)}else{if(!_.isUndefined(n.setCaption))try{n.setCaption(s,a)}catch(e){console.log("setCaption got exception with data '"+i.dataNode+"'. "+e)}if(!_.isUndefined(n.setValue))try{n.setValue(d)}catch(e){console.log("setValue got exception with data '"+i.dataNode+"'. "+e)}}}}function y(e,t,n){var o=null;if(0==datanodesManager.getAllDataNodes().length);else{var i=!1;for(var d in widgetConnector.widgetsConnection)for(var a in widgetConnector.widgetsConnection[d].sliders)if(null!=widgetConnector.widgetsConnection[d].widgetObjConnect&&null!=widgetConnector.widgetsConnection[d].widgetObjConnect.getByName(widgetConnector.widgetsConnection[d].sliders[a].name)&&e==widgetConnector.widgetsConnection[d].widgetObjConnect.getByName(widgetConnector.widgetsConnection[d].sliders[a].name)){i=!0,o=widgetConnector.widgetsConnection[d].sliders[a];break}if(i&&"None"!=o.dataNode){var s=datanodesManager.getAllDataNodes()[o.dataNodeIndex];if(_.isUndefined(s))console.log("data was removed or data index was modified!");else if(s.isSetValueValid()&&!_.isUndefined(e.getValue))try{s.setValue(o.dataFields,e.getValue(),n)}catch(e){console.log("setValue got exception with data: "+s.name()+". "+e.message)}else console.log("setValue is not possible with data: "+s.name())}}}function v(){e=u(),d.setDimensions(e);var n,o=isMediaChanged(c);n=o.bChanged,c=o.lastMedia,n?_.each(_.keys(t),e=>{let n=e+"c";d.resizeWidgetOnMediaChange(e,n),function(e){let n=e+"c";for(var o=document.getElementById(n),i=o.id.substring(0,o.id.length-2),d=(e=o.id.substring(0,o.id.length-1),o.firstElementChild),a=o.childNodes.length-1;a>=0;a--)o.removeChild(o.childNodes[a]);var s=document.createElement("div");s.style.height=unitH(o.offsetHeight-2),s.style.width=unitW(o.offsetWidth-2),s.style.minWidth=parseFloat(o.style.minWidth)-5+"px",s.style.minHeight=parseFloat(o.style.minHeight)-5+"px",o.appendChild(s),s.id=d.id;var l=d.id;t[e]=widgetsPluginsHandler.copyWidget(l,i,t[e],e,!0),g[e]=!1}(e),widgetConnector.updateDataNodeIndex(e),null!=widgetConnector.widgetsConnection[e]&&(widgetConnector.widgetsConnection[e].widgetObjConnect=t[e],m(e))}):_.each(_.keys(t),e=>{rescaleWidget(t,e)})}function N(){for(var e in t)delete t[e];for(var e in $("#dashboard-zone").html(""),a)delete a[e];for(var e in s)delete s[e];for(var e in l)delete l[e];for(var e in r)delete r[e];c=""}return{loadPlayMode:function(){N(),e=widgetEditor.getSnapshotDashZoneDims(),d.setDimensions(e),d.setScalingMethod(n),d.setRows(o),d.setCols(i),f(function(){var e=xdash.serialize();e.scaling=widgetEditor.getSnapshotDashZoneDims();var t=document.getElementById("dashboard-zone"),n=document.createElement("div");return n.id="DropperDroitec",n.className="dropperR",n.style.zIndex=0,n.style.borderRadius="10px",t.appendChild(n),reconstructFoundations.buildDivsFromXprjson(e),e}(),!1),0!=datanodesManager.getAllDataNodes().length&&C()},renderDashboardWidgets:f,updateDataFromWidget:y,resizeDashboard:function(e){if("undefined"!=typeof execOutisdeEditor&&execOutisdeEditor){var t=0;switch($("#nav-menu")[0]&&(t=parseInt($("#nav-menu")[0].style.height),isNaN(t)&&(t=0)),jsonContent.exportOptions){case"rowToPage":rowToPageRuntime.rowToPagePrepareRescale(o,i);break;case"rowToTab":rowToTabRuntime.rowToTabPrepareRescale(o,i);break;case"customNavigation":customNavigationRuntime.customNavigationPrepareRescale(o,i);break;case"keepOriginalWidth":$("#dashboard-zone")[0].style.height=scalingSrc.scrollHeightPx+t+"px";break;default:$("#dashboard-zone")[0].style.height=document.body.clientHeight-t+"px"}}d.setScalingMethod(n),d.setRows(o),d.setCols(i),d.resizeDashboard(e),v(),"undefined"!=typeof execOutsideEditor&&execOutsideEditor&&"rowToPage"==jsonContent.exportOptions&&setTimeout(rowToPageRuntime.rowToPageFinishRescale,500,o,i)},resizeDashboardCols:function(){d.resizeDashboardCols()},widget:t,plotConstantData:m,assignValueChangeHandlers:C,rescale:v,clear:function(){N(),htmlExport.exportOptions="ajustToTargetWindow"},deserialize:function(e){let t;for(t in _.each(_.keys(e),e=>{let t=e.substring(0,e.length-1),n=e+"c";null==widgetConnector.widgetsConnection[e]&&(widgetConnector.widgetsConnection[e]={name:n,id:n,instanceId:e,modelJsonId:t,sliders:[],widgetObjEdit:null,widgetObjConnect:null})}),widgetConnector.widgetsConnection)for(var n in e[t])_.isUndefined(e[t][n].dataNode)&&(e[t][n].dataNode=e[t][n].dataSource,e[t][n].dataNodeIndex=e[t][n].dataSourceIndex,delete e[t][n].dataSource,delete e[t][n].dataSourceIndex),widgetConnector.widgetsConnection[t].sliders[n]=e[t][n];for(t in widgetConnector.widgetsConnection)try{widgetPreview.plotConstantData(t,!1),widgetConnector.widgetsConnection[t].widgetObjEdit=null}catch(e){}},setDataOnWidget:b,clearDataFromWidget:function(e,t,n,o){"D"===widgetConnector.widgetsConnection[e].sliders[t].name.substring(0,1)?n.setText(""):(!_.isUndefined(n.clearCaption)&&o&&n.clearCaption(),_.isUndefined(n.setValue)||n.setValue(null))},getCurrentDashZoneDims:u,getSnapshotDashZoneDims:function(){return e},getWidgetsRelativeDims:function(){return{width:a,height:s,left:l,top:r}},setScalingInformation:function(e,t,a,s){null!=e&&(d.setDimensions(e),null!=e.colDims&&d.deserialize(e)),null!=t&&(n=t,d.setScalingMethod(n)),null!=a&&(o=a,d.setRows(o)),null!=s&&(i=s,d.setCols(i))},getCols:function(){return d.getCols()},mediaChangeProjection:function(e,t,n){return d.mediaChangeProjection(e,t,n)},toPng:function(){var e=function(){var e,n,o=0,i=0,d=$("#dashboard-zone").offset().left,a=$("#dashboard-zone").offset().top,s=$("#dashboard-zone").height();for(var l in t)(e=$("#"+l+"c").offset().left-d+$("#"+l+"c").width())>o&&(o=e),(n=$("#"+l+"c").offset().top-a+$("#"+l+"c").height())>i&&(i=n),i>s&&(i=s);return{right:o,bottom:i}}(),n=document.getElementById("dashboard-zone"),o=n.style.height,i=n.style.width;n.style.height=e.bottom+"px",n.style.width=e.right+"px",html2canvas(n,{allowTaint:!1,useCORS:!0}).then((function(t){var d=Canvas2Image.convertToPNG(t,e.right,e.bottom),a=document.createElement("a");a.setAttribute("download",$("#projectName")[0].value+".png"),a.setAttribute("href",d.src.replace("image/png","image/octet-stream")),a.click(),n.style.height=o,n.style.width=i}))},elevateZIndex:function(e,n){var o=0;_.each(Object.keys(t),(function(e){var t=Number($("#"+e+"c")[0].style["z-index"]);t>o&&(o=t)})),$("#"+e+"c")[0].style["z-index"]=o+1}}}();
...
var customNavigationRuntime=function(){var e=1,o=1;return{customNavigationPrepareRescale:function(e,o){var r=1;"none"!=e&&(r=Number(e));var a=1;if(o>1&&(a=Number(o)),r>1)if(a>1){let e=a*r;for(var i=1;i<=e;i++)$("#dpr"+i+"c").show()}else for(i=1;i<=r;i++)$("#dpr"+i+"c").show()},customNavigationModeInit:function(r){let a=Number(r.pages.defaultPage.id);var i=1;"none"!=r.device.cols.valueRow&&(i=Number(r.device.cols.valueRow));var c=1;if(r.device.cols.valueCol>1&&(c=Number(r.device.cols.valueCol)),e=i,o=c,i>1)if(c>1){let e=c*i,o=(a-1)*c+1,r=o+c;for(var t=1;t<=e;t++)t>=o&&t<r?$("#dpr"+t+"c").show():$("#dpr"+t+"c").hide()}else for(t=1;t<=i;t++)t==a?$("#dpr"+t+"c").show():$("#dpr"+t+"c").hide()},goToPage:function(r){if("undefined"!=typeof layoutMgr&&(e=layoutMgr.getRows(),o=layoutMgr.getCols()),e>1)if(o>1){let i=o*e,c=(r-1)*o+1,t=c+o;for(var a=1;a<=i;a++)a>=c&&a<t?$("#dpr"+a+"c").show():$("#dpr"+a+"c").hide()}else for(a=1;a<=e;a++)a==r?$("#dpr"+a+"c").show():$("#dpr"+a+"c").hide()}}}();
var xDashApi={setVariable:function(e,a,t){datanodesManager.getDataNodeByName(e).setValue([],a,!1,t)},setVariables:function(e,a){let t=datanodesManager.getDataNodeByName(e[0]);for(let t=0;t<e.length;t++){let n=datanodesManager.getDataNodeByName(e[t]),o=a[t];n.setValue([],o,!1,!0)}t.schedulerStart(e,e[0],"setValue")},getVariable:function(e){var a=datanodesManager.getDataNodeByName(e);return _.isUndefined(a)?void 0:a.latestData()},setVariableProperty:function(e,a,t){datanodesManager.getDataNodeByName(e).setValue(a,t)},executeDataNode:function(e){datanodesManager.getDataNodeByName(e).schedulerStart(void 0,void 0,"vignette")},executeDataNodes:function(e){let a=[];for(let t=0;t<e.length;t++)a.push(datanodesManager.getDataNodeByName(e[t]));datanodesManager.getDataNodeByName(e[0]).schedulerStart(e,e[0],"vignette")},viewProject:function(e,a,t){var n=xDashConfig.urlBaseForExport,o=!1;"999"==xDashConfig.version.minor&&(o=!0);var r="";o||(r="-"+xDashConfig.version.fullVersion);var i=n+"index-view"+r+".html?projectUrl="+e+"&inputParams="+inputHandler.encodeInputPars(a);t?window.open(i,"_blank"):window.location=i},viewPage:function(e,a,t){var n=e+"?inputParams="+inputHandler.encodeInputPars(a);t?window.open(n,"_blank"):window.location=n},goToPage:function(e){customNavigationRuntime.goToPage(e)}};
var xdash=function(){var e=xDashConfig.version.fullVersion,t="ajustToTargetWindow";const a=angular.element(document.body).scope().$root;function o(){angular.element(document.body).injector().invoke(["UndoManagerService",e=>{e.clear()}]),datanodesManager.clear(),widgetEditor.clear(),xdashNotifications.clearAllNotifications(),widgetConnector.clear(),widgetPreview.clear(),$("#projectName")[0].value="",$(".tab--active").removeClass("changed"),a.currentPrjDirty="";angular.element(document.getElementById("library__wrap")).scope().resetPyodideLibs(),layoutMgr.resetDashBgColor(),layoutMgr.resetDashboardTheme();angular.element(document.getElementById("help__wrap")).scope().initFrame()}function n(){return{version:e,date:Date(),name:"",description:"",groupName:"",tags:[],schedulerLogOff:offSchedLogUser}}async function i(e){try{return $("#projectName")[0].value=e.meta.name,_.isUndefined(e.meta.description)||(a.currentProject.description=e.meta.description),_.isUndefined(e.meta.tags)||(a.currentProject.tags=e.meta.tags),_.isUndefined(e.meta.groupName)||(a.currentProject.groupName=e.meta.groupName),_.isUndefined(e.meta.schedulerLogOff)?offSchedLogUser=!0:offSchedLogUser=e.meta.schedulerLogOff,await pyodideLib.deserialize(e),datanodesManager.load(e.data,!0)?(angular.element(document.body).injector().invoke(["UndoManagerService",e=>{e.clear()}]),function(e,t,a,o){const n=e.droppers;let i=[];"datasources"in o?_.isUndefined(o.datasources)||(i=o.datasources.map(e=>e.name)):_.isUndefined(o.datanodes)||(i=o.datanodes.map(e=>e.name));if(_.isEmpty(n)){const e=_.keys(t);_.each(e,e=>{r(e,t,a,o,i)})}else{const e=_.keys(n);_.each(e,e=>{const l=_.keys(n[e]);_.each(l,l=>{let s=n[e][l];n[e][l]=r(s,t,a,o,i)})})}}(e.device,e.dashboard,e.connections,e.data),widgetEditor.deserialize(e.dashboard,e.scaling,e.device),widgetConnector.deserialize(e.connections),widgetPreview.clear(),widgetEditor.unselectAllWidgets(),layoutMgr.deserializeDashBgColor(e.device),layoutMgr.deserializeDashboardTheme(e.device),_.isUndefined(e.pages)||(layoutMgr.deserializeRowNames(e.pages),layoutMgr.deserializeDefaultRow(e.pages)),_.isUndefined(e.exportOptions)||(htmlExport.exportOptions=e.exportOptions),_.isUndefined(e.navBarNotification)?htmlExport.navBarNotification=!1:htmlExport.navBarNotification=e.navBarNotification,!0):(o(),!1)}catch(e){return console.log(e),!1}}function r(e,t,a,o,n){if(e.includes("flatUiValue")&&!e.includes("flatUiValueDisplay")){let i="",r="";"datasources"in o?_.isUndefined(a[e].value.dataSource)||(r=a[e].value.dataSource):_.isUndefined(a[e].value.dataNode)||(r=a[e].value.dataNode);(""===r||n.includes(r))&&!_.isUndefined(t[e].modelParameters.isNumber)?(t[e].modelParameters.isNumber?(_.isUndefined(t[e].modelParameters.isPassword)||delete t[e].modelParameters.isPassword,i="flatUiNumericInput"):i="flatUiTextInput",delete t[e].modelParameters.isNumber):i="flatUiValueDisplay",_.isUndefined(t[e].container.id)||(t[e].container.id=t[e].container.id.replace("flatUiValue",i)),_.isUndefined(t[e].container.instanceId)||(t[e].container.instanceId=t[e].container.instanceId.replace("flatUiValue",i)),_.isUndefined(t[e].container.modelJsonId)||(t[e].container.modelJsonId=t[e].container.modelJsonId.replace("flatUiValue",i)),_.isUndefined(t[e].container.widgetTypeName)||(t[e].container.widgetTypeName=t[e].container.widgetTypeName.replace("flatUiValue",i)),_.isUndefined(t[e].modelParameters.decimalDigits)||delete t[e].modelParameters.decimalDigits;let l=e;return t[e=e.replace("flatUiValue",i)]=t[l],delete t[l],a[e]=a[l],delete a[l],e}return e}function l(e,t){let a="Previous";t&&"datanode"!=e||(a="Cancel"),(new FileMngrFct).GetFileList(e,s,!1,a,null)}function s(e,t,a,o){if("error"==a)swal(e,t,a);else if("success"==a){let a=t,n="files";"project"==a?n="projects":"datanode"==a&&(n="xdsjson"),contentElement=function(e,t){var a=document.createElement("div");a.classList.add("dashboard-form");var o='<label for="selectFile">'+t+"</label>";if(o+='<select class="multiple h-full" name="select-file" id="selectFile" size="10">',!_.isUndefined(e.FileList))for(let t=0;t<e.FileList.length;t++)_.isUndefined(e.FileList[t].Name)||(o=0==t?o+'<option selected value ="'+e.FileList[t].Name+'">'+e.FileList[t].Name+"</option>":o+'<option value ="'+e.FileList[t].Name+'">'+e.FileList[t].Name+"</option>");return o+="</select>",a.innerHTML=o,a}(e,"Please select a "+a+": "),new DialogBox(contentElement,"List of available "+n+" on server","Open",o,(function(){let e=$("#selectFile")[0];if(-1==e.selectedIndex)return!0;{datanodesManager.showLoadingIndicator(!0);let t=e.options[e.selectedIndex].value;swal.close(),(new FileMngrFct).ReadFile(a,t,d)}}))}}function d(e,t,a){if("error"==a)swal(e,t,a);else{let a=e,o=t;"project"==o?c(a):"datanode"==o&&xdsjson.openJsonManager(a)}datanodesManager.showLoadingIndicator(!1)}async function c(e){let t;try{t=JSON.parse(e)}catch(e){return void swal("Unable to load file","Project loading will be interrupted.","error")}var a;a=t,angular.element(document.body).injector().invoke(["$rootScope",function(e){e.currentProject={name:a.meta.name}}]);let n=!1,r=async function(e){if(o(),n=await i(t),datanodesManager.showLoadingIndicator(!1),document.removeEventListener("widgets-tab-loaded",r),t=void 0,!n)return swal("Unable to load your project","Project loading will be interrupted.","error"),!1};document.addEventListener("widgets-tab-loaded",r),"widgets"==tabActive&&("edit-dashboard"==modeActive?await r():showEditMode(!0,r))}return $(window).bind("beforeunload",(function(){return function(){let e=angular.element(document.body).scope().$root;if(""!==e.currentProject.name){let t=angular.element(document.getElementById("headerbar-ctrl")).scope();if($(".tab--active").hasClass("changed")){fileManager.getFileListExtended("project",e.currentProject.name,void 0,(function(){t.closeProject(e.currentProject.name,!0),console.log("Your project is saved before closing")}),!0)}else t.closeProject(e.currentProject.name),console.log("Your project was closed")}}(),"Are you sure you want to leave the page ?"})),{openFile:function(e,t){"project"==e?fileText="project":"datanode"==e&&(fileText="xdsjson"),"local"===t?function(e){let t=FileMngr.GetFileExt(e);if(window.File&&window.FileReader&&window.FileList&&window.Blob){let a=document.createElement("input");a.type="file",a.setAttribute("accept",t),$(a).on("change",(function(t){"project"==e&&swal.close();let a=t.target.files;if(a&&a.length>0){let t=a[0],o=new FileReader;datanodesManager.showLoadingIndicator(!0),o.addEventListener("load",(function(t){let a=t.target;"project"==e?c(a.result):"datanode"==e&&xdsjson.openJsonManager(a.result)})),o.readAsText(t)}})),$(a).trigger("click")}else swal("Unable to load a file in this browser.","","error")}(e):"server"===t&&l(e,!0)},openFromServer:l,serialize:function(){const e=n();e.name=$("#projectName")[0].value,a.currentProject&&(e.description=a.currentProject.description,e.tags=a.currentProject.tags,e.groupName=a.currentProject.groupName);let o,i=datanodesManager.serialize(),r=pyodideLib.serialize();o=a.moduleOpened||"widgets"!=tabActive||"edit-dashboard"!=modeActive||"full"!=editorStatus?widgetEditor.getSnapshotDashZoneDims():widgetEditor.getCurrentDashZoneDims();let l=widgetEditor.serialize(),s=layoutMgr.serializeCols(),d=layoutMgr.serializeDashBgColor(),c=layoutMgr.serializeDashboardTheme(),u=widgetConnector.serialize(),g=layoutMgr.serializeRowNames(),m=layoutMgr.serializeDefaultRow();return t=htmlExport.exportOptions,navBarNotification=htmlExport.navBarNotification,{meta:e,data:i,libraries:r,scaling:o,device:{...s,...d,...c},dashboard:l,connections:u,exportOptions:t,pages:{...g,...m},checkExportOptions:!0,navBarNotification:navBarNotification}},initMeta:n,openProjectManager:c,deserialize:i,clear:o,pageLoad:!0,readFileFromServer:function(e,t){let a=new FileMngrFct,o=angular.element(document.body),n=o.scope().$root,i=o.scope().$state;n.origin="openProject",n.showNotifications=!1,n.toggleMenuOptionDisplay("none"),i.go("modules",{}).then((function(){n.moduleOpened=!1,a.ReadFile(t,e+".xprjson",(function(a,o,i){if("success"===i){xdash.openProjectManager(a);let o=new PNotify({title:e,text:"Your "+t+" "+e+" is ready!",type:"success",delay:1800,styling:"bootstrap3"});$(".ui-pnotify-container").on("click",(function(){o.remove()})),n.loadingBarStop(),n.currentProject.name=e}else swal(a,o,i)}))}))},readFileFromUrl:function(e,t){let a;$.get(t,(function(e){a=e})).done((function(){let t=angular.element(document.body),o=t.scope().$root,n=t.scope().$state;o.origin="openProject",o.showNotifications=!1,o.toggleMenuOptionDisplay("none"),n.go("modules",{}),o.moduleOpened=!1,d(a,e)})).fail((function(e,t){datanodesManager.showLoadingIndicator(!1),swal("Error in loading xprjson from URL","Server response : "+e.status,"error")}))},exportOptions:t}}();
...
!function(e){e.fn.hasVScrollBar=function(){return this.get(0).scrollHeight>this.height()},e.fn.hasHScrollBar=function(){return this.get(0).scrollWidth>this.width()},e.fn.computeRatio=function(){return this.get(0).scrollWidth/this.width()}}(jQuery);var RuntimeDashboard=function(){var e;function a(a,o){e=jQuery.extend(!0,{},a.scaling);var i=0;switch($("#nav-menu")[0]&&(i=parseInt($("#nav-menu")[0].style.height),isNaN(i)&&(i=0)),o){case"keepOriginalWidth":$("#dashboard-zone")[0].style.width=e.scrollWidthPx+"px",$("#dashboard-zone")[0].style.height=e.scrollHeightPx+i+"px",e.scalingMethod="scaleTwSp";break;case"adjustToFullWidth":$("#dashboard-zone")[0].style.width="100%",$("#dashboard-zone")[0].style.height=document.body.clientHeight-i+"px",e.scalingMethod="scaleTwSpWS";break;case"ajustToTargetWindow":$("#dashboard-zone")[0].style.width="100%",$("#dashboard-zone")[0].style.height=document.body.clientHeight-i+"px",e.scalingMethod="scaleTwh";break;case"projectToTargetWindow":case"customNavigation":case"rowToTab":case"rowToPage":$("#dashboard-zone")[0].style.width="100%",$("#dashboard-zone")[0].style.height=document.body.clientHeight-i-1+"px",e.scalingMethod="scaleTwhS";break;default:$("#dashboard-zone")[0].style.width="100%",$("#dashboard-zone")[0].style.height="100%"}if($("#dashboard-zone")[0].style.margin="auto",$("#dashboard-zone")[0].style["overflow-x"]="hidden",$("#dashboard-zone")[0].style["overflow-y"]="hidden",$("#DropperDroitec")[0].style.height="100%",$("#DropperDroitec")[0].style.width="100%",$("#DropperDroitec")[0].style["overflow-y"]="auto",_.isUndefined(a.device))a.device={cols:{valueRow:"none",valueCol:"1",maxCells:0,maxCols:0,classType:""}};else{if(_.isUndefined(a.device.cols.valueRow))if(_.isUndefined(a.device.cols.value))a.device.cols.valueRow="none";else switch(a.device.cols.value){case"none":a.device.cols.valueRow="none";break;case"1":case"3":a.device.cols.valueRow="1";break;case"6":a.device.cols.valueRow="6";break;default:a.device.cols.valueRow="none"}if(_.isUndefined(a.device.cols.valueCol))if(_.isUndefined(a.device.cols.value))a.device.cols.valueCol="1";else switch(a.device.cols.value){case"none":case"1":a.device.cols.valueCol="1";break;case"3":case"6":a.device.cols.valueCol="3";break;default:a.device.cols.valueCol="1"}}const s=a.device.cols.maxCols,t=a.device.cols.maxCells/(s||1);var d=jQuery.extend(!0,{},e),r=widgetPreview.getCurrentDashZoneDims();widgetPreview.setScalingInformation(d,e.scalingMethod,t,s),widgetPreview.resizeDashboardCols();var n=widgetPreview.mediaChangeProjection(d,r,t);d=n.referenceFrame,r=n.targetFrame,widgetPreview.setScalingInformation(d,e.scalingMethod,t,s),widgetPreview.resizeDashboard(r)}return{initContainers:a,loadDashboard:async function(e,o){var i=$("<textarea />").html(JSON.stringify(e.data)).text(),s="";try{s=JSON.parse(i)}catch(e){return void swal("JSON Parse error",e.message,"error")}for(var t in await pyodideLib.deserialize(e),datanodesManager.load(s,!0),a(e,o),e.dashboard)if(_.isEmpty(e.dashboard[t].modelParameters)||(modelsParameters[t]=e.dashboard[t].modelParameters),_.isEmpty(e.dashboard[t].modelHiddenParams)||(modelsHiddenParams[t]=e.dashboard[t].modelHiddenParams),_.isUndefined(modelsTempParams[t])){var d=t.substring(0,t.length-1);modelsTempParams[t]=jQuery.extend(!0,{},modelsTempParams[d])}!!_.isUndefined(e.meta.schedulerLogOff)||e.meta.schedulerLogOff,$("html").attr("data-theme",e.device.theme),widgetPreview.deserialize(e.connections),widgetPreview.renderDashboardWidgets(e,!0),$(".dropperR").css("background-color",e.device.backgroundColor),"rowToPage"==e.exportOptions?rowToPageRuntime.rowToPageModeInit(e):"rowToTab"==e.exportOptions?rowToTabRuntime.rowToTabModeInit(e):"customNavigation"==e.exportOptions&&customNavigationRuntime.customNavigationModeInit(e),setTimeout(()=>{widgetPreview.assignValueChangeHandlers()},2e3)}}}();
