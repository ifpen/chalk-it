...
var rowToPageRuntime={rowToPagePrepareRescale:function(e,r){var o=1;"none"!=e&&(o=Number(e));var a=1;if(r>1&&(a=Number(r)),o>1)if(a>1){let e=a*o;for(let r=1;r<=e;r++)$("#dpr"+r+"c").show()}else for(let e=1;e<=o;e++)$("#dpr"+e+"c").show()},rowToPageFinishRescale:function(e,r){var o=angular.element(document.body).scope().$root.pageNumber,a=1;"none"!=e&&(a=Number(e));var p=1;if(r>1&&(p=Number(r)),a>1)if(p>1){let e=p*a,r=(o-1)*p+1,l=r+p;for(var u=1;u<=e;u++)u>=r&&u<l?$("#dpr"+u+"c").show():$("#dpr"+u+"c").hide()}else for(u=1;u<=a;u++)u==o?$("#dpr"+u+"c").show():$("#dpr"+u+"c").hide()},rowToPageModeInit:function(e){var r=angular.element(document.body).scope().$root;r.pageNumber=1;var o=1;"none"!=e.device.cols.valueRow&&(o=Number(e.device.cols.valueRow));var a=1;e.device.cols.valueCol>1&&(a=Number(e.device.cols.valueCol)),r.totalPages=o,r.showPagination=!0,r.exportOptions=e.exportOptions,r.$apply();var p=o*a;if(o>1)if(a>1)for(let e=1;e<=p;e++)e>a&&$("#dpr"+e+"c").hide();else for(let e=2;e<=o;e++)$("#dpr"+e+"c").hide();r.prevDpr=function(){if(a>1){if(r.pageNumber>1){let e=(r.pageNumber-1)*a+1,o=e+a;for(let r=e;r<=o;r++)$("#dpr"+r+"c").hide();r.pageNumber=r.pageNumber-1,e=(r.pageNumber-1)*a+1,o=e+a;for(let r=e;r<=o;r++)$("#dpr"+r+"c").show()}}else r.pageNumber>1&&($("#dpr"+r.pageNumber+"c").hide(),r.pageNumber=r.pageNumber-1,$("#dpr"+r.pageNumber+"c").show())},r.nextDpr=function(){if(a>1){if(r.pageNumber<r.totalPages){let e=(r.pageNumber-1)*a+1,o=e+a;for(let r=e;r<=o;r++)$("#dpr"+r+"c").hide();r.pageNumber=r.pageNumber+1,e=(r.pageNumber-1)*a+1,o=e+a;for(let r=e;r<=o;r++)$("#dpr"+r+"c").show()}}else r.pageNumber<r.totalPages&&($("#dpr"+r.pageNumber+"c").hide(),r.pageNumber=r.pageNumber+1,$("#dpr"+r.pageNumber+"c").show())}}};
var rowToTabRuntime={rowToTabPrepareRescale:function(e,a){var r=1;"none"!=e&&(r=Number(e));var o=1;if(a>1&&(o=Number(a)),r>1)if(o>1){let e=o*r;for(var s=1;s<=e;s++)$("#dpr"+s+"c").show()}else for(s=1;s<=r;s++)$("#dpr"+s+"c").show()},rowToTabFinishRescale:function(e,a){var r=angular.element(document.body).scope().$root.pageNumber,o=1;"none"!=e&&(o=Number(e));var s=1;if(a>1&&(s=Number(a)),$("#page-"+r).removeClass("cancel").addClass("primary"),o>1)if(s>1){let e=s*o,a=(r-1)*s+1,c=a+s;for(var l=1;l<=e;l++)l>=a&&l<c?$("#dpr"+l+"c").show():$("#dpr"+l+"c").hide()}else for(l=1;l<=o;l++)l==r?$("#dpr"+l+"c").show():$("#dpr"+l+"c").hide()},rowToTabModeInit:function(e){var a=angular.element(document.body).scope().$root,r=1;"none"!=e.device.cols.valueRow&&(r=Number(e.device.cols.valueRow));var o=1;e.device.cols.valueCol>1&&(o=Number(e.device.cols.valueCol)),a.pageNames=e.pages.pageNames,a.showPagination=!0,a.exportOptions=e.exportOptions,a.$apply();var s=r*o;if(r>1)if(o>1)for(let e=1;e<=s;e++)e>o&&$("#dpr"+e+"c").hide();else for(let e=2;e<=s;e++)$("#dpr"+e+"c").hide();$("#page-1").removeClass("cancel").addClass("primary"),a.displayPage=function(e){if($("[id^=dpr]").hide(),$("[id^=page-").removeClass("primary").addClass("cancel"),o>1){let a=(e-1)*o+1,r=a+o;for(let e=a;e<r;e++)$("#dpr"+e+"c").show();$("#page-"+e).removeClass("cancel").addClass("primary")}else $("#dpr"+e+"c").show(),$("#page-"+e).removeClass("cancel").addClass("primary")}}};
