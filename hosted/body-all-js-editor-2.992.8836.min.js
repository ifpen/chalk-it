...
function initEditWidget(){var e=$("#DropperDroite")[0],t=[],i=[],o=[],d=[],r=[],n=[],a=new Map;var s,l="",c="scaleTwh",g=new rescaleHelper(s,c,"edit");layoutMgr.setScalingHelper(g);var m=new Set;const u="DropperDroite",p="drop-possible",h="drop-over",f="widget-selected",b="widget-selected-last",w="data-x",v="data-y",A="data-x0",M="data-y0",W="data-height",E="data-width",C="data-height0",D="data-width0",I="data-minRatioX",S="data-minRatioY",T="data-maxRatioX",N="data-maxRatioY",z="data-display-x",P="data-display-y";function F(e){e.removeAttribute(w),e.removeAttribute(v),e.removeAttribute(A),e.removeAttribute(M),e.removeAttribute(W),e.removeAttribute(E),e.removeAttribute(C),e.removeAttribute(D),e.removeAttribute(I),e.removeAttribute(S),e.removeAttribute(T),e.removeAttribute(N),e.removeAttribute(z),e.removeAttribute(P)}function H(e){return{left:parseFloat(e.getAttribute(A))||0,top:parseFloat(e.getAttribute(M))||0,height:parseFloat(e.getAttribute(C))||1,width:parseFloat(e.getAttribute(D))||1}}if($("#DropperDroite")[0].hasChildNodes())for(var R=$("#DropperDroite")[0],L=R.childNodes.length-1;L>=0;L--)"menuWidget"!=R.childNodes[L].id&&R.childNodes[L].remove();function O(e){if(e.parentNode&&e.parentNode.parentNode){const t=e.parentNode.parentNode.id;if(t&&t.startsWith("dpr"))return t}return u}function U(e,t){if(e===u)return t;{const i=$("#"+e).offset();return{...t,top:t.top+i.top,left:t.left+i.left}}}function V(e,t){if(e===u)return t;{const i=$("#"+e).offset();return{...t,top:t.top-i.top,left:t.left-i.left}}}function k(e,t,i){let[o,d]=e,[r,n]=t;return[Math.round((o-r)/i.sizeX)*i.sizeX+r,Math.round((d-n)/i.sizeY)*i.sizeY+n]}var B=null,J=[];interact("#DropperDroite").draggable({cursorChecker:(e,t,i,o)=>o?"pointer":"default",listeners:{start(e){J=[...m],(B=document.createElement("div")).classList.add("dragged-editor-selection-lasso"),document.body.appendChild(B);const t=e.clientX0+window.pageXOffset,i=e.clientY0+window.pageYOffset;B.style.left=t+"px",B.style.top=i+"px",B.style.width="0px",B.style.height="0px",B.setAttribute(w,t),B.setAttribute(v,i),B.setAttribute(A,t),B.setAttribute(M,i)},move(e){const t=parseFloat(B.getAttribute(A))||0,i=parseFloat(B.getAttribute(M))||0;let o=parseFloat(B.getAttribute(w))||0,d=parseFloat(B.getAttribute(v))||0;o+=e.dx,d+=e.dy,B.setAttribute(w,o),B.setAttribute(v,d);const r=Math.min(t,o),n=Math.max(t,o),s=Math.min(i,d),l=Math.max(i,d);B.style.left=r+"px",B.style.width=n-r+"px",B.style.top=s+"px",B.style.height=l-s+"px",m.clear();e.ctrlKey&&J.forEach((e=>m.add(e)));for(const e of a.keys())if(!m.has(e)){const t=$("#"+e);if(t){const i=t.offset(),o=i.left,d=i.top,a=o+t.width(),c=d+t.height();o>=r&&o<=n&&a>=r&&a<=n&&d>=s&&d<=l&&c>=s&&c<=l&&m.add(e)}}oe()},end(){J=[],B&&(B.parentNode.removeChild(B),B=null)}}}).on("tap",(function(){ie()}));var j=null;interact("#DropperDroite .drop-zone-col").dropzone({accept:".drag-drop-new, .drag-drop-move",ondropactivate(e){e.target.classList.add(p)},ondragenter(e){e.target.classList.add(h),j=e.target},ondragleave(e){e.target.classList.remove(h),j=null},ondrop(e){},ondropdeactivate(e){e.target.classList.remove(p),e.target.classList.remove(h),j=null}}),interact("#DropperDroite").dropzone({accept:".drag-drop-new",ondropactivate(e){e.target.classList.add(p)},ondragenter(e){e.target.classList.add(h)},ondragleave(e){e.target.classList.remove(h)},ondrop(e){},ondropdeactivate(e){e.target.classList.remove(p),e.target.classList.remove(h)}});var Y=null,G=null;function X(){angular.element(document.body).injector().invoke(["EventCenterService",e=>{e.sendEvent(EVENTS_EDITOR_ADD_REMOVE_WIDGET)}])}function K(e){_.isUndefined($("#"+e)[0])||(o[e]=$("#"+e).width()/$("#"+$("#"+e)[0].parentNode.parentNode.id).width(),d[e]=$("#"+e).height()/$("#"+$("#"+e)[0].parentNode.parentNode.id).height(),r[e]=$("#"+e).position().left/$("#"+$("#"+e)[0].parentNode.parentNode.id).width(),n[e]=$("#"+e).position().top/$("#"+$("#"+e)[0].parentNode.parentNode.id).height(),l=getMedia())}function Z(){layoutMgr.updateMaxTopAndLeft();var e=$("#drop-zone")[0].getElementsByTagName("div");s=ee(),g.setDimensions(s),g.setScalingMethod(c);var t,o=isMediaChanged(l);if(t=o.bChanged,l=o.lastMedia,t)!function(){g.resizeDashboardCols();for(var e=$("#drop-zone")[0].getElementsByTagName("div"),t=0;t<e.length;t++)if($("#"+e[t].id).hasClass("drsElement")&&"Widget"!=e[t].id.substring(0,6)){var i=e[t],o=i.id;g.resizeWidgetOnMediaChange(o,o);for(var d=i.childNodes.length-1;d>=0;d--)if(i.childNodes[d].id.match("WidgetContainer")){wcId=i.childNodes[d].id;break}widgetContainer.replaceWidget(i)}}();else for(var d=0;d<e.length;d++)if(e[d].id&&$("#"+e[d].id).hasClass("drsElement")&&"Widget"!=e[d].id.substring(0,6)){var r=e[d].id;rescaleWidget(i,r),a.get(r).widgetObj=i[r]}}function q(){flatUiWidgetsPlugin.clear(),plotlyWidgetsPlugin.clear(),mapWidgetsPlugin.clear();for(const[e,t]of a)_.isUndefined(models[e])||delete models[e],_.isUndefined(modelsParameters[e])||delete modelsParameters[e],_.isUndefined(modelsHiddenParams[e])||delete modelsHiddenParams[e],_.isUndefined(modelsTempParams[e])||delete modelsTempParams[e];a.clear();for(const e in i)delete i[e];if(t.length=0,bFirstExec=!0,ie(),X(),storage={},$("#DropperDroite")[0].hasChildNodes())for(var e=$("#DropperDroite")[0],o=e.childNodes.length-1;o>=0;o--)"menuWidget"!=e.childNodes[o].id&&e.childNodes[o].remove()}function Q(){var e;for(e in layoutMgr.clear(),o)delete o[e];for(e in d)delete d[e];for(e in r)delete r[e];for(e in n)delete n[e];l="",c="scaleTwh",q(),widgetConnector.clear(),widgetPreview.clear()}function ee(){return{widthPx:$("#drop-zone").width(),heightPx:$("#drop-zone").height(),scrollWidthPx:$("#drop-zone")[0].scrollWidth,scrollHeightPx:$("#drop-zone")[0].scrollHeight,widthVw:100*$("#drop-zone").width()/document.documentElement.clientWidth,heightVh:100*$("#drop-zone").height()/document.documentElement.clientHeight,scrollWidthVw:100*$("#drop-zone")[0].scrollWidth/document.documentElement.clientWidth,scrollHeightVh:100*$("#drop-zone")[0].scrollHeight/document.documentElement.clientHeight,scalingMethod:c,media:getMedia(),colDims:g.getCurrentDropperDims()}}function te(e){m.delete(e.id),oe()}function ie(){m.clear(),oe()}function oe(){!function(){for(const e of a.keys())$("#"+e).removeClass(f),$("#"+e).removeClass(b);let e=null;m.forEach((t=>{e=$("#"+t),e.addClass(f)})),e&&e.addClass(b)}(),angular.element(document.body).injector().invoke(["EventCenterService",e=>{e.sendEvent(EVENTS_EDITOR_SELECTION_CHANGED)}])}function de(){angular.element(document.body).injector().invoke(["EventCenterService",e=>{e.sendEvent(EVENTS_EDITOR_WIDGET_MOVED)}])}return interact(".drag-drop-new").draggable({cursorChecker:(e,t,i,o)=>o?"grabbing":"grab",listeners:{start(e){const t=e.target;G=t.id,(Y=t.cloneNode(!0)).id="dragged-new-widget",Y.classList.add("dragged-new-widget"),document.body.appendChild(Y);const i=t.getBoundingClientRect();y=i.top+window.pageYOffset,x=i.left+window.pageXOffset,Y.style.left=x+"px",Y.style.top=y+"px",Y.setAttribute(w,x),Y.setAttribute(v,y)},move(e){let t=parseFloat(Y.getAttribute(w))||0,i=parseFloat(Y.getAttribute(v))||0;t+=e.dx,i+=e.dy,Y.setAttribute(w,t),Y.setAttribute(v,i);const o=gridMgr.getGrid();if(o){let e=u;j&&j.id&&(e=j.id);const d=$("#"+e).offset();[t,i]=k([t,i],[d.left,d.top],o)}Y.style.left=t+"px",Y.style.top=i+"px"},end(e){let t=parseFloat(Y.getAttribute(w))||0,i=parseFloat(Y.getAttribute(v))||0;Y.parentNode.removeChild(Y),F(Y),Y=null;const o=e.relatedTarget;if(o&&o.id){const e=o.id;if(e===u||e.startsWith("dpr")){const d=o.getBoundingClientRect();t-=d.left-window.pageXOffset,i-=d.top-window.pageYOffset;const r=gridMgr.getGrid();r&&([t,i]=k([t,i],[0,0],r)),layout={top:unitH(i),left:unitW(t)},angular.element(document.body).injector().invoke(["UndoManagerService","EditorActionFactory",(t,i)=>{const o=i.createCreateWidgetdAction(G,e,layout);t.execute(o)}])}}G=null}}}).on("tap",(function(e){if(e&&e.currentTarget&&e.currentTarget.id){const t=e.currentTarget.id;angular.element(document.body).injector().invoke(["UndoManagerService","EditorActionFactory",(e,i)=>{const o=i.createCreateWidgetdAction(t);e.execute(o)}])}})),interact("#DropperDroite .drag-drop-move").resizable({edges:{left:!0,right:!0,bottom:!0,top:!0},margin:7,listeners:{start(e){const t=e.target.id;t&&a.has(t)&&!m.has(t)&&(m.clear(),m.add(t),oe()),m.forEach((t=>{const i=document.getElementById(t),o=i.offsetLeft,d=i.offsetTop,r=i.offsetHeight||1,n=i.offsetWidth||1;i.setAttribute(A,o),i.setAttribute(M,d),i.setAttribute(C,r),i.setAttribute(D,n),i.setAttribute(w,o),i.setAttribute(v,d),i.setAttribute(W,r),i.setAttribute(E,n);const a=parseInt(i.style["min-width"]||minWidthCst+"px",10),s=parseInt(i.style["min-height"]||minHeightCst+"px",10);i.setAttribute(I,a/n),i.setAttribute(S,s/r);const l=O(i);let c=1/0,g=1/0;if(l!==u){const t=document.getElementById(l);if(!e.edges.left){const e=t.offsetWidth-o-minLeftCst;c=Math.min(c,e/n)}if(!e.edges.top){const e=t.offsetHeight-d-minTopCst;g=Math.min(g,e/r)}}if(e.edges.left){const e=o+n-minLeftCst;c=Math.min(c,e/n)}if(e.edges.top){const e=d+r-minTopCst;g=Math.min(g,e/r)}i.setAttribute(T,c),i.setAttribute(N,g)}))},move(e){const t=H(e.target),i=e.edges.left||e.edges.right,o=e.edges.top||e.edges.bottom,d=e.edges.left,r=e.edges.top;let n=i?e.rect.width/t.width:1,a=o?e.rect.height/t.height:1;if(e.shiftKey&&i&&o){const e=Math.max(n,a);n=a=e}const s=gridMgr.getGrid();m.forEach((t=>{const l=document.getElementById(t),c=H(l),g=parseFloat(l.getAttribute(I))||0,m=parseFloat(l.getAttribute(S))||0,u=parseFloat(l.getAttribute(T))||1/0,p=parseFloat(l.getAttribute(N))||1/0,h={...c};let f=n,b=a;if(e.shiftKey&&i&&o){f=b=Math.max(f,b)}if(s){const e=h.width*f,t=h.height*b,n=h.left+(d?c.width-e:e),a=h.top+(r?c.height-t:t),[l,g]=k([n,a],[0,0],s);i&&(f=(e+(l-n)*(d?-1:1))/h.width),o&&(b=(t+(g-a)*(r?-1:1))/h.height)}f=Math.min(f,u),b=Math.min(b,p),f=Math.max(f,g),b=Math.max(b,m),i&&(h.width*=f,d&&(h.left-=h.width-c.width)),o&&(h.height*=b,r&&(h.top-=h.height-c.height)),l.style.left=h.left+"px",l.style.top=h.top+"px",l.style.width=h.width+"px",l.style.height=h.height+"px",l.setAttribute(w,h.left),l.setAttribute(v,h.top),l.setAttribute(W,h.height),l.setAttribute(E,h.width)})),de()},end(e){const t=new Map;m.forEach((e=>{const i=document.getElementById(e);let o={left:parseFloat(i.getAttribute(w))||0,top:parseFloat(i.getAttribute(v))||0,height:parseFloat(i.getAttribute(W))||0,width:parseFloat(i.getAttribute(E))||0};const d=H(i);angular.equals(d,o)||(widgetContainer.moveResizeWidget(i,d,!1,!0),t.set(e,o)),F(i)})),t.size>0&&angular.element(document.body).injector().invoke(["UndoManagerService","EditorActionFactory",(e,i)=>{const o=i.createSetGeometryAction(t,"Resize widget"+(t.size>1?"s":""));e.execute(o)}])}}}).draggable({cursorChecker:(e,t,i,o)=>o?"grabbing":"grab",listeners:{start(e){const t=e.target.id;t&&a.has(t)&&!m.has(t)&&(m.clear(),m.add(t),oe()),m.forEach((e=>{const t=document.getElementById(e),i=t.offsetLeft,o=t.offsetTop,d=t.offsetHeight||1,r=t.offsetWidth||1;t.setAttribute(A,i),t.setAttribute(M,o),t.setAttribute(C,d),t.setAttribute(D,r),t.setAttribute(w,i),t.setAttribute(v,o)}))},move(e){let t=u;j&&j.id&&(t=j.id);const i=gridMgr.getGrid();m.forEach((o=>{const d=document.getElementById(o),r=O(d),n={left:parseFloat(d.getAttribute(w))||0,top:parseFloat(d.getAttribute(v))||0,height:parseFloat(d.getAttribute(C))||0,width:parseFloat(d.getAttribute(D))||0};n.left+=e.dx,n.top+=e.dy,d.setAttribute(w,n.left),d.setAttribute(v,n.top);let a=n;if(r!==u&&(a=U(r,a)),t===u)i&&([a.left,a.top]=k([a.left,a.top],[0,0],i)),a.left=Math.max(minLeftCst,a.left),a.top=Math.max(minTopCst,a.top);else{const e=$("#"+t),o=e.offset(),d={left:o.left,top:o.top,height:e.height(),width:e.width()};i&&([a.left,a.top]=k([a.left,a.top],[d.left,d.top],i)),a=enforceConstraints(a,d)}const s=V(t,a);d.setAttribute(z,s.left),d.setAttribute(P,s.top),r!==u&&(a=V(r,a)),d.style.left=a.left+"px",d.style.top=a.top+"px",d.style.width=a.width+"px",d.style.height=a.height+"px"})),de()},end(e){const t=new Map,i=e.relatedTarget;let o=u;i&&i.id&&(o=i.id);const d=gridMgr.getGrid();layoutMgr.isRowColMode()&&o===u?m.forEach((e=>{const t=document.getElementById(e),i=H(t);widgetContainer.moveResizeWidget(t,i,!1,!1),F(t)})):(m.forEach((e=>{const i=document.getElementById(e),r=O(i);let n=parseFloat(i.getAttribute(w))||0,a=parseFloat(i.getAttribute(v))||0;const s=H(i);let l={left:n,top:a};o!==r&&(l=U(r,l),l=V(o,l)),d&&([l.left,l.top]=k([l.left,l.top],[0,0],d)),angular.equals(s,l)||(widgetContainer.moveResizeWidget(i,s,!1,!1),t.set(e,l)),F(i)})),t.size>0&&angular.element(document.body).injector().invoke(["UndoManagerService","EditorActionFactory",(e,i)=>{const d=i.createDropToCellAction(o,t,"Move widget"+(t.size>1?"s":""));e.execute(d)}]))}}}).on("tap",(function(e){const t=e.ctrlKey,i=e.currentTarget.id;i&&a.has(i)&&(t?m.has(i)?m.delete(i):m.add(i):(m.clear(),m.add(i)),oe(),e.preventDefault(),e.stopImmediatePropagation())})),{addWidget:function(e,t,o,d,r){const n=widgetFactory.build(e,t,o,d,r);if(i[n.instanceId]=n.widgetObj,a.set(n.instanceId,n),"createWidget"!=i[n.instanceId].constructor.name)return X(),m.clear(),m.add(n.instanceId),oe(),n;widgetInstance.deleteWidget(n.divModel)},deleteWidget:function(e){const t=a.get(e).divModel;widgetInstance.deleteWidget(t),te(t),t.remove(),X()},widgetObject:i,widgetContainers:a,modelsId:t,serialize:function(){var e,t,i,o;i={};var d={},r={};for([e,t]of a)i={top:$("#"+t.id)[0].style.top,left:$("#"+t.id)[0].style.left,height:$("#"+t.id)[0].style.height,width:$("#"+t.id)[0].style.width,minHeight:$("#"+t.id)[0].style.minHeight,minWidth:$("#"+t.id)[0].style.minWidth,"z-index":$("#"+t.id)[0].style["z-index"]},r={id:t.id,instanceId:t.instanceId,modelJsonId:t.modelJsonId,widgetTypeName:t.widgetTitle},"annotationLabel"==t.modelJsonId||"annotationImage"==t.modelJsonId?d[e]={layout:i,container:r,modelParameters:modelsParameters[e],modelHiddenParams:modelsHiddenParams[e]}:(emptyModelsHiddenParams=jQuery.extend(!0,{},modelsHiddenParams[t.modelJsonId]),"perfectWidgetsSimpleMeter"!=t.modelJsonId&&"perfectWidgetsTachometer"!=t.modelJsonId&&"perfectWidgetsMultiSwitch"!=t.modelJsonId&&"perfectWidgetsSimpleCompass"!=t.modelJsonId&&"perfectWidgetsSimpleCircleWind"!=t.modelJsonId||Object.keys(modelsParameters[e]).forEach((t=>{o=t.replace(".","_"),modelsParameters[e][o]=modelsParameters[e][t],delete modelsParameters[e][t]})),d[e]={layout:i,container:r,modelParameters:modelsParameters[e],modelHiddenParams:emptyModelsHiddenParams});return d},deserialize:function(e,i,o){Q(),s=ee();var d,r,n,a=0;_.isUndefined(i)||_.isUndefined(i.scalingMethod)||(c=i.scalingMethod),g.setDimensions(s),g.setScalingMethod(c),o=layoutMgr.deserialize(o,i),g.deserialize(i),layoutMgr.updateColHeight(i),g.resizeDashboardCols();var m=i,u=s;if(_.isUndefined(i))m=s;else{_.isUndefined(i.media)&&(i.media="large");var p=g.mediaChangeProjection(i,s,layoutMgr.getRows());l=p.lastMedia,m=p.referenceFrame,u=p.targetFrame}var h,f,b=new scalingManager(m,u,c),y="",w=layoutMgr.deserializeCols(e,o);for(h in e){if(!_.isEmpty(e[h].modelParameters)){let t=e[h].container.modelJsonId,i=e[h].modelParameters;"perfectWidgetsSimpleMeter"!=t&&"perfectWidgetsTachometer"!=t&&"perfectWidgetsMultiSwitch"!=t&&"perfectWidgetsSimpleCompass"!=t&&"perfectWidgetsSimpleCircleWind"!=t||Object.keys(i).forEach((e=>{f=e.replace("_","."),i[f]=i[e],delete i[e]})),modelsParameters[h]=i}"annotationLabel"!=e[h].container.modelJsonId&&"annotationImage"!=e[h].container.modelJsonId||_.isEmpty(e[h].modelHiddenParams)||(modelsHiddenParams[h]=e[h].modelHiddenParams),t[a]=h,r={topVh:rmUnit(e[h].layout.top),leftVw:rmUnit(e[h].layout.left),widthVw:rmUnit(e[h].layout.width),heightVh:rmUnit(e[h].layout.height)},d={top:(n=b.scale(r)).topVh+"vh",left:n.leftVw+"vw",width:n.widthVw+"vw",height:n.heightVh+"vh"},y=_.isUndefined(e[h].container.widgetTypeName)?e[h].container.modelJsonId:e[h].container.widgetTypeName;var v=document.getElementById(w[h]);widgetEditor.addWidget(e[h].container.modelJsonId,v,e[h].container.instanceId,d,e[h].layout["z-index"],y),a+=1}for(h in e)K(e[h].container.instanceId);s=ee(),g.setDimensions(s)},rescale:Z,resizeDashboard:function(){s=ee(),g.setDimensions(s),g.setScalingMethod(c),g.resizeDashboard(),Z()},clear:Q,reset:q,getCurrentDashZoneDims:ee,getSnapshotDashZoneDims:function(){return s},updateSnapshotDashZoneDims:function(){s=ee()},computeDropperMaxWidth:function(){panelDash.fullScreenWidth=Math.ceil((e.offsetWidth+25)/.75*.975-25)},setLastMedia:function(e){l=e},getWidgetsRelativeDims:function(){return{width:o,height:d,left:r,top:n}},setScalingMethod:function(e){c=e,g.setScalingMethod(c)},widthRatioModels:o,heightRatioModels:d,leftRatioModels:r,topRatioModels:n,selectWidget:function(e){m.add(e.id),oe()},selectAllWidgets:function(){m.clear();for(const e of a.keys())m.add(e);oe()},unselectWidget:te,unselectAllWidgets:ie,getSelectedActive:function(){let e=null;for(e of m);return e},getSelection:function(){return[...m]},getContainer:function(e){return document.getElementById(O(e))},MAIN_CONTAINER_ID:u,DATA_ATTR_DISPLAY_X:z,DATA_ATTR_DISPLAY_Y:P,showHideWidgMenu:function(e){let t=!0;const i=e.parentElement.parentElement,o=i.id;let d=[],r=widgetConnector.widgetsConnection;_.isUndefined(r[o])||_.each(_.keys(r[o].sliders),(e=>{let t=r[o].sliders[e].dataNode;-1===d.indexOf(t)&&d.push(t)})),document.getElementById("openGraphFromWidget").setAttribute("name",JSON.stringify(d));const n="menuWidget";$("#"+n)[0].getAttribute("name")!==o&&($("#"+n).attr("name",o),t=!1);const a=angular.element(document.getElementById("dashboard-editor")).scope().vm;a.menuWidgetVisible?t&&(a.menuWidgetVisible=!1):a.menuWidgetVisible=!0;const s=O(i),l=$("#"+u)[0].offsetHeight,c=$("#"+s)[0].offsetTop,g=$("#"+s)[0].offsetLeft,m=$("#"+o)[0].clientWidth,p=$("#"+o)[0].clientHeight,h=$("#"+o)[0].offsetTop,f=$("#"+o)[0].offsetLeft,b=247.047,y=443,w=p-10,v=layoutMgr.getRows();let A,M;s!==u?(M=l*v,A=l-(p+h+c)):(M=l,A=l-(h+p)),v<=1&&c+h+30+y>=l&&A+w+y>=l?($("#"+n)[0].style.bottom="10px",$("#"+n)[0].style.top="auto",document.styleSheets[0].addRule("#menuWidget::after","top: -5px; transform: rotate(0deg)")):c+h+30+y>=M?($("#"+n)[0].style.bottom=(w+A).toString()+"px",$("#"+n)[0].style.top="auto",document.styleSheets[0].addRule("#menuWidget::after","top: 443px; transform: rotate(180deg)")):($("#"+n)[0].style.top=(c+h+30).toString()+"px",$("#"+n)[0].style.bottom="auto",document.styleSheets[0].addRule("#menuWidget::after","top: -5px; transform: rotate(0deg)")),(m+f).toString()<=b&&0==g?($("#"+n)[0].style.left="7px",document.styleSheets[0].addRule("#menuWidget::after","left: "+(f+m-30)+"px")):($("#"+n)[0].style.left=(m+f+g-b).toString()+"px",document.styleSheets[0].addRule("#menuWidget::after","left: auto; right: 20px")),$("#"+n)[0].style.right="auto"}}}var widgetEditor=initEditWidget();
...
var xdash=function(){var e=xDashConfig.version.fullVersion,t="";const a=angular.element(document.body).scope().$root;function n(){angular.element(document.body).injector().invoke(["UndoManagerService",e=>{e.clear()}]),datanodesManager.clear(),widgetEditor.clear(),xdashNotifications.clearAllNotifications(),$("#projectName")[0].value=t,$(".tab--active").removeClass("changed"),a.currentPrjDirty="";angular.element(document.getElementById("library__wrap")).scope().resetPyodideLibs(),layoutMgr.resetDashBgColor(),layoutMgr.resetDashboardTheme();angular.element(document.getElementById("help__wrap")).scope().initFrame()}function o(){return{version:e,date:Date(),name:"",description:"",groupName:"",tags:[],schedulerLogOff:offSchedLogUser}}async function i(e){try{return $("#projectName")[0].value=e.meta.name,_.isUndefined(e.meta.description)||(a.currentProject.description=e.meta.description),_.isUndefined(e.meta.tags)||(a.currentProject.tags=e.meta.tags),_.isUndefined(e.meta.groupName)||(a.currentProject.groupName=e.meta.groupName),_.isUndefined(e.meta.schedulerLogOff)?offSchedLogUser=!0:offSchedLogUser=e.meta.schedulerLogOff,await pyodideLib.deserialize(e),e.data.version=e.meta.version,datanodesManager.load(e.data,!0)?(angular.element(document.body).injector().invoke(["UndoManagerService",e=>{e.clear()}]),function(e,t,a,n){const o=e.droppers;let i=[];"datasources"in n?_.isUndefined(n.datasources)||(i=n.datasources.map((e=>e.name))):_.isUndefined(n.datanodes)||(i=n.datanodes.map((e=>e.name)));if(_.isEmpty(o)){const e=_.keys(t);_.each(e,(e=>{r(e,t,a,n,i)}))}else{const e=_.keys(o);_.each(e,(e=>{const l=_.keys(o[e]);_.each(l,(l=>{let s=o[e][l];o[e][l]=r(s,t,a,n,i)}))}))}}(e.device,e.dashboard,e.connections,e.data),widgetEditor.deserialize(e.dashboard,e.scaling,e.device),widgetConnector.deserialize(e.connections),widgetPreview.clear(),widgetEditor.unselectAllWidgets(),layoutMgr.deserializeDashBgColor(e.device),layoutMgr.deserializeDashboardTheme(e.device),_.isUndefined(e.pages)||(layoutMgr.deserializeRowNames(e.pages),layoutMgr.deserializeDefaultRow(e.pages)),layoutMgr.deserializeExportOptions(e.exportOptions),_.isUndefined(e.navBarNotification)?htmlExport.navBarNotification=!1:htmlExport.navBarNotification=e.navBarNotification,!0):(n(),!1)}catch(e){return console.log(e),!1}}function r(e,t,a,n,o){if(e.includes("flatUiValue")&&!e.includes("flatUiValueDisplay")){let i="",r="";"datasources"in n?_.isUndefined(a[e].value.dataSource)||(r=a[e].value.dataSource):_.isUndefined(a[e].value.dataNode)||(r=a[e].value.dataNode);(""===r||o.includes(r))&&!_.isUndefined(t[e].modelParameters.isNumber)?(t[e].modelParameters.isNumber?(_.isUndefined(t[e].modelParameters.isPassword)||delete t[e].modelParameters.isPassword,i="flatUiNumericInput"):i="flatUiTextInput",delete t[e].modelParameters.isNumber):i="flatUiValueDisplay",_.isUndefined(t[e].container.id)||(t[e].container.id=t[e].container.id.replace("flatUiValue",i)),_.isUndefined(t[e].container.instanceId)||(t[e].container.instanceId=t[e].container.instanceId.replace("flatUiValue",i)),_.isUndefined(t[e].container.modelJsonId)||(t[e].container.modelJsonId=t[e].container.modelJsonId.replace("flatUiValue",i)),_.isUndefined(t[e].container.widgetTypeName)||(t[e].container.widgetTypeName=t[e].container.widgetTypeName.replace("flatUiValue",i)),_.isUndefined(t[e].modelParameters.decimalDigits)||delete t[e].modelParameters.decimalDigits;let l=e;return t[e=e.replace("flatUiValue",i)]=t[l],delete t[l],a[e]=a[l],delete a[l],e}return e}function l(e,t){let a="Previous";t&&"datanode"!=e||(a="Cancel"),(new FileMngrFct).GetFileList(e,s,!1,a,null)}function s(e,t,a,n){if("error"==a)swal(e,t,a);else if("success"==a){let a=t,o="files";"project"==a?o="projects":"datanode"==a&&(o="xdsjson"),contentElement=function(e,t){var a=document.createElement("div");a.classList.add("dashboard-form");var n='<label for="selectFile">'+t+"</label>";if(n+='<select class="multiple h-full" name="select-file" id="selectFile" size="10">',!_.isUndefined(e.FileList))for(let t=0;t<e.FileList.length;t++)_.isUndefined(e.FileList[t].Name)||(n=0==t?n+'<option selected value ="'+e.FileList[t].Name+'">'+e.FileList[t].Name+"</option>":n+'<option value ="'+e.FileList[t].Name+'">'+e.FileList[t].Name+"</option>");return n+="</select>",a.innerHTML=n,a}(e,"Please select a "+a+": "),new DialogBox(contentElement,"List of available "+o+" on server","Open",n,(function(){let e=$("#selectFile")[0];if(-1==e.selectedIndex)return!0;{datanodesManager.showLoadingIndicator(!0);let t=e.options[e.selectedIndex].value;swal.close(),(new FileMngrFct).ReadFile(a,t,d)}}))}}function d(e,t,a){if("error"==a)swal(e,t,a);else{let a=e,n=t;"project"==n?c(a):"datanode"==n&&xdsjson.openJsonManager(a)}datanodesManager.showLoadingIndicator(!1)}async function c(e){let t;try{t=JSON.parse(e)}catch(e){return void swal("Unable to load file","Project loading will be interrupted.","error")}var a;a=t,angular.element(document.body).injector().invoke(["$rootScope",function(e){e.currentProject={name:a.meta.name}}]);let n=!1,o=async function(e){if(angular.element(document.getElementById("dash-ctrl")).scope().reset(),n=await i(t),datanodesManager.showLoadingIndicator(!1),document.removeEventListener("widgets-tab-loaded",o),t=void 0,!n)return swal("Unable to load your project","Project loading will be interrupted.","error"),!1};document.addEventListener("widgets-tab-loaded",o),"widgets"==tabActive&&await o()}return $(window).bind("beforeunload",(function(){return function(){let e=angular.element(document.body).scope().$root;if(""!==e.currentProject.name){let t=angular.element(document.getElementById("headerbar-ctrl")).scope();$(".tab--active").hasClass("changed")?fileManager.getFileListExtended("project",e.currentProject.name,void 0,(function(){t.closeProject(e.currentProject.name,!0),console.log("Your project is saved before closing")}),!0):(t.closeProject(e.currentProject.name),console.log("Your project was closed"))}}(),"Are you sure you want to leave the page ?"})),{openFile:function(e,t){"project"==e?fileText="project":"datanode"==e&&(fileText="xdsjson"),"local"===t?function(e){let t=FileMngr.GetFileExt(e);if(window.File&&window.FileReader&&window.FileList&&window.Blob){let a=document.createElement("input");a.type="file",a.setAttribute("accept",t),$(a).on("change",(function(t){"project"==e&&swal.close();let a=t.target.files;if(a&&a.length>0){let t=a[0],n=new FileReader;datanodesManager.showLoadingIndicator(!0),n.addEventListener("load",(function(t){let a=t.target;"project"==e?c(a.result):"datanode"==e&&xdsjson.openJsonManager(a.result)})),n.readAsText(t)}})),$(a).trigger("click")}else swal("Unable to load a file in this browser.","","error")}(e):"server"===t&&l(e,!0)},openFromServer:l,serialize:function(){const e=o();e.name=$("#projectName")[0].value||"Untitled",a.currentProject&&(e.description=a.currentProject.description,e.tags=a.currentProject.tags,e.groupName=a.currentProject.groupName);const t=datanodesManager.serialize(),n=pyodideLib.serialize();let i;i=a.moduleOpened||"widgets"!=tabActive||"edit-dashboard"!=modeActive||"full"!=editorStatus?widgetEditor.getSnapshotDashZoneDims():widgetEditor.getCurrentDashZoneDims();const r=widgetEditor.serialize(),l=layoutMgr.serializeCols(),s=layoutMgr.serializeDashBgColor(),d=layoutMgr.serializeDashboardTheme(),c=widgetConnector.serialize(),u=layoutMgr.serializeRowNames(),g=layoutMgr.serializeDefaultRow(),m=layoutMgr.serializeExportOptions();return navBarNotification=htmlExport.navBarNotification,{meta:e,data:t,libraries:n,scaling:i,device:{...l,...s,...d},dashboard:r,connections:c,exportOptions:m,pages:{...u,...g},checkExportOptions:!0,navBarNotification:navBarNotification}},initMeta:o,openProjectManager:c,deserialize:i,clear:n,pageLoad:!0,readFileFromServer:function(e,t){let a=new FileMngrFct,n=angular.element(document.body),o=n.scope().$root,i=n.scope().$state;o.origin="openProject",o.showNotifications=!1,o.toggleMenuOptionDisplay("none"),i.go("modules",{}),o.moduleOpened=!1,a.ReadFile(t,e+".xprjson",(function(a,n,i){if("success"===i){xdash.openProjectManager(a);let n=new PNotify({title:e,text:"Your "+t+" "+e+" is ready!",type:"success",delay:1800,styling:"bootstrap3"});$(".ui-pnotify-container").on("click",(function(){n.remove()})),o.loadingBarStop(),o.currentProject.name=e}else swal(a,n,i)}))},readFileFromUrl:function(e,t){let a;$.get(t,(function(e){a=e})).done((function(){let t=angular.element(document.body),n=t.scope().$root,o=t.scope().$state;n.origin="openProject",n.showNotifications=!1,n.toggleMenuOptionDisplay("none"),o.go("modules",{}),n.moduleOpened=!1,d(a,e)})).fail((function(e,t){datanodesManager.showLoadingIndicator(!1),swal("Error in loading xprjson from URL","Server response : "+e.status,"error")}))}}}();
...
var datanodesManager=function(){var e,n={},t=new DatanodeDependency;"undefined"==typeof execOutsideEditor?this.execOutsideEditor=!1:execOutsideEditor?this.execOutsideEditor=!0:this.execOutsideEditor=!1,this.execOutsideEditor||(e=new GraphVisu(t));var a,o=new TimeManager,i=new FreeboardUI,s=new DatanodesListModel(n,i,t,o),d=new JSONEdit,r={},c=new JSEditor,l=new PluginEditor(c);function u(e){if(e.sampleTime()&&o.unregisterDatanode(e.name()),t.hasSuccessors(e.name())){let n=Array.from(t.getSuccessors(e.name())).toString();n=n.replaceAll(",",", "),swal("Deleting dataNode side effects",'This dataNode "'+e.name()+'" is still used in dataNode(s) "'+n+'".\n It must be changed.',"warning")}var n=angular.element(document.body).scope().$root;s.deleteDatanode(e),s.datanodes.remove(e),n.alldatanodes=datanodesManager.getAllDataNodes(),n.filtredNodes=n.alldatanodes.length,n.showNotifications=!1,n.updateFlagDirty(!0),n.safeApply(),t.updateDisconnectedGraphsList(e.name(),"delete"),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("All disconnected Graphs after delete: ",t.getAllDisconnectedGraphs())}function g(e){var n=!1,t=[];for(var a in widgetConnector.widgetsConnection)for(var o in widgetConnector.widgetsConnection[a].sliders)"None"!=widgetConnector.widgetsConnection[a].sliders[o].name&&widgetConnector.widgetsConnection[a].sliders[o].dataNode===e&&(n=!0,t.push(a));return n||(t=[]),[n,_.uniq(t)]}function m(e,n,t){if([bFoundConnection,prop]=g(e.name()),"datanode"==n&&bFoundConnection){let n=[];for(let e=0;e<prop.length;e++)n.push(widgetConnector.widgetsConnection[prop[e]].instanceId);swal({title:"Are you sure?",text:"This dataNode will be deleted and connections with widget(s) '"+n.join("\n")+"' may be removed!",type:"warning",showCancelButton:!0,showConfirmButton:!1,showConfirmButton1:!0,confirmButtonText:"Yes",cancelButtonText:"Abandon",closeOnConfirm:!0,closeOnConfirm1:!0,closeOnCancel:!0},(function(n){if(n){if(u(e),angular.element(document.body).scope().$root.bIsPlayMode)for(key in widgetConnector.widgetsConnection)widgetPreview.plotConstantData(key,!1)}}))}else{var a=angular.element(document.body).scope().$root;a.isPopupWindow=!0,a.popupTitle="Confirm Delete",a.popupText="Are you sure you want to delete this "+t,a.popupAction=function(){"datanode"==n&&u(e)}}}return ko.bindingHandlers.pluginEditor={init:function(e,t,a,o,i){var s=ko.unwrap(t()),d="";"datanode"==s.type&&(n,d="DataNode"),$(e).click((function(n){if("delete"==s.operation)m(o,s.type,d);else if("refresh"==s.operation)o.schedulerStart(void 0,void 0,"refresh");else if("stop"==s.operation)null!=o.execInstance()&&o.execInstance().stopOperation(o.name());else if("showTooltip"==s.operation)"datanode"==s.type&&($(e).tooltip("fixTitle"),$(e).tooltip("show"));else if("hide"==s.operation)"data-preview"==s.type&&$(e).parent().parent().parent().remove();else{"datanode"==s.type&&("add"==s.operation?{}:(o.type(),o.settings().name=o.name()))}}))}},ko.virtualElements.allowedBindings.datanodeTypeSettings=!0,ko.bindingHandlers.datanodeTypeSettings={update:function(e,n,t,a,o){processPluginSettings(e,n,t,a,o)}},{initialize:function(e){ko.applyBindings(s),i.showLoadingIndicator(!1),document.querySelectorAll(".docsLink").forEach((function(e){e.href=xDashConfig.urlDoc+"index.html"})),urlQueryEntry.process(e)},load:function(e,n,t){return s.load(e,n,t),!s.error()},serialize:function(){return s.serialize()},loadDatanodePlugin:function(e){_.isUndefined(e.display_name)&&(e.display_name=e.type_name),"Memory_plugin"!==e.type_name?e.settings.unshift({name:"name",display_name:"Name",type:"text",required:!0}):e.settings.unshift({name:"name",display_name:"Generated memory name",type:"text",disabled:!0}),n[e.type_name]=e,s._datanodeTypes.valueHasMutated()},getDataNodePluginTypes:function(){return n},setAssetRoot:function(e){c.setAssetRoot(e)},showLoadingIndicator:function(e){i.showLoadingIndicator(e)},foundDatanode:function(e){var n=s.datanodes();return datanode=_.find(n,(function(n){return n.name()===e})),!!datanode},getDataNodeByName:function(e){var n=s.datanodes();if(datanode=_.find(n,(function(n){return n.name()===e})),datanode)return datanode},getDatasourceByName:function(e){return datanodesManager.getDataNodeByName(e)},getAllDataNodes:function(){return s.datanodes()},getAllDataSources:function(){return datanodesManager.getAllDataNodes()},clear:function(){return schedulerProfiling={},s.clear()},showDepGraph:function(n){e.showDepGraph(n),angular.element(document.getElementById("dependency__graph--container")).scope().getUniqTypes()},editNodeFromGraph:function(e){angular.element(document.getElementById("dependency__graph--container")).scope().editNodeFromGraph(e)},selectNodeFromTagList:function(n){e.selectNodeFromTagList(n)},selectConnectedWithWidget:function(n){e.selectConnectedWithWidget(n)},closeGraph:function(){e.closeGraph()},isSingletonNode:function(e){return t.isSingletonNode(e)},RemoveUnusedDatanodes:function(){var e=[],n=t.getAllsingletonNodes();for(let t in n)[bFoundConnection,prop]=g(n[t]),bFoundConnection||e.push(n[t]);offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("zombie: ",e);var a=[],o=xdsjson.getDataList(e,"Unused data is a singleton node that is not connected to any widget.<br>Please check data to be deleted : ");new DialogBoxForData(o,"List of unused data","Delete","Cancel",(function(){for(var n=0;n<e.length;n++)$("#data-checkbox-"+n).is(":checked")&&(a[n]=e[n],u(datanodesManager.getDataNodeByName(e[n])),!0)}))},stopSchedule:function(){var e=s.datanodes();for(var n in t.clearExtraStartNodesList(),t.clearSetvarList(),t.clearProcessedSetvarList(),t.clearCurrentGraphList(),e)if(null!=e[n].execInstance()){e[n].execInstance().stopAllOperations(),swal("Scheduler progress","scheduler is stopped!","success");break}},isConnectedWithWidgt:g,previewWidget:function(e){var n=[];$("#widgets-preview-top > div").each(((e,t)=>{n.push(t.id),$("#"+t.id).hide()})),$("#widget-preview-zone-"+e).show()},deleteDataNode:function(e,n,t){m(e,n,t)},createPluginEditor:function(e,n,t,a){!function(e,n,t,a){l.createPluginEditor(e,n,t,a)}(e,n,t,a)},settingsSavedCallback:function(e,a,i,d){return!!l.saveSettings(d,i,(function(){return function(e,a,i){var d;if("add"==a.operation){if("datanode"==a.type){if(datanodesManager.foundDatanode(i.settings.name))return swal("A dataNode with name '"+i.settings.name+"' adready exists.","Please specify a different name","error"),!0;(d=new DatanodeModel(s,n,t,o)).name(i.settings.name),d.settings(i.settings),d.type(i.type),"Memory_plugin"===i.type&&(d.is_specific_exec=!0);const e="icn-"+i.iconType.replace(/\.[^/.]+$/,"");if(d.iconType(e),d.error())return!0;d.isSchedulerStartSafe(!0),s.addDatanode(d),t.updateDisconnectedGraphsList(d.name(),"add"),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("All disconnected Graphs after add: ",t.getAllDisconnectedGraphs()),_.isUndefined(i.settings.sampleTime)||0==i.settings.sampleTime?d.schedulerStart(void 0,void 0,"unidentified"):(d.sampleTime(i.settings.sampleTime),o.registerDatanode(d.sampleTime(),d.name(),"unidentified")),angular.element(document.body).injector().invoke(["$rootScope",function(e){}]);var r=angular.element(document.body).scope().$root;r.alldatanodes=datanodesManager.getAllDataNodes(),r.showNotifications=!1,r.safeApply()}}else if("edit"==a.operation){if("datanode"==a.type){if(e.isSettingNameChanged(i.settings.name)){if(datanodesManager.foundDatanode(i.settings.name))return swal("A dataNode with name '"+i.settings.name+"' already exists.","Please specify a different name","error"),!0;if(t.hasSuccessors(e.name())){var c=Array.from(t.getSuccessors(e.name()));xdashNotifications.manageNotification("info",e.name(),'Update new name "'+i.settings.name+'" in script of "'+c+'"');for(let n in c)formula=datanodesManager.getDataNodeByName(c[n]).settings().json_var_formula,formula=formula.replaceAll(e.name(),i.settings.name),datanodesManager.getDataNodeByName(c[n]).settings().json_var_formula=formula}if([bFoundConnection,prop]=g(e.name()),bFoundConnection){let n=[];for(let e in widgetConnector.widgetsConnection)for(let t in widgetConnector.widgetsConnection[e].sliders)n.push(widgetConnector.widgetsConnection[e].instanceId),widgetConnector.widgetsConnection[e].sliders[t].dataNode=i.settings.name;xdashNotifications.manageNotification("info",e.name(),'Update new name "'+i.settings.name+'" in connected widgets "'+n.join("\n")+'"')}null!=e.execInstance()&&e.execInstance().stopOperation(e.name()),e.name()!==i.settings.name&&s.renameDatanodeData(e.name(),i.settings.name)}e.name()!==i.settings.name&&t.renameNode(e.name(),i.settings.name),e.name(i.settings.name),_.isUndefined(i.settings.sampleTime)||e.isSettingSampleTimeChanged(i.settings.sampleTime)&&e.sampleTime(i.settings.sampleTime)}e.type(i.type),e.settings(i.settings);const n="icn-"+i.iconType.replace(/\.[^/.]+$/,"");if(e.iconType(n),e.error())return!0;"datanode"==a.type&&(t.computeAllDisconnectedGraphs(),offSchedLogUser||xDashConfig.disableSchedulerLog||console.log("All disconnected Graphs after rename: ",t.getAllDisconnectedGraphs()),_.isUndefined(i.settings.sampleTime)?e.schedulerStart(void 0,void 0,"edit"):0!=e.sampleTime()?o.registerDatanode(e.sampleTime(),e.name(),"edit"):o.isRegisteredDatanode(e.name())&&(o.unregisterDatanode(e.name()),e.schedulerStart(void 0,void 0,"edit")))}return!1}(e,a,i)}))},getOldSettingsCallback:function(e){!function(e){if(_.isFunction(e.getSavedSettings)){var n=e.getSavedSettings();if(!_.isUndefined(n))e.settings(n[1]),e.statusCallback(n[0]),e.name()!==n[1].name&&(s.renameDatanodeData(e.name(),n[1].name),t.renameNode(e.name(),n[1].name)),e.name(n[1].name),n[1]}}(e)},getDataNodeNewSettings:function(){return l.getNewSettings()},getJsonEd:function(){return d},setJsonEditor:function(e){r=e},getJsonEditor:function(){return r},datanodesDependency:function(){return t},setCurrentDataNode:function(e){a=e},getCurrentDataNode:function(){return a}}}();
