...
function DatanodesListModel(e,a,t,n){var s=this,d=[];function r(a){var d=new DatanodeModel(s,e,t,n);return d.deserialize(a)?(s.addDatanode(d),!0):(s.error(!0),!1)}this.datanodes=ko.observableArray(),this.datasourceData={},this.processDatanodeUpdate=function(e,a){s.datasourceData[e]=a},this.renameDatanodeData=function(e,a){s.datasourceData[a]=s.datasourceData[e],delete s.datasourceData[e]},this._datanodeTypes=ko.observable(),this.datanodeTypes=ko.computed({read:function(){s._datanodeTypes();var a=[];return _.each(e,(function(e){var t=e.type_name,n=t;_.isUndefined(e.display_name)||(n=e.display_name),a.push({name:t,display_name:n})})),a}}),this.serialize=function(){var e=[];_.each(s.datanodes(),(function(a){e.push(a.serialize())}));var a=angular.element(document.body).scope().$root;return a.alldatanodes=datanodesManager.getAllDataNodes(),a.showNotifications=!1,a.safeApply(),{datanodes:e}},this.deserialize=function(e,a,o){return a&&s.clear(),function(){s.error=ko.observable(!1),d=[];var a,i=[];_.isUndefined(e.datanodes)&&(e.datanodes=e.datasources,delete e.datasources);for(let a=0;a<e.datanodes.length;a++)"REST_web-service_from_datasource"===e.datanodes[a].type||"FMI_web-service_from_datasource"===e.datanodes[a].type||"Map_matching_from_datasource"===e.datanodes[a].type||"Clock_web-service"===e.datanodes[a].type||"Generic_file_reader_plugin"===e.datanodes[a].type||e.datanodes[a].type;if(i=e.datanodes,_.each(i,(function(e){if(function(e){for(var a=!1,t=0;t<s.datanodes().length;t++)if(a=!1,s.datanodes()[t].name()==e){a=!0;break}return!!a}(e.name))d.push(e);else if(!r(e))return!1})),0!=d.length&&(a=xdsjson.getDuplicateDataList(d,"Please check data to be loaded after choosing rename or overwite option"),new DialogBoxForDuplicateData(a,"List of duplicate data name","Load","Close",(function(){var e=0;for(e=0;e<d.length;e++)$("#data-checkbox-"+e).is(":checked")&&(d[e].name=$("#data-check-"+e)[0].value);for(e=0;e<d.length;e++)if($("#data-checkbox-"+e).is(":checked"))if(d[e].name=$("#data-check-"+e)[0].value,$("#data-rename-"+e).is(":checked"))r(d[e]);else for(var a=0;a<s.datanodes().length;a++)if(s.datanodes()[a].name()==d[e].name){s.deleteDatanode(s.datanodes()[a]),s.datanodes.remove(s.datanodes()[a]),r(d[e]);break}}))),s.datanodes().length>0){var l=!1,c=Object.keys(t.dependencyStructure).length-i.length;if(0!=c)for(var f in t.dependencyStructure){l=!1;for(var u=0;u<i.length;u++)if(f===i[u].name){l=!0;break}if(!l){var h=Array.from(t.getSuccessors(f));swal("Missed dataNodes!","'"+f+"' is referenced in formula of '"+h+"' but doesn't exist in list of datanodes","error"),c--}if(0==c)break}for(var m=!1,g=!1,p=0,v=0,b=0;b<s.datanodes().length;b++)i=s.datanodes()[b],_.isUndefined(i.settings().refresh)?_.isUndefined(i.settings().refresh_time)?_.isUndefined(i.settings().refresh_rate)?_.isUndefined(i.settings().refreshRate)||(i.settings().sampleTime=i.settings().refreshRate,delete i.settings().refreshRate):(i.settings().sampleTime=i.settings().refresh_rate,delete i.settings().refresh_rate):(i.settings().sampleTime=i.settings().refresh_time,delete i.settings().refresh_time):(i.settings().sampleTime=i.settings().refresh,delete i.settings().refresh);t.computeAllDisconnectedGraphs();for(b=0;b<s.datanodes().length;b++)i=s.datanodes()[b],_.isUndefined(i.settings().sampleTime)||0==i.settings().sampleTime?(g=!0,v=b):(m=!0,p=b,i.sampleTime(i.settings().sampleTime),n.registerDatanode(i.sampleTime(),i.name(),"globalFirstUpdate"));m&&(i=s.datanodes()[p],n.registerDatanode(i.sampleTime(),i.name())),g&&(i=s.datanodes()[v],s.launchGlobalFirstUpdate(i))}_.isFunction(o)&&o()}(),!s.error()},this.launchGlobalFirstUpdate=function(e){var a=t.getSourceNodes();0!=a.length&&e.schedulerStart(a,a[0],"globalFirstUpdate")},this.clear=function(){if(Object.keys(t.getExtraStartNodes()).length&&t.clearExtraStartNodes(),_.each(s.datanodes(),(function(e){s.deleteDatanode(e)})),Object.keys(t.dependencyStructure).length)for(var e in t.dependencyStructure)t.removeNode(e),console.log("extra nodes are deleted");t.resetGraphList(),s.datanodes.removeAll()},this.load=function(e,t,n){a.showLoadingIndicator(!0),s.deserialize(e,t,(function(){return a.showLoadingIndicator(!1),_.isFunction(n)&&n(),!s.error()}))},this.addDatanode=function(e){for(var a=!1,t=0;t<s.datanodes().length;t++)if(a=!1,s.datanodes()[t].name()==e.name()){a=!0;break}a||s.datanodes.unshift(e)},this.deleteDatanode=function(e){var a=e.name();delete s.datasourceData[a],e.dispose()}}
