...
var chalkit=(scheduler={setVariable:function(e,a){chalkit.setVariable(e,a)},setVariables:function(e,a){chalkit.setVariables(e,a)},setVariableProperty:function(e,a,t){chalkit.setVariableProperty(e,a,t)},executeDataNode:function(e){chalkit.executeDataNode(e)},executeDataNodes:function(e){chalkit.executeDataNodes(e)}},dashboard={viewPage:function(e,a,t){chalkit.viewPage(e,a,t)},viewProject:function(e,a,t){chalkit.viewProject(e,a,t)},goToPage:function(e){chalkit.goToPage(e)},enableWidget:function(e){chalkit.enableWidget(e)},disableWidget:function(e){chalkit.disableWidget(e)},showWidget:function(e){chalkit.showWidget(e)},hideWidget:function(e){chalkit.hideWidget(e)}},notification={notify:function(e,a,t){chalkit.notify(e,a,t)},swalert:function(e,a,t){chalkit.swalert(e,a,t)}},{setVariable:function(e,a){const t=JSON.parse(JSON.stringify(a)),n=datanodesManager.getCurrentDataNode();let i=datanodesManager.getDataNodeByName(e);_.isUndefined(i)?(i=datanodesManager.getDataNodeByName(n),i.notificationCallback("error",n,"The dataNode referenced in setVariable api doesn't exist. Please verify your parameters")):(datanodesManager.datanodesDependency().addSetvarList(e,n),i.setValue([],t,!0))},setVariables:function(e,a){const t=datanodesManager.getCurrentDataNode();for(let n=0;n<e.length;n++){let i=datanodesManager.getDataNodeByName(e[n]);if(_.isUndefined(i))i=datanodesManager.getDataNodeByName(t),i.notificationCallback("error",t,"The dataNode referenced in setVariables api doesn't exist. Please verify your parameters");else{datanodesManager.datanodesDependency().addSetvarList(e[n],t);const o=JSON.parse(JSON.stringify(a[n]));i.setValue([],o,!0)}}},setVariableProperty:function(e,a,t){const n=datanodesManager.getCurrentDataNode(),i=JSON.parse(JSON.stringify(t));let o=datanodesManager.getDataNodeByName(e);_.isUndefined(o)?(o=datanodesManager.getDataNodeByName(n),o.notificationCallback("error",n,"The dataNode referenced in setVariableProperty api doesn't exist. Please verify your parameters")):(datanodesManager.datanodesDependency().addSetvarList(e,n),o.setValue(a,i,!0))},executeDataNode:function(e){const a=datanodesManager.getCurrentDataNode();datanodesManager.foundDatanode(e)?datanodesManager.datanodesDependency().addSetvarList(e,a):datanodesManager.getDataNodeByName(a).notificationCallback("error",a,"The dataNode referenced in executeDataNode api doesn't exist. Please verify your parameters")},executeDataNodes:function(e){const a=datanodesManager.getCurrentDataNode();for(let t=0;t<e.length;t++)datanodesManager.foundDatanode(e[t])?datanodesManager.datanodesDependency().addSetvarList(e[t],a):datanodesManager.getDataNodeByName(a).notificationCallback("error",a,"The dataNode referenced in executeDataNodes api doesn't exist. Please verify your parameters")},viewProject:function(e,a,t){const n=xDashConfig.urlBaseForExport;let i=!1;"999"==xDashConfig.version.minor&&(i=!0);let o="";i||(o="-"+xDashConfig.version.fullVersion);const d=n+"index-view"+o+".html?projectUrl="+e+"&inputParams="+inputHandler.encodeInputPars(a);t?window.open(d,"_blank"):window.location=d},viewPage:function(e,a,t){const n=e+"?inputParams="+inputHandler.encodeInputPars(a);t?window.open(n,"_blank"):window.location=n},goToPage:function(e){customNavigationRuntime.customNavigationGoToPage(e)},enableWidget:function(e){modelsParameters[e].enableWidget=!0,widgetPreview.widget[e].render(!0)},disableWidget:function(e){modelsParameters[e].enableWidget=!1,widgetPreview.widget[e].render(!0)},showWidget:function(e){modelsParameters[e].showWidget=!0,widgetPreview.widget[e].render(!0)},hideWidget:function(e){modelsParameters[e].showWidget=!1,widgetPreview.widget[e].render(!0)},notify:function(e,a,t){let n=e,i=datanodesManager.getDataNodeByName(n);_.isUndefined(i)&&(n=datanodesManager.getCurrentDataNode(),i=datanodesManager.getDataNodeByName(n)),i.notificationCallback(t,n,a)},swalert:function(e,a,t){swal(e,a,t)},scheduler:scheduler,dashboard:dashboard,notification:notification});
