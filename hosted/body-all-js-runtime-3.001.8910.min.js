...
class RowToPageRuntime{#e;constructor(){this.#e={rows:1,cols:1}}rowToPagePrepareRescale(e,o){const{defaultRows:r,defaultCols:s}=this.grid,i=Number(e)||r,t=Number(o)||s;this.grid={rows:i,cols:t},i>1&&$("[id^=dpr][id$=c]").show()}rowToPageFinishRescale(e,o){const r=angular.element(document.body).scope().$root.pageNumber,{defaultRows:s,defaultCols:i}=this.grid||{rows:1,cols:1},t=Number(e)||s,a=Number(o)||i;if(this.grid={rows:t,cols:a},t>1)if($("[id^=dpr][id$=c]").hide(),a>1){const e=r*a;for(let o=e-a+1;o<=e;o++)$("#dpr"+o+"c").show()}else $("#dpr"+r+"c").show()}rowToPageModeInit(e){const o=angular.element(document.body).scope().$root,{defaultRows:r,defaultCols:s}=this.grid,i=Number(e.device.cols.valueRow)||r,t=Number(e.device.cols.valueCol)||s;if(this.grid={rows:i,cols:t},o.pageNumber=1,o.totalPages=i,o.showPagination=!0,o.exportOptions=e.exportOptions,o.$apply(),i>1)if($("[id^=dpr][id$=c]").hide(),t>1)for(let e=1;e<=t;e++)$("#dpr"+e+"c").show();else $("#dpr"+o.pageNumber+"c").show();o.rowToPageChange=function(e){let r=!0,s="";switch(e){case"previous":r=o.pageNumber>1,s="-";break;case"next":r=o.pageNumber<o.totalPages,s="+"}if(r){switch($("[id^=dpr][id$=c]").hide(),s){case"-":o.pageNumber-=1;break;case"+":o.pageNumber+=1}if(t>1){const e=o.pageNumber*t;for(let o=e-t+1;o<=e;o++)$("#dpr"+o+"c").show()}else $("#dpr"+o.pageNumber+"c").show()}}}get grid(){return this.#e}set grid(e){this.#e=e}}const rowToPageRuntime=new RowToPageRuntime;
class RowToTabRuntime{#e;constructor(){this.#e={rows:1,cols:1}}rowToTabPrepareRescale(e,o){const{defaultRows:s,defaultCols:r}=this.grid,i=Number(e)||s,d=Number(o)||r;this.grid={rows:i,cols:d},i>1&&$("[id^=dpr][id$=c]").show()}rowToTabFinishRescale(e,o){const s=angular.element(document.body).scope().$root.pageNumber,{defaultRows:r,defaultCols:i}=this.grid||{rows:1,cols:1},d=Number(e)||r,t=Number(o)||i;if(this.grid={rows:d,cols:t},$("#page-"+s).removeClass("cancel").addClass("primary"),d>1)if($("[id^=dpr][id$=c]").hide(),t>1){const e=s*t;for(let o=e-t+1;o<=e;o++)$("#dpr"+o+"c").show()}else $("#dpr"+s+"c").show()}rowToTabModeInit(e){const o=angular.element(document.body).scope().$root,{defaultRows:s,defaultCols:r}=this.grid,i=Number(e.device.cols.valueRow)||s,d=Number(e.device.cols.valueCol)||r;if(this.grid={rows:i,cols:d},o.pageNumber=1,o.pageNames=e.pages.pageNames,o.showPagination=!0,o.exportOptions=e.exportOptions,o.$apply(),i>1)if($("[id^=dpr][id$=c]").hide(),d>1)for(let e=1;e<=d;e++)$("#dpr"+e+"c").show();else $("#dpr"+o.pageNumber+"c").show();o.rowToTabChange=function(e){if(o.pageNumber=e,$("[id^=dpr][id$=c]").hide(),d>1){const o=e*d;for(let e=o-d+1;e<=o;e++)$("#dpr"+e+"c").show()}else $("#dpr"+e+"c").show()}}get grid(){return this.#e}set grid(e){this.#e=e}}const rowToTabRuntime=new RowToTabRuntime;
