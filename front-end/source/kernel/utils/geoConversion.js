...
var geoConversion = (function () {
  ...
  function latLng2geoJson(mylat, mylong, legend, indexColor) {
    ...
    var feature = {
      ...
      properties: {
        style: { color: geoJsonColors[indexColor], weight: 4, opacity: 0.9 },
        description: '<span style="color: ' + geoJsonColors[indexColor] + '">' + legend + '</span>',
      },
    };
  ...
  function dqTrip2geoJson(dqJson, fileName, indexColor) {
    ...
    if (!_.isUndefined(mylong) && !_.isUndefined(mylat))
      //ABK
