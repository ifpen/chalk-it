...
var reconstructFoundations = (function() {
    ...
    function createWidgetDiv(widget) {
        ...
        idWC++;
        divWidgetContainer.style.width = (rmUnit(widget.layout.width) - (2 * (100 / document.documentElement.clientWidth))) + 'vw';
        divWidgetContainer.style.height = (rmUnit(widget.layout.height) - (2 * (100 / document.documentElement.clientHeight))) + 'vh';
