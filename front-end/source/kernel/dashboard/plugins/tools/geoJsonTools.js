...
export function geoJsonTools() {
  function compareSharedKeys(obj1, obj2) {
  ...
  function findPropertiesWithNumber(geoJSON) {
  ...
  function getMinMaxByProperty(GeoJSON, property) {
  ...
  function findAllProperties(geoJSON) {
  ...
  function findFeatureType(geoJSON) {
