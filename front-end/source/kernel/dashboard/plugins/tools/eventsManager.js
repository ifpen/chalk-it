...
export function eventsManager() {
  function mouseoverHandler(self, geoJSON, leafletIndex) {
    return function (e) {
      ...
      _.each(properties, (property) => {
        popupContent =
          ...
          property +
          '</strong> : ' +
          geoJsonTools.formatProperty(e.target.feature.properties[property]) +
          '</p>';
      });
  ...
  function mouseoutHandler(self, geoJSON, leafletIndex) {
    return function (e) {
      let style = modelsHiddenParams[self.idInstance].GeoJSONStyle.style[leafletIndex];
  ...
  function clickHandler(self, geoJSON, leafletLayer, leafletIndex) {
    return function (e) {
      let style = modelsHiddenParams[self.idInstance].GeoJSONStyle.style[leafletIndex];
      if (
        _.isUndefined(style) ||
  ...
  function configureEvents(self, geoJSON, leafletLayer, leafletIndex) {
    //add events :
    // mouseover
