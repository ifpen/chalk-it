...
function pyodideWidgetsPluginClass() {
    ...
    this.genericPlotlyPythonWidget = function(idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.render = async function() {
            ...
            if (bInteractive) { idDivPlotlyPy = idDivPlotlyPy + "c"; }
...
`;
                    try {
                        ...
                        if (bInteractive) {
                            ...
                            Plotly.newPlot(idDivPlotlyPy, plotDef.data, plotDef.layout, plotDef.config)
                                .then(
                                    function(gd) {
                                        Plotly.toImage(gd, { height: $("#" + idDivContainer).height(), width: $("#" + idDivContainer).width() })
                                            .then(
                                                function(url) {
                                                    img_url = url;
                                                    Plotly.purge(gd);
        ...
        const _FIG_DESCRIPTOR = new WidgetActuatorDescription("fig", "Plotly figure object", WidgetActuatorDescription.READ);
    ...
    this.genericMatplotlibWidget = function(idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.render = async function() {
            ...
            if (bInteractive) { idDivMatplotlib = idDivMatplotlib + "c"; }
...
`;
        ...
        const _FIG_DESCRIPTOR = new WidgetActuatorDescription("fig", "Matplotlib figure object", WidgetActuatorDescription.READ);
        this.getActuatorDescriptions = function() {
            return [_FIG_DESCRIPTOR];
        };
    ...
    this.pluginDefinition = {
        ...
        'widgetsDefinitionList': {
            plotlyPyGeneric: { factory: "genericPlotlyPythonWidget", title: "Plotly Python generic", icn: "plotly-python-generic", help: "wdg/wdg-plots/#plotly-python-generic" },
            matplotlib: { factory: "genericMatplotlibWidget", title: "Matplotlib generic", icn: "matplolib-generic", help: "wdg/wdg-plots/#matplotlib" }
        },
    };
