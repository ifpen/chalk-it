...
function echartsWidgetsPluginClass() {
    ...
    function createEchartsDiv(idDivContainer, pId, bInteractive) {
        ...
        if (bInteractive) { idDivEcharts = idDivEcharts + "c"; }
    ...
    this.genericEchartsWidget = function(idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        const _OPTION_DESCRIPTOR = new WidgetActuatorDescription("option", "Chart definition", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_ANY_OBJECT);
        const _SELECTION_DESCRIPTOR = new WidgetActuatorDescription("selection", "Current selection", WidgetActuatorDescription.WRITE, WidgetPrototypesManager.SCHEMA_ANY_OBJECT);
        ...
        this.option = {
            setValue: function(val) {
                if (val != modelsHiddenParams[idInstance].option && (val != "")) {
