...
function timePickerWidgetsPluginClass() {
    ...
    this.timepickerWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.render = function () {
            ...
            if (modelsParameters[idInstance].displayLabel == true) {
                ...
                LabelHtml = '<span class="value-span" id="time-label-span' + idWidget +
            ...
            var clockHtml = '<div id="clockpicker' + idWidget + '" >' +
                '<div class="' + inputClass + '">' +
                '<input autocomplete="off" ' + timePickerdisabled + ' placeholder="Select Time" id="clockpickerInput' + idWidget + '" ' +
                ...
                '"><i class="fa fa-lg fa-clock-o" ' + 'style="display: table-cell; vertical-align: middle;' +
            ...
            $('#clockpicker' + idWidget).clockpicker({
                // donetext: 'Done',
                autoclose: true,
                'default': '12:00',
                init: function () {
    ...
    this.pluginDefinition = {
        ...
        'widgetsDefinitionList': {
            timepickerSimple: { factory: "timepickerWidget", title: "Simple clock", icn: "clock", help: "wdg/wdg-geo-time/#simple-clock" }
        },
    };
