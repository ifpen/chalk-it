...
function flatUiWidgetsPluginClass() {
            ...
            input.on('change', function (e) {
                ...
                reader.addEventListener("load", function (event) {
                    ...
                    if (data instanceof ArrayBuffer) {
                        result.content = btoa([].reduce.call(new Uint8Array(data), function (p, c) { return p + String.fromCharCode(c) }, ''))
    ...
    this.horizontalSliderFlatUiWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.enable = function () {
            ...
            $("#slider" + idWidget).on("slide", function (e, ui) { self.value.setValue(ui.value); });
        ...
        this.insertLabel = function (widgetHtml) {
            ...
            if (!_.isUndefined(modelsParameters[idInstance].labelWidthProportion)) {
                widgetLabel.setAttribute('style', 'width:' + modelsParameters[idInstance].labelWidthProportion +
        ...
        this.insertValue = function (widgetHtml) {
            ...
            if (modelsParameters[idInstance].displayLabel)
                ...
                valueHeightPx = Math.min($('#' + idDivContainer).height(), $('#' + idDivContainer).width() / 8); // keepRatio
            ...
            var valueContent = '<input id="hslider-value' + idWidget +
                '" type="text" placeholder="" class="hslider-input form-control" style="height: ' +
                valueHeightPx + 'px; ' + this.valueFontSize() + this.valueColor() + this.valueFontFamily() +
                hsliderValueCursor + '" disabled></input>';
        ...
        this.render = function () {
            ...
            document.styleSheets[0].addRule('#slider' + idWidget + ' > .ui-slider-handle:hover', this.sliderHandleHoverColor());
            document.styleSheets[0].addRule('#slider' + idWidget + ' > .ui-slider-handle:active', this.sliderHandleActiveColor());
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Current value", WidgetActuatorDescription.READ_WRITE, WidgetPrototypesManager.SCHEMA_NUMBER);
        const _MIN_DESCRIPTOR = new WidgetActuatorDescription("min", "Value lower bound", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER);
        const _MAX_DESCRIPTOR = new WidgetActuatorDescription("max", "Value upper bound", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER);
        this.getActuatorDescriptions = function (model = null) {
            const data = model || modelsParameters[idInstance];
    ...
    this.verticalSliderFlatUiWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.enable = function (updateDataFromWidget) {
            ...
            $("#vertical-slider" + idWidget).on("slide", function (e, ui) { self.value.setValue(ui.value); });
        ...
        this.render = function () {
            ...
            document.styleSheets[0].addRule('#vertical-slider' + idWidget + ' > .ui-slider-handle', this.sliderHandleDefaultColor());
            document.styleSheets[0].addRule('#vertical-slider' + idWidget + ' > .ui-slider-handle:hover', this.sliderHandleHoverColor());
            document.styleSheets[0].addRule('#vertical-slider' + idWidget + ' > .ui-slider-handle:active', this.sliderHandleActiveColor());
    ...
    this.progressBarFlatUiWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.insertValue = function (widgetHtml) {
            ...
            var valueContent = '<input id="progress-bar-value' + idWidget +
                '" type="text" placeholder="" class="hslider-input form-control" style="height: ' +
                valueHeightPx + 'px; ' + this.valueFontSize() + this.valueColor() + this.valueFontFamily() +
                progressBarValueCursor + '" disabled></input>';
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Current progress", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER);
        const _MIN_DESCRIPTOR = new WidgetActuatorDescription("min", "Base progress value", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER);
        const _MAX_DESCRIPTOR = new WidgetActuatorDescription("max", "Final progress value", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER);
        this.getActuatorDescriptions = function (model = null) {
            const data = model || modelsParameters[idInstance];
            const result = [_VALUE_DESCRIPTOR];
    ...
    this.valueFlatUiWidgetModel = function (idDivContainer, idWidget, idInstance, bInteractive, scope, nameWidget) {
        ...
        self.render = function () {
            ...
            if (nameWidget !== "value-display") {
                ...
                document.styleSheets[0].addRule("#" + nameWidget + "-valid-btn" + idWidget , this.validationButtonDefaultColor());
                document.styleSheets[0].addRule("#" + nameWidget + "-valid-btn" + idWidget + ':hover', ' outline: none; ' + this.validationButtonHoverColor());
                document.styleSheets[0].addRule("#" + nameWidget + "-valid-btn" + idWidget + ':focus', ' outline: none; ');
                document.styleSheets[0].addRule("#" + nameWidget + "-valid-btn" + idWidget + ':active', this.validationButtonActiveColor());
            }
    ...
    this.textInputFlatUiWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Current string", WidgetActuatorDescription.READ_WRITE, WidgetPrototypesManager.SCHEMA_STRING);
    ...
    this.numericInputFlatUiWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Current number", WidgetActuatorDescription.READ_WRITE, WidgetPrototypesManager.SCHEMA_NUMBER);
        this.getActuatorDescriptions = () => [_VALUE_DESCRIPTOR];
    };
    ...
    this.valueDisplayFlatUiWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Displayed value", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER_OR_STRING);
        this.getActuatorDescriptions = () => [_VALUE_DESCRIPTOR];
    };
    ...
    this.pluginDefinition = {
        ...
        'widgetsDefinitionList': {
            ...
            flatUiButton: { factory: "buttonFlatUiWidget", title: "Push button", icn: "button", help: "wdg/wdg-basics/#push-button" },
        },
    };
