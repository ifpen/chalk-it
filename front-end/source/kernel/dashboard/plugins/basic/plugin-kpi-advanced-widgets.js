...
function advancedKpiWidgetsPluginClass() {
    ...
    this.advancedKpiCardWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.render = function () {
            ...
            labelContent = labelContent + ' style="text-align:center; margin-bottom: 4rem;' +
                this.labelFontSize() + this.labelColor() + this.labelFontFamily() + '"></h5>';

            var valueContent = '';
            valueContent = valueContent + '<div id="advanced-card-value-' + idWidget +
            ...
            var subLabelContent = '';
            subLabelContent = subLabelContent + '<div id="advanced-card-sub-label-' + idWidget +
                '" class="card-value" style="text-align:center; margin-bottom: 2rem; ';
            subLabelContent = subLabelContent + this.subLabelFontSize() + this.subLabelColor() + this.subLabelFontFamily() + '"></div>';
            ...
            echartsDivContent = echartsDivContent + '<div id="' + idDivEcharts + '" style="text-align:left; height: 11.9vh; width: 100%; background-color: transparent"></div>';
            ...
            /**************************subLabel******************/
            $("#advanced-card-sub-label-" + idWidget)[0].innerText = self.valueFormat(modelsHiddenParams[idInstance].subLabel);
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("extendedValue", "Current value and sub-label", WidgetActuatorDescription.READ, JSON_SCHEMA);
