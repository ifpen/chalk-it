...
function saveToFileButtonWidgetsPluginClass() {
    ...
    this.buttonSaveToFileWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "File content", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_STRING);
    ...
    this.pluginDefinition = {
        ...
        'widgetsDefinitionList': {
            saveToFileButton: { factory: "buttonSaveToFileWidget", title: "Save to file button", icn: "export-to-file", help: "wdg/wdg-basics/#save-to-file-button" },
        },
    };
