...
function kpiWidgetsPluginClass() {
    ...
    this.kpiCardWidget = function(idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.render = function() {
            ...
            var valueContent = '';
            valueContent = valueContent + '<div id="card-value-' + idWidget +
                '" class="card-value" style="text-align:center;';
            valueContent = valueContent + this.valueFontSize() + this.valueColor() + this.valueFontFamily() +
                '">' + '</div>';
            ...
            unitContent = '<span id ="unit-span' + idWidget + '" style="text-align: left; color: ' + modelsParameters[idInstance].unitColor + '; font-size: calc(7px + ' + modelsParameters[idInstance].unitFontSize * getFontFactor() + 'vw + 0.4vh);">' + modelsParameters[idInstance].unit + '</span>';
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Current value", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_ANY_PRIMITIVE);
