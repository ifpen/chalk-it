...
// Parameters
modelsParameters.scoringFullCircularGauge = { "label": "", "inheritLabelFromData": true, "min": 0, "max": 100, "unit": "", "valueColor": "var(--widget-color)", "thick": 10, "thicknessColor": "var(--widget-range-color)", "duration": 1500, "thicknessBackgroundColor": "var(--widget-segment-color)" };
modelsParameters.scoringSemiCircularGauge = { "label": "", "inheritLabelFromData": true, "min": 0, "max": 100, "unit": "", "valueColor": "var(--widget-color)", "thick": 10, "thicknessColor": "var(--widget-range-color)", "duration": 1500, "thicknessBackgroundColor": "var(--widget-segment-color)" };
modelsParameters.scoringArchCircularGauge = { "label": "", "inheritLabelFromData": true, "min": 0, "max": 100, "unit": "", "valueColor": "var(--widget-color)", "thick": 10, "thicknessColor": "var(--widget-range-color)", "duration": 1500, "thicknessBackgroundColor": "var(--widget-segment-color)" };
...
function scoringWidgetsPluginClass() {
    ...
    this.scoringCircularGaugeWidget = function (idDivContainer, idWidget, idInstance, bInteractive, typeWidget) {
        ...
        this.render = function () {
            ...
            var divContent = angular.element(
                ...
                idWidget + '" style="' + this.valueColor() + '" size="' +
                gaugeSize + '" type="' + typeWidget +
                '" thick="' + modelsParameters[idInstance].thick +
                '" min="' + modelsParameters[idInstance].min +
                '" max="' + modelsParameters[idInstance].max +
                '" value="' + modelObj + '"' +
                '" cap="round" label="' + modelsParameters[idInstance].label +
                '" duration="' + modelsParameters[idInstance].duration + '"' +
                this.thicknessColor() + 
                this.thicknessBackgroundColor() + 
                '" append="' + modelsParameters[idInstance].unit +
                '"></ng-gauge>'
            );
        ...
        const _VALUE_DESCRIPTOR = new WidgetActuatorDescription("value", "Numeric value", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_NUMBER);
    ...
    this.pluginDefinition = {
        ...
        'widgetsDefinitionList': {
            scoringFullCircularGauge: { factory: "scoringFullCircularGauge", title: "Full-circular gauge", icn: "full-circular-gauge", help: "wdg/wdg-scoring-gauge/" },
            scoringSemiCircularGauge: { factory: "scoringSemiCircularGauge", title: "Semi-circular gauge", icn: "semi-circular-gauge", help: "wdg/wdg-scoring-gauge/" },
            scoringArchCircularGauge: { factory: "scoringArchCircularGauge", title: "Arch-circular gauge", icn: "widgets icn-arch-circular-gauge", help: "wdg/wdg-scoring-gauge/" }
        },
    };
