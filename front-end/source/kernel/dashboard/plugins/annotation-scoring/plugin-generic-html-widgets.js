...
function genericHtmlWidgetPluginClass() {
    ...
    this.genericHtmlWidget = function (idDivContainer, idWidget, idInstance, bInteractive) {
        ...
        this.render = function () {
            ...
            var divContent = '<div id="htmlDiv' + idWidget +
        ...
        const _HTML_DESCRIPTOR = new WidgetActuatorDescription("html", "Html content", WidgetActuatorDescription.READ, WidgetPrototypesManager.SCHEMA_STRING);
    ...
    this.pluginDefinition = {
        ...
        'widgetsDefinitionList': {
            annotationHtml: { factory: "genericHtmlWidget", title: "Generic html", icn: "generic-html", help: "wdg/wdg-annotation-video/#generic-html" }
        },
    };
