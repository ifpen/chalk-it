(function() {
    ...
    datanodesManager.loadDatanodePlugin({
        ...
        newInstance: function(
            ...
            newInstanceCallback(
                new genericFilePlugin(settings, updateCallback, statusCallback)
            );
            if (error)
            //ABK
                return false;
    ...
    var genericFilePlugin = function(settings, updateCallback, statusCallback) {
        ...
        self.setFile = function(newContent) {
            ...
            // TODO : uniformiser le format "fichier" et les méta informations
            currentSettings.content = newContent.content; // MBG 02/01/2023
