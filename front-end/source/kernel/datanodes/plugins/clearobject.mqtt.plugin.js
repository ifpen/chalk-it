    ...
    datanodesManager.loadDatanodePlugin({
        ...
        "settings": [{
            ...
            },
            {
                ...
                "type": "boolean",
                "description": "Use TLS encryption to connect to the MQTT Server securely (datanodesManager.io requires all brokers to use encryption).",
                "default_value": true
            },
            {
                "name": "client_id",
            ...
            },
            {
                ...
                "type": "boolean",
                "description": "If the messages on your topic are in JSON format they will be parsed so the individual fields can be used in datanodesManager widgets.",
                "default_value": true
            }
        ],
