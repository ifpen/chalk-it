 ...
 * @author AR
 * @description
 * This Datanode is used to send dat through Web socket. It's allow Taipy Designer to send data
 */
// ### Datanode Definition
//
// -------------------
...
(function () {
  var dataObj = {};
  var Websocket_send_Plugin = function (
    settings,
    updateCallback,
    statusCallback,
  ...
  datanodesManager.loadDatanodePlugin({
    ...
    description: "Websocket client to send data to Taipy Designer",
