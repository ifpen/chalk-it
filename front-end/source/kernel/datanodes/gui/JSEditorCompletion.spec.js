...
describe('JSEditorCompletion', function () {
    ...
    describe('locateDataNodesPrefix', function () {
        ...
        it(`should match after quotes for '${plopStr}'`, function () {
            ...
            assert.deepStrictEqual(JSEditorCompletion._locateDataNodesPrefix(plopStr, 19), { prefix: 'x', start: 7, end: 19 });
            assert.deepStrictEqual(JSEditorCompletion._locateDataNodesPrefix(plopStr, 20), { prefix: 'xy', start: 7, end: 20 });
            assert.deepStrictEqual(JSEditorCompletion._locateDataNodesPrefix(plopStr, 21), { prefix: 'xyz', start: 7, end: 21 });
        });

        it(`should match prefix "aa" for 'dataNodes[\'nope\' ] dataNodes[ "nope"] dataNodes [\'aa dataNodes["nope"]'`, function () {
            assert.deepStrictEqual(
                JSEditorCompletion._locateDataNodesPrefix('dataNodes[\'nope\' ] dataNodes[ "nope"] dataNodes [\'aa dataNodes["nope"]', 52),
