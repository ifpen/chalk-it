...
var RuntimeDashboard = (function () {
    ...
    function initContainers(jsonContent, exportOptions) {
        ...
        var mediaChangeProj = widgetPreview.mediaChangeProjection(projectedScalingObj,
            projectedPreviewDimensions, rows);
    ...
    async function loadDashboard(jsonContent, exportOptions) {
        ...
        //AEF: issue#304
        var offSchedLogUser;
        if (!_.isUndefined(jsonContent.meta.schedulerLogOff))
            offSchedLogUser = jsonContent.meta.schedulerLogOff;
        else
