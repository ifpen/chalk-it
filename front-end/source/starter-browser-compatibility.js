...
(function() {
    ...
    function preprocessPage() {
        ...
        Mymessage = '<div style="margin:100px">' +
            '   <h2 style="text-align:center">' + title + '</h2>' +
            '   <p style="text-align:center">' + text1 + '</p>' +
            '   <p style="text-align:center">' + text2 + '</p>' +
            '</div>';
    ...
    } else if (browser.name !== "Chrome" && browser.name !== "Firefox" && browser.name !== "Safari" && browser.name != "Edge") {
