...
angular.module('xCLOUD')
    .service('ApisFactory', ['$http', '$rootScope', function($http, $rootScope) {
        ...
        this.postRequest = function(apiMethod, data) {
            ...
            return $http.post(xServConfig.urlApi + apiMethod,
                JSON.stringify(data), {
                    contentType: "application/json; charset=utf-8"
                }).then(function(msg) {
        ...
        this.GetProjectByName = function(data) {
            $rootScope.loadingBarStart();
            return $http.post(xServConfig.urlApi + "ReadProject",
                JSON.stringify(data), {
                    contentType: "application/json; charset=utf-8"
                }).then(function(msg) {
                $rootScope.loadingBarStop();
        ...
        this.deleteFileFromServer = function(data, DeleteAction) {
            $rootScope.loadingBarStart();
            return $http.post(xServConfig.urlApi + DeleteAction,
                JSON.stringify(data), {
                    contentType: "application/json; charset=utf-8"
                }).then(function(msg) {
                $rootScope.loadingBarStop();
        ...
        this.registerRequest = function(userModel) {
            return callxDashNodeServerAPI("POST", "auth/register",
                userModel
            );
        }
