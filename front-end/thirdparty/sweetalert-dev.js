  ...
  })(
    {
      1: [
        function (require, module, exports) {
          ...
          var _handleButton$handleConfirm$handleCancel$handleClose = require("./modules/handle-click");
          ...
          exports["default"] = sweetAlert = swal = function () {
            ...
            var onButtonEvent = function onButtonEvent(e) {
              return _handleButton$handleConfirm$handleCancel$handleClose.handleButton(
                e,
                params,
                modal
              );
          ...
          sweetAlert.disableButtons = swal.disableButtons = function (event) {
            ...
            var $confirmButton1 = modal.querySelector("button.confirm1");
            var $cancelButton = modal.querySelector("button.cancel");
            var $closeButton = modal.querySelector("a.close1");
            var $introButton = modal.querySelector("a.intro");
            var $copyButton = modal.querySelector("a.copy-btn");
      ...
      2: [
        function (require, module, exports) {
          ...
          var defaultParams = {
            ...
            confirmButtonColor: "#606061", //'#8CD4F5',
      ...
      3: [
        function (require, module, exports) {
          ...
          var handleButton = function handleButton(event, params, modal) {
            ...
            var targetedClose = target.className.indexOf("close1") !== -1;
            var targetedOverlay =
		...
		$confirmButton1.style.boxShadow = 'none';
      }*/
                break;
              ...
              case "click":
                ...
                if (targetedClose && modalIsVisible) {
                  handleClose(params);
                } else if (
                  targetedConfirm &&
                  doneFunctionExists &&
           ...
           */
          var handleClose = function handleClose(params) {
            if (params.closeOnClose) {
              sweetAlert.close();
            }
          };
      ...
      7: [
        function (require, module, exports) {
          ...
          var injectedHTML =
            ...
            //close btn
            '<a href="javascript:void(0)" onclick="swal.close();" class="btn btn-icon-only close1" title="Close" style="float: right;width: auto;line-height: 0;color: black;margin-top: 1em;">\n <i class="basic icn-close close-aside"> </i>\n</a> \n ' +
            // Error icon
            ...
            '<h2>Title</h2>\n    <p>Text</p>\n  <textarea class="swal-text" id ="swal-text" readonly>Text</textarea>\n<div style="display: inline-block;">\n <p id="swal-p" style="float:right;visibility:hidden;"> Copied!</p>\n</div>\n</br>\n   <fieldset class="copy-fieldset">\n      <input id ="swal-input" type="text" tabIndex="3" />\n  <a href="javascript:void(0)" class="copy-btn" onclick="copyURLtoClipboard();" title="Click to copy"><i class="fa-copy fa"></i></a>\n    <div class="sa-input-error"></div>\n    </fieldset> ' +
            // Input errors
            '<div class="sa-error-container">\n      <div class="icon">!</div>\n      <p>Not valid!</p>\n    </div>' +
            // Container and confirm buttons
            '<div class="sa-button-container">\n  <div class="sa-confirm-button-container">\n   <button class=" btn btn-rounded-fill primary confirm" style="padding: 0.5em 1em;" tabIndex="1">OK</button>\n  </div>\n' +
            // Cancel and Confirm and close buttons
            //"<div class=\"sa-confirm-button-container1\">\n <a href=\"#close\" title=\"Close\"><button class=\"btn btn-rounded-fill primary confirm1\" tabIndex=\"1\">OK</button></a>\n <button class=\"btn btn-rounded-fill cancel\" tabIndex=\"2\">Cancel</button>\n <a href=\"javascript:void(0)\" class=\"intro\" onclick=\"sweetAlert.close();startIntro();\" title=\"First quick start guide\" style=\"float: right;margin: 11px;\"><i class=\"icon-info-sign icon \"></i></a>\n" +
            '<div class="sa-confirm-button-container1">\n <button class=" btn btn-rounded-fill cancel" style="padding: 0.5em 1em;" tabIndex="2">Cancel</button>\n <a><button class=" btn btn-rounded-fill primary confirm1" style="padding: 0.5em 1em;" tabIndex="1">OK</button></a>\n <button class=" btn btn-rounded-fill primary cancel1" style="padding: 0.5em 1em;" tabIndex="2">Cancel</button>\n <a href="javascript:void(0)" class="intro" onclick="sweetAlert.close();startIntro();" title="First quick start guide"><img src="source/assets/icon/light-bulb.svg" style="width:24px;height:24px"></a>\n' +
            // Loading animation
      ...
      8: [
        function (require, module, exports) {
          ...
          var setParameters = function setParameters(params) {
            ...
            var $url = modal.querySelector("textarea");
            var $confirmBtn = modal.querySelector("button.confirm");
            var $confirmBtn1 = modal.querySelector("button.confirm1");
            var $cancelBtn = modal.querySelector("button.cancel");
            var $cancelBtn1 = modal.querySelector("button.cancel1");
            var $closeBtn = modal.querySelector("a.close1");
            var $introBtn = modal.querySelector("a.intro");
            var $copyBtn = modal.querySelector("a.copy-btn");
            /*
             * Title
             */
            ...
            modal.setAttribute(
              "data-has-confirm-button",
              params.showConfirmButton1
            );
            if (params.showConfirmButton1) {
             ...
             * Show close button?
             */
            modal.setAttribute("data-has-close-button", params.showCloseButton);
            ...
            if (params.confirmButtonText) {
              ...
              $confirmBtn1.innerHTML = _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.escapeHtml(
                params.confirmButtonText
              );
            }
            if (params.cancelButtonText) {
              ...
              $cancelBtn1.innerHTML = _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.escapeHtml(
                params.cancelButtonText
              );
            }
            ...
            if (params.confirmButtonColor) {
              ...
              //$confirmBtn1.style.backgroundColor = params.confirmButtonColor;
              // Set the confirm button color to the loading ring
              // $confirmBtn.style.borderLeftColor = params.confirmLoadingButtonColor;
              // $confirmBtn.style.borderRightColor = params.confirmLoadingButtonColor;
              //$confirmBtn1.style.borderLeftColor = params.confirmLoadingButtonColor;
              // $confirmBtn1.style.borderRightColor = params.confirmLoadingButtonColor;
              // Set box-shadow to default focused button
              //  _getModal$getInput$setFocusStyle.setFocusStyle($confirmBtn, params.confirmButtonColor);
              //	 _getModal$getInput$setFocusStyle.setFocusStyle($confirmBtn1, params.confirmButtonColor);
            }
