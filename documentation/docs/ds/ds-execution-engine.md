...
- When set to _true_, the dataNode, in terms of execution flow control, is considered as a source node. It is no longer executed when a direct predecessor is updated. With this setting, it is only executed when it is explicitly triggered by an associated [push button](../wdg/wdg-basic-inputs.md#push-button) widget, by [chalkit scheduler APIs](../chalkitapi.md#scheduler-features), or by a click on the dataNode refresh icon ![Update](img/refresh-icon.png "Update") present in the dataNodes list of tabs 1 or 3. Please refer to the [Triggered POST](ds-reference.md#triggered-post) example above.
...
| [Python Script](ds-reference.md#python-script)                            | :heavy_check_mark: |                    | :heavy_check_mark: |
| [JavaScript Script (client-side)](ds-reference.md#javascript-script)      | :heavy_check_mark: |                    | :heavy_check_mark: |
| [REST web-service](ds-reference.md#rest-web-services)                     | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| MQTT                                                                      |                    |                    |                    |
| [WebSocket receive](ds-reference.md#websocket-receive)                    | :heavy_check_mark: |                    |                    |
| [WebSocket send](ds-reference.md#websocket-send)                          | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
\*By an associated [push button](../wdg/wdg-basic-inputs.md#push-button) widget, by a click on the dataNode update icon ![Update](img/refresh-icon.png "Update"), or by using [executeDataNode API](../chalkitapi.md#executedatanode).
...
Currently only [Variable](ds-basics.md#variable) and [Memory](ds-reference.md#memory) dataNodes have this property. It indicates that their workspace value can be modified by widgets that have write capabilities (such as sliders ([horizontal slider](../wdg/wdg-basic-inputs.md#horizontal-slider) ...), [numeric input](../wdg/wdg-basic-inputs.md#numeric-input), editable [table](../wdg/wdg-basic-inputs.md#table) ...).

### setValue from file

The value of the dataNode can be assigned from a file. See example in [Push button](../wdg/wdg-basic-inputs.md#push-button).

### setValue from script

Python or JavaScript code can be written to define input to [Variable](ds-basics.md#variable) and [Memory](ds-reference.md#memory) dataNodes, using chalkit API functions:

- [setVariable](../chalkitapi.md#setvariable)
- [setVariableProperty](../chalkitapi.md#setvariableproperty)
- [setVariables](../chalkitapi.md#setvariables)

This is useful to init and reset variables. See example [reset-counter.xprjson](xprjson/reset-counter.xprjson).
...
| ----------------------------------------------------------------------- | :-------------------: | :------------------: | :----------------: | :------------------: |
| [Variable](ds-basics.md#variable)                                       |                       |  :heavy_check_mark:  | :heavy_check_mark: |                      |
| [Python Script](ds-reference.md#python-script)                          |  :heavy_check_mark:   |                      |                    |  :heavy_check_mark:  |
| [JavaScript Script (client-side)](ds-reference.md#javascript-script)    |  :heavy_check_mark:   |                      |                    |  :heavy_check_mark:  |
| [REST web-service](ds-basics.md)                                        |  :heavy_check_mark:   |                      |                    |  :heavy_check_mark:  |
...
| [Memory](ds-reference.md#memory)                                        |                       |                      |                    |                      |
| MQTT                                                                    |                       |                      |                    |                      |
| [WebSocket receive](ds-reference.md#websocket-receive)                  |                       |                      |                    |                      |
| [WebSocket send](ds-reference.md#websocket-send)                        |  :heavy_check_mark:   |                      |                    |                      |
